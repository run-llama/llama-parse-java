...
import ai.llamaindex.llamacloud.client.LlamaCloudClientImpl
...
/**
 * A class that allows building an instance of [LlamaCloudClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LlamaCloudOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LlamaCloudClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): LlamaCloudClient = builder().fromEnv().build()
    }

    /** A builder for [LlamaCloudOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LlamaCloudClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LlamaCloudClient =
            LlamaCloudClientImpl(
                clientOptions
                    .httpClient(
