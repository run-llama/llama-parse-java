...
package ai.llamaindex.llamacloud.client.okhttp

import ai.llamaindex.llamacloud.client.LlamaCloudClientAsync
import ai.llamaindex.llamacloud.client.LlamaCloudClientAsyncImpl
import ai.llamaindex.llamacloud.core.ClientOptions
import ai.llamaindex.llamacloud.core.LogLevel
import ai.llamaindex.llamacloud.core.Sleeper
import ai.llamaindex.llamacloud.core.Timeout
import ai.llamaindex.llamacloud.core.http.AsyncStreamResponse
import ai.llamaindex.llamacloud.core.http.Headers
import ai.llamaindex.llamacloud.core.http.HttpClient
...
/**
 * A class that allows building an instance of [LlamaCloudClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LlamaCloudOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LlamaCloudClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): LlamaCloudClientAsync = builder().fromEnv().build()
    }

    /** A builder for [LlamaCloudOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [ai.llamaindex.llamacloud.core.jsonMapper]. The default is usually sufficient
        ...
        /**
         * Returns an immutable instance of [LlamaCloudClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LlamaCloudClientAsync =
            LlamaCloudClientAsyncImpl(
                clientOptions
                    .httpClient(
