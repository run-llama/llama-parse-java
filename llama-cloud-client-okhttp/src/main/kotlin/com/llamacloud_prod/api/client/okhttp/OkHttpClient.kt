...
import com.llamacloud_prod.api.core.http.HttpRequestBody
import com.llamacloud_prod.api.core.http.HttpResponse
import com.llamacloud_prod.api.core.http.ProxyAuthenticator
import com.llamacloud_prod.api.errors.LlamaCloudIoException
...
internal constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw LlamaCloudIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(LlamaCloudIoException("Request failed", e))
                }
            }
        )
