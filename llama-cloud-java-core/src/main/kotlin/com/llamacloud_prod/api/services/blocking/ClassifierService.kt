...
interface ClassifierService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): ClassifierService

    fun jobs(): JobService

    /** A view of [ClassifierService] that provides access to raw HTTP responses for each method. */
