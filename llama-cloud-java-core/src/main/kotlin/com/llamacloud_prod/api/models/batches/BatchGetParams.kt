...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatchGetParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchGetParams: BatchGetParams) = apply {
            batchId = batchGetParams.batchId
            expand = batchGetParams.expand?.toMutableList()
            organizationId = batchGetParams.organizationId
            projectId = batchGetParams.projectId
    ...
    override fun toString() =
        "BatchGetParams{batchId=$batchId, expand=$expand, organizationId=$organizationId, projectId=$projectId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
