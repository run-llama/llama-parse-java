...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MetadataDeleteAllParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MetadataDeleteAllParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MetadataDeleteAllParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(metadataDeleteAllParams: MetadataDeleteAllParams) = apply {
            ...
            additionalBodyProperties =
                metadataDeleteAllParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MetadataDeleteAllParams].
         *
