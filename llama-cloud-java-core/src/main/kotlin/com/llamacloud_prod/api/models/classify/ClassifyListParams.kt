...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ClassifyListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ClassifyListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ClassifyListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(classifyListParams: ClassifyListParams) = apply {
            configurationId = classifyListParams.configurationId
            createdAtOnOrAfter = classifyListParams.createdAtOnOrAfter
            createdAtOnOrBefore = classifyListParams.createdAtOnOrBefore
            jobIds = classifyListParams.jobIds?.toMutableList()
            organizationId = classifyListParams.organizationId
            pageSize = classifyListParams.pageSize
            pageToken = classifyListParams.pageToken
            projectId = classifyListParams.projectId
            status = classifyListParams.status
            additionalHeaders = classifyListParams.additionalHeaders.toBuilder()
            additionalQueryParams = classifyListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ClassifyListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ClassifyListParams =
            ClassifyListParams(
                configurationId,
                createdAtOnOrAfter,
                createdAtOnOrBefore,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassifyListParams &&
    ...
    override fun toString() =
        "ClassifyListParams{configurationId=$configurationId, createdAtOnOrAfter=$createdAtOnOrAfter, createdAtOnOrBefore=$createdAtOnOrBefore, jobIds=$jobIds, organizationId=$organizationId, pageSize=$pageSize, pageToken=$pageToken, projectId=$projectId, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
