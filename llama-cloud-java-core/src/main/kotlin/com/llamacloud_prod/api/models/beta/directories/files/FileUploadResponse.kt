...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileUploadResponse: FileUploadResponse) = apply {
            ...
            directoryId = fileUploadResponse.directoryId
            displayName = fileUploadResponse.displayName
            projectId = fileUploadResponse.projectId
            uniqueId = fileUploadResponse.uniqueId
            createdAt = fileUploadResponse.createdAt
            deletedAt = fileUploadResponse.deletedAt
            downloadUrl = fileUploadResponse.downloadUrl
            fileId = fileUploadResponse.fileId
            metadata = fileUploadResponse.metadata
            updatedAt = fileUploadResponse.updatedAt
    ...
    override fun toString() =
        "FileUploadResponse{id=$id, directoryId=$directoryId, displayName=$displayName, projectId=$projectId, uniqueId=$uniqueId, createdAt=$createdAt, deletedAt=$deletedAt, downloadUrl=$downloadUrl, fileId=$fileId, metadata=$metadata, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
