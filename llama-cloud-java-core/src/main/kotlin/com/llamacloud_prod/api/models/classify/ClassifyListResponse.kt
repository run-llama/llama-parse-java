...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassifyListResponse].
         *
    ...
    /** A builder for [ClassifyListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(classifyListResponse: ClassifyListResponse) = apply {
            id = classifyListResponse.id
            configuration = classifyListResponse.configuration
            documentInputType = classifyListResponse.documentInputType
            fileInput = classifyListResponse.fileInput
            projectId = classifyListResponse.projectId
            status = classifyListResponse.status
            userId = classifyListResponse.userId
            configurationId = classifyListResponse.configurationId
            createdAt = classifyListResponse.createdAt
            errorMessage = classifyListResponse.errorMessage
            parseJobId = classifyListResponse.parseJobId
            result = classifyListResponse.result
            transactionId = classifyListResponse.transactionId
            updatedAt = classifyListResponse.updatedAt
            additionalProperties = classifyListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClassifyListResponse].
         *
         ...
         */
        fun build(): ClassifyListResponse =
     ...
     *   expected type.
     */
    fun validate(): ClassifyListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassifyListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ClassifyListResponse{id=$id, configuration=$configuration, documentInputType=$documentInputType, fileInput=$fileInput, projectId=$projectId, status=$status, userId=$userId, configurationId=$configurationId, createdAt=$createdAt, errorMessage=$errorMessage, parseJobId=$parseJobId, result=$result, transactionId=$transactionId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
