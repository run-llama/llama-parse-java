...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassifyCreateResponse].
         *
    ...
    /** A builder for [ClassifyCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(classifyCreateResponse: ClassifyCreateResponse) = apply {
            id = classifyCreateResponse.id
            configuration = classifyCreateResponse.configuration
            documentInputType = classifyCreateResponse.documentInputType
            fileInput = classifyCreateResponse.fileInput
            projectId = classifyCreateResponse.projectId
            status = classifyCreateResponse.status
            userId = classifyCreateResponse.userId
            configurationId = classifyCreateResponse.configurationId
            createdAt = classifyCreateResponse.createdAt
            errorMessage = classifyCreateResponse.errorMessage
            parseJobId = classifyCreateResponse.parseJobId
            result = classifyCreateResponse.result
            transactionId = classifyCreateResponse.transactionId
            updatedAt = classifyCreateResponse.updatedAt
            additionalProperties = classifyCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClassifyCreateResponse].
         *
         ...
         */
        fun build(): ClassifyCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): ClassifyCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassifyCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ClassifyCreateResponse{id=$id, configuration=$configuration, documentInputType=$documentInputType, fileInput=$fileInput, projectId=$projectId, status=$status, userId=$userId, configurationId=$configurationId, createdAt=$createdAt, errorMessage=$errorMessage, parseJobId=$parseJobId, result=$result, transactionId=$transactionId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
