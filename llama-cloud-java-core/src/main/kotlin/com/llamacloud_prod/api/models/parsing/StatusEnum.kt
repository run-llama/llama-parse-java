...
class StatusEnum @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [StatusEnum]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [StatusEnum] can contain an unknown value in a couple of cases:
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StatusEnum && value == other.value
    }
