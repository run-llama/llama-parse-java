...
private constructor(
    ...
    private val progressPercentage: JsonField<Double>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        progressPercentage: JsonField<Double> = JsonMissing.of(),
    ) : this(job, progressPercentage, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun progressPercentage(): Double = progressPercentage.getRequired("progress_percentage")
    ...
    /**
     * Returns the raw JSON value of [progressPercentage].
     *
     * Unlike [progressPercentage], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("progress_percentage")
    @ExcludeMissing
    fun _progressPercentage(): JsonField<Double> = progressPercentage
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchGetStatusResponse].
         *
    ...
    /** A builder for [BatchGetStatusResponse]. */
    class Builder internal constructor() {

        private var job: JsonField<Job>? = null
        private var progressPercentage: JsonField<Double>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(batchGetStatusResponse: BatchGetStatusResponse) = apply {
            job = batchGetStatusResponse.job
            progressPercentage = batchGetStatusResponse.progressPercentage
            additionalProperties = batchGetStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Percentage of items processed (0-100) */
        fun progressPercentage(progressPercentage: Double) =
            progressPercentage(JsonField.of(progressPercentage))

        /**
         * Sets [Builder.progressPercentage] to an arbitrary JSON value.
         *
         * You should usually call [Builder.progressPercentage] with a well-typed [Double] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun progressPercentage(progressPercentage: JsonField<Double>) = apply {
        ...
        /**
         * Returns an immutable instance of [BatchGetStatusResponse].
         *
         ...
         */
        fun build(): BatchGetStatusResponse =
            BatchGetStatusResponse(
                checkRequired("job", job),
                checkRequired("progressPercentage", progressPercentage),
     ...
     *   expected type.
     */
    fun validate(): BatchGetStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (job.asKnown().getOrNull()?.validity() ?: 0) +
            (if (progressPercentage.asKnown().isPresent) 1 else 0)
    ...
    private constructor(
        ...
        @JsonProperty("failed_items")
        @ExcludeMissing
        fun _failedItems(): JsonField<Long> = failedItems
         ...
         *
         * Unlike [processedItems], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("processed_items")
        @ExcludeMissing
         ...
         *
         * Unlike [skippedItems], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("skipped_items")
        @ExcludeMissing
        ...
        @JsonProperty("workflow_id")
        @ExcludeMissing
        fun _workflowId(): JsonField<String> = workflowId
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.jobRecordId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun jobRecordId(jobRecordId: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.processedItems] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.skippedItems] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun skippedItems(skippedItems: JsonField<Long>) = apply {
             ...
             *
             * You should usually call [Builder.workflowId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Job{id=$id, jobType=$jobType, projectId=$projectId, status=$status, totalItems=$totalItems, completedAt=$completedAt, createdAt=$createdAt, directoryId=$directoryId, effectiveAt=$effectiveAt, errorMessage=$errorMessage, failedItems=$failedItems, jobRecordId=$jobRecordId, processedItems=$processedItems, skippedItems=$skippedItems, startedAt=$startedAt, updatedAt=$updatedAt, workflowId=$workflowId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetStatusResponse &&
            job == other.job &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(job, progressPercentage, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BatchGetStatusResponse{job=$job, progressPercentage=$progressPercentage, additionalProperties=$additionalProperties}"
}
