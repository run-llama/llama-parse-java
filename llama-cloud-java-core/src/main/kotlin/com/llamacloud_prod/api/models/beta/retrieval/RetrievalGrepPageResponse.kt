...
private constructor(
    private val items: JsonField<List<RetrievalGrepResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<RetrievalGrepResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<RetrievalGrepResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<RetrievalGrepResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RetrievalGrepPageResponse].
         *
    ...
    /** A builder for [RetrievalGrepPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<RetrievalGrepResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(retrievalGrepPageResponse: RetrievalGrepPageResponse) = apply {
            items = retrievalGrepPageResponse.items.map { it.toMutableList() }
            nextPageToken = retrievalGrepPageResponse.nextPageToken
            totalSize = retrievalGrepPageResponse.totalSize
            additionalProperties = retrievalGrepPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<RetrievalGrepResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<RetrievalGrepResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<RetrievalGrepResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [RetrievalGrepResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: RetrievalGrepResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [RetrievalGrepPageResponse].
         *
         ...
         */
        fun build(): RetrievalGrepPageResponse =
            RetrievalGrepPageResponse(
     ...
     *   expected type.
     */
    fun validate(): RetrievalGrepPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetrievalGrepPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "RetrievalGrepPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
