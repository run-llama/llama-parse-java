...
private constructor(
    ...
    ) : this(id, name, parameters, productType, version, createdAt, updatedAt, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConfigurationResponse].
         *
    ...
    /** A builder for [ConfigurationResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(configurationResponse: ConfigurationResponse) = apply {
            id = configurationResponse.id
            name = configurationResponse.name
            parameters = configurationResponse.parameters
            productType = configurationResponse.productType
            version = configurationResponse.version
            createdAt = configurationResponse.createdAt
            updatedAt = configurationResponse.updatedAt
            additionalProperties = configurationResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConfigurationResponse].
         *
         ...
         */
        fun build(): ConfigurationResponse =
     ...
     *   expected type.
     */
    fun validate(): ConfigurationResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConfigurationResponse &&
            id == other.id &&
            name == other.name &&
    ...
    override fun toString() =
        "ConfigurationResponse{id=$id, name=$name, parameters=$parameters, productType=$productType, version=$version, createdAt=$createdAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
