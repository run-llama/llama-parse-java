...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileGetStatusCountsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [FileGetStatusCountsParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileGetStatusCountsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileGetStatusCountsParams: FileGetStatusCountsParams) = apply {
        ...
        /**
         * Returns an immutable instance of [FileGetStatusCountsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileGetStatusCountsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileGetStatusCountsParams &&
