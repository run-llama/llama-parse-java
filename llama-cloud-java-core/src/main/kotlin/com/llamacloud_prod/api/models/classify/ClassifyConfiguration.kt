...
private constructor(
    ...
    ) : this(rules, mode, parsingConfiguration, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassifyConfiguration].
         *
    ...
    /** A builder for [ClassifyConfiguration]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(classifyConfiguration: ClassifyConfiguration) = apply {
            rules = classifyConfiguration.rules.map { it.toMutableList() }
            mode = classifyConfiguration.mode
            parsingConfiguration = classifyConfiguration.parsingConfiguration
            additionalProperties = classifyConfiguration.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClassifyConfiguration].
         *
         ...
         */
        fun build(): ClassifyConfiguration =
     ...
     *   expected type.
     */
    fun validate(): ClassifyConfiguration = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassifyConfiguration &&
            rules == other.rules &&
            mode == other.mode &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(rules, mode, parsingConfiguration, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ClassifyConfiguration{rules=$rules, mode=$mode, parsingConfiguration=$parsingConfiguration, additionalProperties=$additionalProperties}"
}
