...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PipelineGetStatusParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PipelineGetStatusParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PipelineGetStatusParams]. */
    class Builder internal constructor() {
        ...
        fun fullDetails(fullDetails: Boolean?) = apply { this.fullDetails = fullDetails }

        /**
         * Alias for [Builder.fullDetails].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun fullDetails(fullDetails: Boolean) = fullDetails(fullDetails as Boolean?)
        ...
        /**
         * Returns an immutable instance of [PipelineGetStatusParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PipelineGetStatusParams =
