...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CloudDocumentCreate].
         *
    ...
    /** A builder for [CloudDocumentCreate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(cloudDocumentCreate: CloudDocumentCreate) = apply {
            metadata = cloudDocumentCreate.metadata
            text = cloudDocumentCreate.text
            id = cloudDocumentCreate.id
            excludedEmbedMetadataKeys =
                cloudDocumentCreate.excludedEmbedMetadataKeys.map { it.toMutableList() }
            excludedLlmMetadataKeys =
                cloudDocumentCreate.excludedLlmMetadataKeys.map { it.toMutableList() }
            pagePositions = cloudDocumentCreate.pagePositions.map { it.toMutableList() }
            additionalProperties = cloudDocumentCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CloudDocumentCreate].
         *
     ...
     *   expected type.
     */
    fun validate(): CloudDocumentCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloudDocumentCreate &&
    ...
    override fun toString() =
        "CloudDocumentCreate{metadata=$metadata, text=$text, id=$id, excludedEmbedMetadataKeys=$excludedEmbedMetadataKeys, excludedLlmMetadataKeys=$excludedLlmMetadataKeys, pagePositions=$pagePositions, additionalProperties=$additionalProperties}"
}
