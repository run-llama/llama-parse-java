...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileGetResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileGetResponse: FileGetResponse) = apply {
            id = fileGetResponse.id
            directoryId = fileGetResponse.directoryId
            displayName = fileGetResponse.displayName
            projectId = fileGetResponse.projectId
            uniqueId = fileGetResponse.uniqueId
            createdAt = fileGetResponse.createdAt
            deletedAt = fileGetResponse.deletedAt
            downloadUrl = fileGetResponse.downloadUrl
            fileId = fileGetResponse.fileId
            metadata = fileGetResponse.metadata
            updatedAt = fileGetResponse.updatedAt
            additionalProperties = fileGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FileGetResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): FileGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileGetResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "FileGetResponse{id=$id, directoryId=$directoryId, displayName=$displayName, projectId=$projectId, uniqueId=$uniqueId, createdAt=$createdAt, deletedAt=$deletedAt, downloadUrl=$downloadUrl, fileId=$fileId, metadata=$metadata, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
