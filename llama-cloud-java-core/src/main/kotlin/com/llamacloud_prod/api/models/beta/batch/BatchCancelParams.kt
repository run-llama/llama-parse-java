 ...
 *
 * Stops processing and marks pending items as cancelled. Items currently being processed may still
 * complete.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchCancelParams: BatchCancelParams) = apply {
            jobId = batchCancelParams.jobId
            organizationId = batchCancelParams.organizationId
            projectId = batchCancelParams.projectId
            temporalNamespace = batchCancelParams.temporalNamespace
            body = batchCancelParams.body.toBuilder()
    ...
    override fun toString() =
        "BatchCancelParams{jobId=$jobId, organizationId=$organizationId, projectId=$projectId, temporalNamespace=$temporalNamespace, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
