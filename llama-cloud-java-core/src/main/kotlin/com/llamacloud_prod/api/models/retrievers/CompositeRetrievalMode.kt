...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [CompositeRetrievalMode]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [CompositeRetrievalMode] can contain an unknown value in a couple of cases:
     ...
     *   expected type.
     */
    fun validate(): CompositeRetrievalMode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompositeRetrievalMode && value == other.value
    }
