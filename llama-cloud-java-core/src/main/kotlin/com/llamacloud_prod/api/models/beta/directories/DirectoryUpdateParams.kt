...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DirectoryUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DirectoryUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DirectoryUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(directoryUpdateParams: DirectoryUpdateParams) = apply {
            directoryId = directoryUpdateParams.directoryId
            organizationId = directoryUpdateParams.organizationId
            projectId = directoryUpdateParams.projectId
            body = directoryUpdateParams.body.toBuilder()
            additionalHeaders = directoryUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = directoryUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DirectoryUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DirectoryUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirectoryUpdateParams &&
    ...
    override fun toString() =
        "DirectoryUpdateParams{directoryId=$directoryId, organizationId=$organizationId, projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
