...
private constructor(
    ...
    ) : this(md, value, bbox, language, type, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CodeItem].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(codeItem: CodeItem) = apply {
            md = codeItem.md
            value = codeItem.value
            bbox = codeItem.bbox.map { it.toMutableList() }
            language = codeItem.language
            type = codeItem.type
            additionalProperties = codeItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CodeItem].
         *
    ...
    private val hashCode: Int by lazy {
        Objects.hash(md, value, bbox, language, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CodeItem{md=$md, value=$value, bbox=$bbox, language=$language, type=$type, additionalProperties=$additionalProperties}"
}
