...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HeaderItem].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(headerItem: HeaderItem) = apply {
            items = headerItem.items.map { it.toMutableList() }
            md = headerItem.md
            bbox = headerItem.bbox.map { it.toMutableList() }
            type = headerItem.type
            additionalProperties = headerItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HeaderItem].
         *
    ...
    private constructor(
        ...
        override fun hashCode(): Int = Objects.hash(text, heading, list, code, table, image, link)
    ...
    override fun toString() =
        "HeaderItem{items=$items, md=$md, bbox=$bbox, type=$type, additionalProperties=$additionalProperties}"
}
