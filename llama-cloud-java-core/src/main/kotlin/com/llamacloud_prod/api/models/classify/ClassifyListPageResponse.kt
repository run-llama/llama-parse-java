...
class ClassifyListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<ClassifyListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<ClassifyListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<ClassifyListResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<ClassifyListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassifyListPageResponse].
         *
    ...
    /** A builder for [ClassifyListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<ClassifyListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(classifyListPageResponse: ClassifyListPageResponse) = apply {
            items = classifyListPageResponse.items.map { it.toMutableList() }
            nextPageToken = classifyListPageResponse.nextPageToken
            totalSize = classifyListPageResponse.totalSize
            additionalProperties = classifyListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<ClassifyListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<ClassifyListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<ClassifyListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ClassifyListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ClassifyListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [ClassifyListPageResponse].
         *
         ...
         */
        fun build(): ClassifyListPageResponse =
            ClassifyListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): ClassifyListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassifyListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "ClassifyListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
