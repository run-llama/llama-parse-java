...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IndexGetResponse].
         *
    ...
    /** A builder for [IndexGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(indexGetResponse: IndexGetResponse) = apply {
            ...
            createdAt = indexGetResponse.createdAt
            description = indexGetResponse.description
        ...
        /**
         * Returns an immutable instance of [IndexGetResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): IndexGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IndexGetResponse &&
            id == other.id &&
