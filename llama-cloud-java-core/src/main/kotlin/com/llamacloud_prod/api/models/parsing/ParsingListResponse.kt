...
private constructor(
    ...
    override fun toString() =
        "ParsingListResponse{id=$id, projectId=$projectId, status=$status, createdAt=$createdAt, errorMessage=$errorMessage, name=$name, tier=$tier, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
