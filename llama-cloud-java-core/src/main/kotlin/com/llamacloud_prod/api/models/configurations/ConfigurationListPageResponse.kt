...
class ConfigurationListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<ConfigurationResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<ConfigurationResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<ConfigurationResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<ConfigurationResponse>> = items
    ...
    /** A builder for [ConfigurationListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<ConfigurationResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(configurationListPageResponse: ConfigurationListPageResponse) = apply {
            items = configurationListPageResponse.items.map { it.toMutableList() }
            nextPageToken = configurationListPageResponse.nextPageToken
            totalSize = configurationListPageResponse.totalSize
            additionalProperties = configurationListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<ConfigurationResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<ConfigurationResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<ConfigurationResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ConfigurationResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ConfigurationResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [ConfigurationListPageResponse].
         *
         ...
         */
        fun build(): ConfigurationListPageResponse =
            ConfigurationListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): ConfigurationListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConfigurationListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "ConfigurationListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
