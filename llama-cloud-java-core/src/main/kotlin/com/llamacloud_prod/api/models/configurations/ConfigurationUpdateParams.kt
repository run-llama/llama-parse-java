...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ConfigurationUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(configurationUpdateParams: ConfigurationUpdateParams) = apply {
            configId = configurationUpdateParams.configId
            organizationId = configurationUpdateParams.organizationId
            projectId = configurationUpdateParams.projectId
        ...
        fun parameters(splitV1: SplitV1Parameters) = apply { body.parameters(splitV1) }
         ...
         * ```
         */
        fun splitV1Parameters(categories: List<SplitCategory>) = apply {
            body.splitV1Parameters(categories)
        }

        /** Alias for calling [parameters] with `Parameters.ofExtractV2(extractV2)`. */
        fun parameters(extractV2: ExtractV2Parameters) = apply { body.parameters(extractV2) }
         ...
         * ```
         */
        fun extractV2Parameters(dataSchema: ExtractV2Parameters.DataSchema) = apply {
            body.extractV2Parameters(dataSchema)
        }

        /** Alias for calling [parameters] with `Parameters.ofClassifyV2(classifyV2)`. */
        fun parameters(classifyV2: ClassifyV2Parameters) = apply { body.parameters(classifyV2) }
         ...
         * ```
         */
        fun classifyV2Parameters(rules: List<ClassifyV2Parameters.Rule>) = apply {
            body.classifyV2Parameters(rules)
        }

        /** Alias for calling [parameters] with `Parameters.ofParseV2(parseV2)`. */
        fun parameters(parseV2: ParseV2Parameters) = apply { body.parameters(parseV2) }

        /** Alias for calling [parameters] with `Parameters.ofSpreadsheetV1(spreadsheetV1)`. */
        fun parameters(spreadsheetV1: Parameters.SpreadsheetV1) = apply {
            body.parameters(spreadsheetV1)
        }

        /** Alias for calling [parameters] with `Parameters.ofUnknown(unknown)`. */
        fun parameters(unknown: UntypedParameters) = apply { body.parameters(unknown) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(name, parameters, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{name=$name, parameters=$parameters, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ConfigurationUpdateParams{configId=$configId, organizationId=$organizationId, projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
