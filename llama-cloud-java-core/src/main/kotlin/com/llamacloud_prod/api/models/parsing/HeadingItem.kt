...
private constructor(
    ...
    ) : this(level, md, value, bbox, type, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HeadingItem].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(headingItem: HeadingItem) = apply {
            level = headingItem.level
            md = headingItem.md
            value = headingItem.value
            bbox = headingItem.bbox.map { it.toMutableList() }
            type = headingItem.type
            additionalProperties = headingItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HeadingItem].
         *
     ...
     *   expected type.
     */
    fun validate(): HeadingItem = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val HEADING = of("heading")
    ...
    private val hashCode: Int by lazy {
        Objects.hash(level, md, value, bbox, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "HeadingItem{level=$level, md=$md, value=$value, bbox=$bbox, type=$type, additionalProperties=$additionalProperties}"
}
