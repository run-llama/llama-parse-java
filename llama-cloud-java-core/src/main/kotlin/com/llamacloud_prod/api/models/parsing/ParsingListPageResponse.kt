...
private constructor(
    private val items: JsonField<List<ParsingListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<ParsingListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<ParsingListResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<ParsingListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParsingListPageResponse].
         *
    ...
    /** A builder for [ParsingListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<ParsingListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(parsingListPageResponse: ParsingListPageResponse) = apply {
            items = parsingListPageResponse.items.map { it.toMutableList() }
            nextPageToken = parsingListPageResponse.nextPageToken
            totalSize = parsingListPageResponse.totalSize
            additionalProperties = parsingListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<ParsingListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<ParsingListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<ParsingListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ParsingListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ParsingListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [ParsingListPageResponse].
         *
         ...
         */
        fun build(): ParsingListPageResponse =
            ParsingListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): ParsingListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParsingListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "ParsingListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
