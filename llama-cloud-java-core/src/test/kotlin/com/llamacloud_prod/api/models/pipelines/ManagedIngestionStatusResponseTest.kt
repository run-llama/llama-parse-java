    ...
    fun create() {
        val managedIngestionStatusResponse =
            ManagedIngestionStatusResponse.builder()
                .status(ManagedIngestionStatusResponse.Status.NOT_STARTED)
                ...
                .addError(
                    ManagedIngestionStatusResponse.Error.builder()
                        ...
                        .message("message")
                        .step(ManagedIngestionStatusResponse.Error.Step.MANAGED_INGESTION)
                        .build()
                )
                .jobId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                .build()
        ...
        assertThat(managedIngestionStatusResponse.status())
            .isEqualTo(ManagedIngestionStatusResponse.Status.NOT_STARTED)
