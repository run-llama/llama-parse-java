    ...
    fun create() {
        val pipelineDataSource =
            PipelineDataSource.builder()
                ...
                .sourceType(PipelineDataSource.SourceType.S3)
                ...
                .status(PipelineDataSource.Status.NOT_STARTED)
        ...
        assertThat(pipelineDataSource.sourceType()).isEqualTo(PipelineDataSource.SourceType.S3)
        ...
        assertThat(pipelineDataSource.status()).contains(PipelineDataSource.Status.NOT_STARTED)
