    ...
    fun create() {
        val classifyListResponse =
            ClassifyListResponse.builder()
                ...
                .documentInputType(ClassifyListResponse.DocumentInputType.URL)
                .fileInput("file_input")
                .projectId("project_id")
                .status(ClassifyListResponse.Status.PENDING)
                .userId("user_id")
        ...
        assertThat(classifyListResponse.documentInputType())
            .isEqualTo(ClassifyListResponse.DocumentInputType.URL)
        ...
        assertThat(classifyListResponse.status()).isEqualTo(ClassifyListResponse.Status.PENDING)
