    ...
    fun create() {
        val classifyGetResponse =
            ClassifyGetResponse.builder()
                ...
                .documentInputType(ClassifyGetResponse.DocumentInputType.URL)
                .fileInput("file_input")
                .projectId("project_id")
                .status(ClassifyGetResponse.Status.PENDING)
                .userId("user_id")
        ...
        assertThat(classifyGetResponse.documentInputType())
            .isEqualTo(ClassifyGetResponse.DocumentInputType.URL)
        ...
        assertThat(classifyGetResponse.status()).isEqualTo(ClassifyGetResponse.Status.PENDING)
