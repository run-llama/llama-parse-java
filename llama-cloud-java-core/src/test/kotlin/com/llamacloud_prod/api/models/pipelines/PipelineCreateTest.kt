...
internal class PipelineCreateTest {
    ...
    fun create() {
        ...
        assertThat(pipelineCreate.name()).isEqualTo("x")
        assertThat(pipelineCreate.dataSink())
            .contains(
                DataSinkCreate.builder()
                    .component(
                        DataSinkCreate.Component.UnionMember0.builder()
        ...
        assertThat(pipelineCreate.embeddingConfig())
            .contains(
                PipelineCreate.EmbeddingConfig.ofAzureEmbedding(
                    AzureOpenAIEmbeddingConfig.builder()
                        .component(
                            AzureOpenAIEmbedding.builder()
                                .additionalKwargs(
        ...
        assertThat(pipelineCreate.embeddingModelConfigId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(pipelineCreate.llamaParseParameters())
            .contains(
                LlamaParseParameters.builder()
                    .adaptiveLongTable(true)
                    .aggressiveTableExtraction(true)
        ...
        assertThat(pipelineCreate.managedPipelineId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(pipelineCreate.metadataConfig())
            .contains(
                PipelineMetadataConfig.builder()
                    .addExcludedEmbedMetadataKey("string")
                    .addExcludedLlmMetadataKey("string")
        ...
        assertThat(pipelineCreate.sparseModelConfig())
            .contains(
                SparseModelConfig.builder()
                    .className("class_name")
                    .modelType(SparseModelConfig.ModelType.SPLADE)
        ...
        assertThat(pipelineCreate.transformConfig())
            .contains(
                PipelineCreate.TransformConfig.ofAuto(
                    AutoTransformConfig.builder()
                        .chunkOverlap(0L)
                        .chunkSize(1L)
                        .mode(AutoTransformConfig.Mode.AUTO)
    ...
    fun roundtrip() {
        ...
        val roundtrippedPipelineCreate =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(pipelineCreate),
                jacksonTypeRef<PipelineCreate>(),
            )

        assertThat(roundtrippedPipelineCreate).isEqualTo(pipelineCreate)
    }
}
