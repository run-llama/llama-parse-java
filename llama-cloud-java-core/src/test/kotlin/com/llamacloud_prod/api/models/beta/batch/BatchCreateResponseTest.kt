    ...
    fun create() {
        val batchCreateResponse =
            BatchCreateResponse.builder()
                ...
                .jobType(BatchCreateResponse.JobType.PARSE)
                .projectId("proj-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee")
                .status(BatchCreateResponse.Status.PENDING)
                .totalItems(0L)
        ...
        assertThat(batchCreateResponse.jobType()).isEqualTo(BatchCreateResponse.JobType.PARSE)
        assertThat(batchCreateResponse.projectId())
            .isEqualTo("proj-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee")
        assertThat(batchCreateResponse.status()).isEqualTo(BatchCreateResponse.Status.PENDING)
