...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.llamacloud_prod.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.llamacloud_prod.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.llamacloud_prod.api.** {
    <init>(...);
