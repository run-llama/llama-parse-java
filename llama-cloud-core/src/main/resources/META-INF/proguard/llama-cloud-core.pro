...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class ai.llamaindex.llamacloud.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class ai.llamaindex.llamacloud.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class ai.llamaindex.llamacloud.** {
    <init>(...);
