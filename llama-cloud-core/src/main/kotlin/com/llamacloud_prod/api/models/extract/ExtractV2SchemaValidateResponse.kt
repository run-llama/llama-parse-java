...
private constructor(
    ...
    /** A builder for [ExtractV2SchemaValidateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(extractV2SchemaValidateResponse: ExtractV2SchemaValidateResponse) =
            apply {
                dataSchema = extractV2SchemaValidateResponse.dataSchema
                additionalProperties =
                    extractV2SchemaValidateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ExtractV2SchemaValidateResponse].
         *
         ...
         */
        fun build(): ExtractV2SchemaValidateResponse =
            ExtractV2SchemaValidateResponse(
     ...
     *   expected type.
     */
    fun validate(): ExtractV2SchemaValidateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExtractV2SchemaValidateResponse &&
    ...
    override fun toString() =
        "ExtractV2SchemaValidateResponse{dataSchema=$dataSchema, additionalProperties=$additionalProperties}"
}
