...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DataSinkDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DataSinkDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DataSinkDeleteParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DataSinkDeleteParams].
         *
