...
private constructor(
    private val items: JsonField<List<BatchListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<BatchListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<BatchListResponse> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<BatchListResponse>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<BatchListResponse>>? = null
        ...
        internal fun from(batchListPageResponse: BatchListPageResponse) = apply {
            items = batchListPageResponse.items.map { it.toMutableList() }
            nextPageToken = batchListPageResponse.nextPageToken
            totalSize = batchListPageResponse.totalSize
            additionalProperties = batchListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<BatchListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<BatchListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<BatchListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [BatchListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: BatchListResponse) = apply {
            items =
    ...
    override fun toString() =
        "BatchListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
