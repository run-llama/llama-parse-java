...
private constructor(
    ...
    ) : this(topN, type, mutableMapOf())

    /**
     * The number of nodes to retrieve after reranking over retrieved nodes from all retrieval
     * tools.
     *
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ReRankConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ReRankConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(reRankConfig: ReRankConfig) = apply {
            topN = reRankConfig.topN
            type = reRankConfig.type
            additionalProperties = reRankConfig.additionalProperties.toMutableMap()
        }
         ...
         * tools.
         */
        fun topN(topN: Long) = topN(JsonField.of(topN))
        ...
        /**
         * Returns an immutable instance of [ReRankConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ReRankConfig = ReRankConfig(topN, type, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ReRankConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (topN.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReRankConfig &&
            topN == other.topN &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(topN, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ReRankConfig{topN=$topN, type=$type, additionalProperties=$additionalProperties}"
}
