...
private constructor(
    private val items: JsonField<List<IndexListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<IndexListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<IndexListResponse> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<IndexListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IndexListPageResponse].
         *
    ...
    /** A builder for [IndexListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<IndexListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(indexListPageResponse: IndexListPageResponse) = apply {
            items = indexListPageResponse.items.map { it.toMutableList() }
            nextPageToken = indexListPageResponse.nextPageToken
            totalSize = indexListPageResponse.totalSize
            additionalProperties = indexListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<IndexListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<IndexListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<IndexListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [IndexListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: IndexListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [IndexListPageResponse].
         *
         ...
         */
        fun build(): IndexListPageResponse =
            IndexListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): IndexListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IndexListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "IndexListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
