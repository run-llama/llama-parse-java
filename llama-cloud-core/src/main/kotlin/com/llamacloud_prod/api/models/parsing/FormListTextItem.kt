...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FormListTextItem].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(formListTextItem: FormListTextItem) = apply {
            ...
            additionalProperties = formListTextItem.additionalProperties.toMutableMap()
        }
    ...
    private val hashCode: Int by lazy { Objects.hash(md, value, type, additionalProperties) }
