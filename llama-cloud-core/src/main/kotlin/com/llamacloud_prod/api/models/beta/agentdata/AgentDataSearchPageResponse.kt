...
private constructor(
    private val items: JsonField<List<AgentData>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<AgentData>> = JsonMissing.of(),
     ...
     */
    fun items(): List<AgentData> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<AgentData>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentDataSearchPageResponse].
         *
    ...
    /** A builder for [AgentDataSearchPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<AgentData>>? = null
        ...
        @JvmSynthetic
        internal fun from(agentDataSearchPageResponse: AgentDataSearchPageResponse) = apply {
            items = agentDataSearchPageResponse.items.map { it.toMutableList() }
            nextPageToken = agentDataSearchPageResponse.nextPageToken
            totalSize = agentDataSearchPageResponse.totalSize
            additionalProperties = agentDataSearchPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<AgentData>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<AgentData>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<AgentData>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentData] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: AgentData) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [AgentDataSearchPageResponse].
         *
         ...
         */
        fun build(): AgentDataSearchPageResponse =
            AgentDataSearchPageResponse(
     ...
     *   expected type.
     */
    fun validate(): AgentDataSearchPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentDataSearchPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "AgentDataSearchPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
