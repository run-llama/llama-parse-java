 ...
 *
 * Includes tier selection, processing options, output formatting, page targeting, and webhook
 * delivery. Refer to the LlamaParse documentation for details on each field.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("crop_box") @ExcludeMissing cropBox: JsonField<CropBox> = JsonMissing.of(),
     ...
     */
    fun agenticOptions(): Optional<AgenticOptions> = agenticOptions.getOptional("agentic_options")
     ...
     * ```java
     * MyClass myObject = parseV2Parameters.fastOptions().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParseV2Parameters].
         *
    ...
    /** A builder for [ParseV2Parameters]. */
    class Builder internal constructor() {

        private var productType: JsonValue = JsonValue.from("parse_v2")
        ...
        @JvmSynthetic
        internal fun from(parseV2Parameters: ParseV2Parameters) = apply {
            productType = parseV2Parameters.productType
            tier = parseV2Parameters.tier
            version = parseV2Parameters.version
            agenticOptions = parseV2Parameters.agenticOptions
            clientName = parseV2Parameters.clientName
            cropBox = parseV2Parameters.cropBox
            disableCache = parseV2Parameters.disableCache
            fastOptions = parseV2Parameters.fastOptions
         ...
         */
        fun disableCache(disableCache: Boolean?) = disableCache(JsonField.ofNullable(disableCache))
        ...
        /** Output formatting options for markdown, text, and extracted images */
        fun outputOptions(outputOptions: OutputOptions) = outputOptions(JsonField.of(outputOptions))
        ...
        /**
         * Returns an immutable instance of [ParseV2Parameters].
         *
     ...
     *   expected type.
     */
    fun validate(): ParseV2Parameters = apply {
        if (validated) {
            return@apply
        }

        _productType().let {
            if (it != JsonValue.from("parse_v2")) {
    ...
    internal fun validity(): Int =
        productType.let { if (it == JsonValue.from("parse_v2")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParseV2Parameters &&
