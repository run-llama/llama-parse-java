...
class ParsingMode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [ParsingMode]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [ParsingMode] can contain an unknown value in a couple of cases:
     ...
     *   expected type.
     */
    fun validate(): ParsingMode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParsingMode && value == other.value
    }
