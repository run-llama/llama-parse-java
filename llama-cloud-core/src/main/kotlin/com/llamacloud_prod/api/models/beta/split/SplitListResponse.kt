...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(splitListResponse: SplitListResponse) = apply {
            ...
            documentInput = splitListResponse.documentInput
    ...
    override fun toString() =
        "SplitListResponse{id=$id, categories=$categories, documentInput=$documentInput, projectId=$projectId, status=$status, userId=$userId, configurationId=$configurationId, createdAt=$createdAt, errorMessage=$errorMessage, result=$result, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
