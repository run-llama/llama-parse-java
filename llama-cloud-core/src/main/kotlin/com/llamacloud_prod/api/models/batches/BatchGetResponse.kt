...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchGetResponse].
         *
    ...
    /** A builder for [BatchGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetResponse: BatchGetResponse) = apply {
            id = batchGetResponse.id
            config = batchGetResponse.config
            projectId = batchGetResponse.projectId
            sourceDirectoryId = batchGetResponse.sourceDirectoryId
            status = batchGetResponse.status
            createdAt = batchGetResponse.createdAt
            results = batchGetResponse.results.map { it.toMutableList() }
            updatedAt = batchGetResponse.updatedAt
            additionalProperties = batchGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): BatchGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetResponse &&
            id == other.id &&
            config == other.config &&
    ...
    override fun toString() =
        "BatchGetResponse{id=$id, config=$config, projectId=$projectId, sourceDirectoryId=$sourceDirectoryId, status=$status, createdAt=$createdAt, results=$results, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
