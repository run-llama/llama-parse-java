...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileUpdateResponse: FileUpdateResponse) = apply {
            ...
            directoryId = fileUpdateResponse.directoryId
            displayName = fileUpdateResponse.displayName
            projectId = fileUpdateResponse.projectId
            uniqueId = fileUpdateResponse.uniqueId
            createdAt = fileUpdateResponse.createdAt
            deletedAt = fileUpdateResponse.deletedAt
            downloadUrl = fileUpdateResponse.downloadUrl
    ...
    override fun toString() =
        "FileUpdateResponse{id=$id, directoryId=$directoryId, displayName=$displayName, projectId=$projectId, uniqueId=$uniqueId, createdAt=$createdAt, deletedAt=$deletedAt, downloadUrl=$downloadUrl, fileId=$fileId, metadata=$metadata, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
