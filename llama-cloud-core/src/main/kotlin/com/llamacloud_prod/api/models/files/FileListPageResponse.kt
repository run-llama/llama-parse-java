...
private constructor(
    private val items: JsonField<List<FileListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<FileListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<FileListResponse> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<FileListResponse>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<FileListResponse>>? = null
        ...
        internal fun from(fileListPageResponse: FileListPageResponse) = apply {
            items = fileListPageResponse.items.map { it.toMutableList() }
            nextPageToken = fileListPageResponse.nextPageToken
            totalSize = fileListPageResponse.totalSize
            additionalProperties = fileListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<FileListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<FileListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<FileListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [FileListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: FileListResponse) = apply {
            items =
    ...
    override fun toString() =
        "FileListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
