...
interface SheetServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /api/v1/sheets/jobs`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /api/v1/sheets/jobs`, but is otherwise the same as
         * [SheetServiceAsync.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /api/v1/sheets/jobs/{spreadsheet_job_id}`, but is
         * otherwise the same as [SheetServiceAsync.deleteJob].
         */
        fun deleteJob(
            spreadsheetJobId: String
        ...
        /**
         * Returns a raw HTTP response for `get /api/v1/sheets/jobs/{spreadsheet_job_id}`, but is
         * otherwise the same as [SheetServiceAsync.get].
         */
         ...
         * /api/v1/sheets/jobs/{spreadsheet_job_id}/regions/{region_id}/result/{region_type}`, but
         * is otherwise the same as [SheetServiceAsync.getResultTable].
         */
        fun getResultTable(
            regionType: SheetGetResultTableParams.RegionType,
            params: SheetGetResultTableParams,
