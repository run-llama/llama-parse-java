...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchCreateResponse: BatchCreateResponse) = apply {
            ...
            sourceDirectoryId = batchCreateResponse.sourceDirectoryId
    ...
    override fun toString() =
        "BatchCreateResponse{id=$id, config=$config, projectId=$projectId, sourceDirectoryId=$sourceDirectoryId, status=$status, createdAt=$createdAt, results=$results, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
