...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2ProjectListResponse].
         *
    ...
    /** A builder for [V2ProjectListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v2ProjectListResponse: V2ProjectListResponse) = apply {
            id = v2ProjectListResponse.id
            name = v2ProjectListResponse.name
            organizationId = v2ProjectListResponse.organizationId
            createdAt = v2ProjectListResponse.createdAt
            isDefault = v2ProjectListResponse.isDefault
            updatedAt = v2ProjectListResponse.updatedAt
            additionalProperties = v2ProjectListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [V2ProjectListResponse].
         *
         ...
         */
        fun build(): V2ProjectListResponse =
     ...
     *   expected type.
     */
    fun validate(): V2ProjectListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V2ProjectListResponse &&
            id == other.id &&
            name == other.name &&
    ...
    override fun toString() =
        "V2ProjectListResponse{id=$id, name=$name, organizationId=$organizationId, createdAt=$createdAt, isDefault=$isDefault, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
