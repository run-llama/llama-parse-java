...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirectoryGetResponse].
         *
    ...
    /** A builder for [DirectoryGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(directoryGetResponse: DirectoryGetResponse) = apply {
            id = directoryGetResponse.id
            name = directoryGetResponse.name
            projectId = directoryGetResponse.projectId
            connectorSubscriptionId = directoryGetResponse.connectorSubscriptionId
            createdAt = directoryGetResponse.createdAt
            deletedAt = directoryGetResponse.deletedAt
            description = directoryGetResponse.description
            expiresAt = directoryGetResponse.expiresAt
            systemMetadata = directoryGetResponse.systemMetadata
            type = directoryGetResponse.type
            updatedAt = directoryGetResponse.updatedAt
            additionalProperties = directoryGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DirectoryGetResponse].
         *
         ...
         */
        fun build(): DirectoryGetResponse =
     ...
     *   expected type.
     */
    fun validate(): DirectoryGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirectoryGetResponse &&
            id == other.id &&
            name == other.name &&
    ...
    override fun toString() =
        "DirectoryGetResponse{id=$id, name=$name, projectId=$projectId, connectorSubscriptionId=$connectorSubscriptionId, createdAt=$createdAt, deletedAt=$deletedAt, description=$description, expiresAt=$expiresAt, systemMetadata=$systemMetadata, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
