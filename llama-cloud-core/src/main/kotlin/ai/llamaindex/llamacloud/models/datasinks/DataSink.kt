...
private constructor(
    ...
    ) : this(id, component, name, projectId, sinkType, createdAt, updatedAt, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DataSink].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataSink: DataSink) = apply {
            id = dataSink.id
            component = dataSink.component
            name = dataSink.name
            projectId = dataSink.projectId
            sinkType = dataSink.sinkType
            createdAt = dataSink.createdAt
            updatedAt = dataSink.updatedAt
            additionalProperties = dataSink.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DataSink].
         *
    ...
    override fun toString() =
        "DataSink{id=$id, component=$component, name=$name, projectId=$projectId, sinkType=$sinkType, createdAt=$createdAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
