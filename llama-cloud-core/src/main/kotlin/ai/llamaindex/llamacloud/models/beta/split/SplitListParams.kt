...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(splitListParams: SplitListParams) = apply {
            createdAtOnOrAfter = splitListParams.createdAtOnOrAfter
            createdAtOnOrBefore = splitListParams.createdAtOnOrBefore
            jobIds = splitListParams.jobIds?.toMutableList()
            organizationId = splitListParams.organizationId
            pageSize = splitListParams.pageSize
            pageToken = splitListParams.pageToken
            projectId = splitListParams.projectId
    ...
    override fun toString() =
        "SplitListParams{createdAtOnOrAfter=$createdAtOnOrAfter, createdAtOnOrBefore=$createdAtOnOrBefore, jobIds=$jobIds, organizationId=$organizationId, pageSize=$pageSize, pageToken=$pageToken, projectId=$projectId, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
