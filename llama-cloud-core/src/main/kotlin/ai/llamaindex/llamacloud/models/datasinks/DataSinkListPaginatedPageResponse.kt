...
class DataSinkListPaginatedPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<DataSink>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<DataSink>> = JsonMissing.of(),
     ...
     */
    fun items(): List<DataSink> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<DataSink>> = items
    ...
    /** A builder for [DataSinkListPaginatedPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<DataSink>>? = null
        ...
        @JvmSynthetic
        internal fun from(dataSinkListPaginatedPageResponse: DataSinkListPaginatedPageResponse) =
            apply {
                items = dataSinkListPaginatedPageResponse.items.map { it.toMutableList() }
                nextPageToken = dataSinkListPaginatedPageResponse.nextPageToken
                totalSize = dataSinkListPaginatedPageResponse.totalSize
                additionalProperties =
                    dataSinkListPaginatedPageResponse.additionalProperties.toMutableMap()
            }

        /** The list of items. */
        fun items(items: List<DataSink>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<DataSink>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun items(items: JsonField<List<DataSink>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [DataSink] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: DataSink) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [DataSinkListPaginatedPageResponse].
         *
         ...
         */
        fun build(): DataSinkListPaginatedPageResponse =
            DataSinkListPaginatedPageResponse(
     ...
     *   expected type.
     */
    fun validate(): DataSinkListPaginatedPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DataSinkListPaginatedPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "DataSinkListPaginatedPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
