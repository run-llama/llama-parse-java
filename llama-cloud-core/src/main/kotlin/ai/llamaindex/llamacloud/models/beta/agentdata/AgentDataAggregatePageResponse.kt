...
private constructor(
    private val items: JsonField<List<AgentDataAggregateResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<AgentDataAggregateResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<AgentDataAggregateResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<AgentDataAggregateResponse>> = items
    ...
    /** A builder for [AgentDataAggregatePageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<AgentDataAggregateResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(agentDataAggregatePageResponse: AgentDataAggregatePageResponse) = apply {
            items = agentDataAggregatePageResponse.items.map { it.toMutableList() }
            nextPageToken = agentDataAggregatePageResponse.nextPageToken
            totalSize = agentDataAggregatePageResponse.totalSize
            additionalProperties =
                agentDataAggregatePageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<AgentDataAggregateResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed
         * `List<AgentDataAggregateResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun items(items: JsonField<List<AgentDataAggregateResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentDataAggregateResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: AgentDataAggregateResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [AgentDataAggregatePageResponse].
         *
         ...
         */
        fun build(): AgentDataAggregatePageResponse =
            AgentDataAggregatePageResponse(
     ...
     *   expected type.
     */
    fun validate(): AgentDataAggregatePageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentDataAggregatePageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "AgentDataAggregatePageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
