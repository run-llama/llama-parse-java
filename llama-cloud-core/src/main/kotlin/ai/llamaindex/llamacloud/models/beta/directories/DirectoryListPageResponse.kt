...
private constructor(
    private val items: JsonField<List<DirectoryListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<DirectoryListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<DirectoryListResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<DirectoryListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirectoryListPageResponse].
         *
    ...
    /** A builder for [DirectoryListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<DirectoryListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(directoryListPageResponse: DirectoryListPageResponse) = apply {
            items = directoryListPageResponse.items.map { it.toMutableList() }
            nextPageToken = directoryListPageResponse.nextPageToken
            totalSize = directoryListPageResponse.totalSize
            additionalProperties = directoryListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<DirectoryListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<DirectoryListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<DirectoryListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [DirectoryListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: DirectoryListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [DirectoryListPageResponse].
         *
         ...
         */
        fun build(): DirectoryListPageResponse =
            DirectoryListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): DirectoryListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirectoryListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "DirectoryListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
