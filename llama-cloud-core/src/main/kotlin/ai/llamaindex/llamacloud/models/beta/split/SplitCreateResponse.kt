...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(splitCreateResponse: SplitCreateResponse) = apply {
            ...
            documentInput = splitCreateResponse.documentInput
    ...
    override fun toString() =
        "SplitCreateResponse{id=$id, categories=$categories, documentInput=$documentInput, projectId=$projectId, status=$status, userId=$userId, configurationId=$configurationId, createdAt=$createdAt, errorMessage=$errorMessage, result=$result, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
