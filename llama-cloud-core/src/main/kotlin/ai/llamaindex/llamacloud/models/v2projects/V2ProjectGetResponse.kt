...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2ProjectGetResponse].
         *
    ...
    /** A builder for [V2ProjectGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v2ProjectGetResponse: V2ProjectGetResponse) = apply {
            id = v2ProjectGetResponse.id
            name = v2ProjectGetResponse.name
            organizationId = v2ProjectGetResponse.organizationId
            createdAt = v2ProjectGetResponse.createdAt
            isDefault = v2ProjectGetResponse.isDefault
            updatedAt = v2ProjectGetResponse.updatedAt
            additionalProperties = v2ProjectGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [V2ProjectGetResponse].
         *
         ...
         */
        fun build(): V2ProjectGetResponse =
     ...
     *   expected type.
     */
    fun validate(): V2ProjectGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V2ProjectGetResponse &&
            id == other.id &&
            name == other.name &&
    ...
    override fun toString() =
        "V2ProjectGetResponse{id=$id, name=$name, organizationId=$organizationId, createdAt=$createdAt, isDefault=$isDefault, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
