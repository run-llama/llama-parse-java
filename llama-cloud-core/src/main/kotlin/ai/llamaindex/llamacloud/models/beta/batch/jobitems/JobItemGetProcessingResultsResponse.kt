...
private constructor(
    ...
    private val processingResults: JsonField<List<ProcessingResult>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        processingResults: JsonField<List<ProcessingResult>> = JsonMissing.of(),
    ) : this(itemId, itemName, processingResults, mutableMapOf())
     ...
     */
    fun processingResults(): Optional<List<ProcessingResult>> =
        processingResults.getOptional("processing_results")
    ...
    /**
     * Returns the raw JSON value of [processingResults].
     *
     * Unlike [processingResults], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("processing_results")
    @ExcludeMissing
    fun _processingResults(): JsonField<List<ProcessingResult>> = processingResults
    ...
    /** A builder for [JobItemGetProcessingResultsResponse]. */
    class Builder internal constructor() {

        private var itemId: JsonField<String>? = null
        private var itemName: JsonField<String>? = null
        private var processingResults: JsonField<MutableList<ProcessingResult>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            jobItemGetProcessingResultsResponse: JobItemGetProcessingResultsResponse
        ) = apply {
            itemId = jobItemGetProcessingResultsResponse.itemId
            itemName = jobItemGetProcessingResultsResponse.itemName
            processingResults =
                jobItemGetProcessingResultsResponse.processingResults.map { it.toMutableList() }
            additionalProperties =
                jobItemGetProcessingResultsResponse.additionalProperties.toMutableMap()
        }
        ...
        /** List of all processing operations performed on this item */
        fun processingResults(processingResults: List<ProcessingResult>) =
            processingResults(JsonField.of(processingResults))

        /**
         * Sets [Builder.processingResults] to an arbitrary JSON value.
         *
         * You should usually call [Builder.processingResults] with a well-typed
         * `List<ProcessingResult>` value instead. This method is primarily for setting the field to
         * an undocumented or not yet supported value.
         */
        fun processingResults(processingResults: JsonField<List<ProcessingResult>>) = apply {
            this.processingResults = processingResults.map { it.toMutableList() }
        }

        /**
         * Adds a single [ProcessingResult] to [processingResults].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addProcessingResult(processingResult: ProcessingResult) = apply {
            processingResults =
                (processingResults ?: JsonField.of(mutableListOf())).also {
                    checkKnown("processingResults", it).add(processingResult)
                }
        }
        ...
        /**
         * Returns an immutable instance of [JobItemGetProcessingResultsResponse].
         *
         ...
         */
        fun build(): JobItemGetProcessingResultsResponse =
            JobItemGetProcessingResultsResponse(
                checkRequired("itemId", itemId),
                checkRequired("itemName", itemName),
                (processingResults ?: JsonMissing.of()).map { it.toImmutable() },
     ...
     *   expected type.
     */
    fun validate(): JobItemGetProcessingResultsResponse = apply {
        if (validated) {
            return@apply
        }
        ...
        itemId()
        itemName()
        processingResults().ifPresent { it.forEach { it.validate() } }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (if (itemId.asKnown().isPresent) 1 else 0) +
            ...
            (processingResults.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    private constructor(
        ...
        private val outputS3Path: JsonField<String>,
        private val parametersHash: JsonField<String>,
        private val processedAt: JsonField<OffsetDateTime>,
        private val resultId: JsonField<String>,
        private val outputMetadata: JsonValue,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            jobType: JsonField<JobType> = JsonMissing.of(),
            @JsonProperty("output_s3_path")
            @ExcludeMissing
            outputS3Path: JsonField<String> = JsonMissing.of(),
            @JsonProperty("parameters_hash")
            @ExcludeMissing
            parametersHash: JsonField<String> = JsonMissing.of(),
            @JsonProperty("processed_at")
            @ExcludeMissing
            processedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("result_id")
            @ExcludeMissing
            resultId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("output_metadata")
            @ExcludeMissing
            outputMetadata: JsonValue = JsonMissing.of(),
        ) : this(
            itemId,
            jobConfig,
            jobType,
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun outputS3Path(): String = outputS3Path.getRequired("output_s3_path")
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun parametersHash(): String = parametersHash.getRequired("parameters_hash")
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun resultId(): String = resultId.getRequired("result_id")
         ...
         * ```java
         * MyClass myObject = processingResult.outputMetadata().convert(MyClass.class);
         * ```
         */
        @JsonProperty("output_metadata")
        @ExcludeMissing
        fun _outputMetadata(): JsonValue = outputMetadata
        ...
        /**
         * Returns the raw JSON value of [outputS3Path].
         *
         * Unlike [outputS3Path], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("output_s3_path")
        @ExcludeMissing
        fun _outputS3Path(): JsonField<String> = outputS3Path

        /**
         * Returns the raw JSON value of [parametersHash].
         *
         * Unlike [parametersHash], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("parameters_hash")
        @ExcludeMissing
        fun _parametersHash(): JsonField<String> = parametersHash
         ...
         */
        @JsonProperty("result_id") @ExcludeMissing fun _resultId(): JsonField<String> = resultId
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [ProcessingResult].
             *
             * The following fields are required:
             * ```java
             * .itemId()
        ...
        /** A builder for [ProcessingResult]. */
        class Builder internal constructor() {

            private var itemId: JsonField<String>? = null
            private var jobConfig: JsonField<JobConfig>? = null
            private var jobType: JsonField<JobType>? = null
            private var outputS3Path: JsonField<String>? = null
            private var parametersHash: JsonField<String>? = null
            private var processedAt: JsonField<OffsetDateTime>? = null
            private var resultId: JsonField<String>? = null
            private var outputMetadata: JsonValue = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(processingResult: ProcessingResult) = apply {
                itemId = processingResult.itemId
                jobConfig = processingResult.jobConfig
                jobType = processingResult.jobType
                outputS3Path = processingResult.outputS3Path
                parametersHash = processingResult.parametersHash
                processedAt = processingResult.processedAt
                resultId = processingResult.resultId
                outputMetadata = processingResult.outputMetadata
                additionalProperties = processingResult.additionalProperties.toMutableMap()
            }
             ...
             *
             * You should usually call [Builder.jobType] with a well-typed [JobType] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** Location of the processing output */
            fun outputS3Path(outputS3Path: String) = outputS3Path(JsonField.of(outputS3Path))

            /**
             * Sets [Builder.outputS3Path] to an arbitrary JSON value.
             *
             * You should usually call [Builder.outputS3Path] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun outputS3Path(outputS3Path: JsonField<String>) = apply {
                this.outputS3Path = outputS3Path
            }

            /** Content hash of the job configuration for dedup */
            fun parametersHash(parametersHash: String) =
                parametersHash(JsonField.of(parametersHash))

            /**
             * Sets [Builder.parametersHash] to an arbitrary JSON value.
             *
             * You should usually call [Builder.parametersHash] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun parametersHash(parametersHash: JsonField<String>) = apply {
             ...
             *
             * You should usually call [Builder.processedAt] with a well-typed [OffsetDateTime]
             ...
             *
             * You should usually call [Builder.resultId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Metadata about processing output.
             *
             * Currently empty - will be populated with job-type-specific metadata fields in the
             * future.
             */
            fun outputMetadata(outputMetadata: JsonValue) = apply {
            ...
            /**
             * Returns an immutable instance of [ProcessingResult].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): ProcessingResult =
                ProcessingResult(
                    checkRequired("itemId", itemId),
                    checkRequired("jobConfig", jobConfig),
                    checkRequired("jobType", jobType),
                    checkRequired("outputS3Path", outputS3Path),
                    checkRequired("parametersHash", parametersHash),
                    checkRequired("processedAt", processedAt),
                    checkRequired("resultId", resultId),
                    outputMetadata,
                    additionalProperties.toMutableMap(),
                )
        }
         ...
         *   expected type.
         */
        fun validate(): ProcessingResult = apply {
            if (validated) {
                return@apply
            }
        ...
        internal fun validity(): Int =
            (if (itemId.asKnown().isPresent) 1 else 0) +
                ...
                (if (outputS3Path.asKnown().isPresent) 1 else 0) +
                (if (parametersHash.asKnown().isPresent) 1 else 0) +
        ...
        private constructor(
            ...
            companion object {
                 ...
                 * workflow and combined with DirectoryFile data to create full ParseJobRecordCreate
                 ...
                 * cross-service tracking parent_job_execution_id: Parent job execution ID if nested
                 * user_id: User who created the job project_id: Project this job belongs to
                 * webhook_url: Optional webhook URL for job completion notifications
                 */
                @JvmStatic
                fun ofBatchParseJobRecordCreate(
                    batchParseJobRecordCreate: BatchParseJobRecordCreate
                ) = JobConfig(batchParseJobRecordCreate = batchParseJobRecordCreate)
            ...
            /**
             * An interface that defines how to map each variant of [JobConfig] to a value of type
             * [T].
             */
            interface Visitor<out T> {
                 ...
                 *
                 * An instance of [JobConfig] can contain an unknown variant if it was deserialized
            ...
            internal class Deserializer : BaseDeserializer<JobConfig>(JobConfig::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): JobConfig {
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(node, jacksonTypeRef<BatchParseJobRecordCreate>())
                                    ?.let {
            ...
            private constructor(
                 ...
                 *
                 * Unlike [correlationId], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("correlation_id")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [jobName], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("job_name")
                @ExcludeMissing
                fun _jobName(): JsonField<JobName> = jobName
                 ...
                 *
                 * Unlike [partitions], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("partitions")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(batchParseJobRecordCreate: BatchParseJobRecordCreate) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.correlationId] with a well-typed [String]
                     ...
                     * individual ParseJobRecordCreate instances for each file.
                     *
                     * The fields in this model should be generic settings that apply uniformly to
                     * all files being processed in the batch.
                     */
                     ...
                     *
                     * You should usually call [Builder.parentJobExecutionId] with a well-typed
                     ...
                     *
                     * You should usually call [Builder.partitions] with a well-typed [Partitions]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * The upstream request ID that created this job. Used for tracking the job
                     * across services.
                     */
                ...
                private constructor(
                     ...
                     *   type (e.g. if the server responded with an unexpected value).
                     */
                    fun annotateLinks(): Optional<Boolean> =
                        annotateLinks.getOptional("annotate_links")
                    ...
                    fun autoModeTriggerOnImageInPage(): Optional<Boolean> =
                        autoModeTriggerOnImageInPage.getOptional(
                    ...
                    fun autoModeTriggerOnRegexpInPage(): Optional<String> =
                        autoModeTriggerOnRegexpInPage.getOptional(
                    ...
                    fun autoModeTriggerOnTableInPage(): Optional<Boolean> =
                        autoModeTriggerOnTableInPage.getOptional(
                     ...
                     *   type (e.g. if the server responded with an unexpected value).
                     */
                    fun extractCharts(): Optional<Boolean> =
                        extractCharts.getOptional("extract_charts")

                    /**
                     * @throws LlamaCloudInvalidDataException if the JSON field has an unexpected
                     *   type (e.g. if the server responded with an unexpected value).
                     */
                    fun extractLayout(): Optional<Boolean> =
                        extractLayout.getOptional("extract_layout")
                     ...
                     *   type (e.g. if the server responded with an unexpected value).
                     */
                    fun inputS3Region(): Optional<String> =
                        inputS3Region.getOptional("input_s3_region")
                     ...
                     *   type (e.g. if the server responded with an unexpected value).
                     */
                    fun pageSeparator(): Optional<String> =
                        pageSeparator.getOptional("page_separator")
                    ...
                    fun presentationOutOfBoundsContent(): Optional<Boolean> =
                        presentationOutOfBoundsContent.getOptional(
                    ...
                    fun specializedChartParsingAgentic(): Optional<Boolean> =
                        specializedChartParsingAgentic.getOptional(
                    ...
                    fun spreadsheetIncludeHiddenSheets(): Optional<Boolean> =
                        spreadsheetIncludeHiddenSheets.getOptional(
                    ...
                    fun structuredOutputJsonSchemaName(): Optional<String> =
                        structuredOutputJsonSchemaName.getOptional(
                     ...
                     *
                     * Unlike [adaptiveLongTable], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("adaptive_long_table")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [aggressiveTableExtraction], this method doesn't throw if the JSON
                     ...
                     *
                     * Unlike [annotateRevisions], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("annotate_revisions")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [autoMode], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("auto_mode")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [autoModeConfigurationJson], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("auto_mode_configuration_json")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [autoModeTriggerOnTextInPage], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("auto_mode_trigger_on_text_in_page")
                    @ExcludeMissing
                    fun _autoModeTriggerOnTextInPage(): JsonField<String> =
                        autoModeTriggerOnTextInPage

                    /**
                     * Returns the raw JSON value of [azureOpenAIApiVersion].
                     *
                     * Unlike [azureOpenAIApiVersion], this method doesn't throw if the JSON field
                     ...
                     *
                     * Unlike [azureOpenAIDeploymentName], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("azure_openai_deployment_name")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [azureOpenAIEndpoint], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("azure_openai_endpoint")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [bboxLeft], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("bbox_left")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [bboxRight], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("bbox_right")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [bboxTop], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("bbox_top")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [compactMarkdownTable], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("compact_markdown_table")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [complementalFormattingInstruction], this method doesn't throw if the
                     ...
                     *
                     * Unlike [confidenceScoreEffort], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("confidence_score_effort")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [contentGuidelineInstruction], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("content_guideline_instruction")
                    @ExcludeMissing
                    fun _contentGuidelineInstruction(): JsonField<String> =
                        contentGuidelineInstruction
                     ...
                     *
                     * Unlike [disableImageExtraction], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("disable_image_extraction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [disableReconstruction], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("disable_reconstruction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [enableCostOptimizer], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("enable_cost_optimizer")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [extractPrintedPageNumber], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("extract_printed_page_number")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [fastMode], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("fast_mode")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [formattingInstruction], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("formatting_instruction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [gpt4oMode], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("gpt4o_mode")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [guessXlsxSheetName], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("guess_xlsx_sheet_name")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [htmlMakeAllElementsVisible], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("html_make_all_elements_visible")
                    @ExcludeMissing
                    fun _htmlMakeAllElementsVisible(): JsonField<Boolean> =
                        htmlMakeAllElementsVisible

                    /**
                     * Returns the raw JSON value of [htmlRemoveFixedElements].
                     *
                     * Unlike [htmlRemoveFixedElements], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("html_remove_fixed_elements")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [httpProxy], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("http_proxy")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [ignoreDocumentElementsForLayoutDetection], this method doesn't throw
                     ...
                     *
                     * Unlike [inlineImagesInMarkdown], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("inline_images_in_markdown")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [inputUrl], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("input_url")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [internalIsScreenshotJob], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("internal_is_screenshot_job")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [isFormattingInstruction], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("is_formatting_instruction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [jobTimeoutExtraTimePerPageInSeconds], this method doesn't throw if
                     ...
                     *
                     * Unlike [jobTimeoutInSeconds], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("job_timeout_in_seconds")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [languages], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("languages")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [lineLevelBoundingBox], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("line_level_bounding_box")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [markdownTableMultilineHeaderSeparator], this method doesn't throw if
                     * the JSON field has an unexpected type.
                     */
                    @JsonProperty("markdown_table_multiline_header_separator")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [maxPages], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("max_pages")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [mergeTablesAcrossPagesInMarkdown], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("merge_tables_across_pages_in_markdown")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [outlinedTableExtraction], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("outlined_table_extraction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [outputPdfOfDocument], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("output_pdf_of_document")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [outputS3PathPrefix], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("output_s3_path_prefix")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [outputTablesAsHtml], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("output_tables_as_HTML")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [pageErrorTolerance], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("page_error_tolerance")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [parseMode], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("parse_mode")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [parsingInstruction], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("parsing_instruction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [preciseBoundingBox], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("precise_bounding_box")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [presentationOutOfBoundsContent], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("presentation_out_of_bounds_content")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [preset], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("preset")
                    @ExcludeMissing
                    fun _preset(): JsonField<String> = preset

                    /**
                     * Returns the raw JSON value of [priority].
                     *
                     * Unlike [priority], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("priority")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [replaceFailedPageMode], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("replace_failed_page_mode")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [replaceFailedPageWithErrorMessagePrefix], this method doesn't throw
                     * if the JSON field has an unexpected type.
                     */
                    @JsonProperty("replace_failed_page_with_error_message_prefix")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [replaceFailedPageWithErrorMessageSuffix], this method doesn't throw
                     * if the JSON field has an unexpected type.
                     */
                    @JsonProperty("replace_failed_page_with_error_message_suffix")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [specializedChartParsingAgentic], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("specialized_chart_parsing_agentic")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [specializedChartParsingEfficient], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("specialized_chart_parsing_efficient")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [specializedChartParsingPlus], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("specialized_chart_parsing_plus")
                    @ExcludeMissing
                    fun _specializedChartParsingPlus(): JsonField<Boolean> =
                        specializedChartParsingPlus

                    /**
                     * Returns the raw JSON value of [specializedImageParsing].
                     *
                     * Unlike [specializedImageParsing], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("specialized_image_parsing")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [spreadsheetExtractSubTables], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("spreadsheet_extract_sub_tables")
                    @ExcludeMissing
                    fun _spreadsheetExtractSubTables(): JsonField<Boolean> =
                        spreadsheetExtractSubTables
                     ...
                     *
                     * Unlike [spreadsheetIncludeHiddenSheets], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("spreadsheet_include_hidden_sheets")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [strictModeBuggyFont], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("strict_mode_buggy_font")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [strictModeImageExtraction], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("strict_mode_image_extraction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [strictModeImageOcr], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("strict_mode_image_ocr")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [strictModeReconstruction], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("strict_mode_reconstruction")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [structuredOutputJsonSchema], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("structured_output_json_schema")
                    @ExcludeMissing
                    fun _structuredOutputJsonSchema(): JsonField<String> =
                        structuredOutputJsonSchema

                    /**
                     * Returns the raw JSON value of [structuredOutputJsonSchemaName].
                     *
                     * Unlike [structuredOutputJsonSchemaName], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("structured_output_json_schema_name")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [systemPromptAppend], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("system_prompt_append")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [useVendorMultimodalModel], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("use_vendor_multimodal_model")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [vendorMultimodalApiKey], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("vendor_multimodal_api_key")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [vendorMultimodalModelName], this method doesn't throw if the JSON
                     * field has an unexpected type.
                     */
                    @JsonProperty("vendor_multimodal_model_name")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [webhookConfigurations], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("webhook_configurations")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        private var autoModeTriggerOnImageInPage: JsonField<Boolean> =
                            JsonMissing.of()
                        private var autoModeTriggerOnRegexpInPage: JsonField<String> =
                            JsonMissing.of()
                        private var autoModeTriggerOnTableInPage: JsonField<Boolean> =
                            JsonMissing.of()
                        private var autoModeTriggerOnTextInPage: JsonField<String> =
                            JsonMissing.of()
                        ...
                        private var contentGuidelineInstruction: JsonField<String> =
                            JsonMissing.of()
                        ...
                        private var htmlMakeAllElementsVisible: JsonField<Boolean> =
                            JsonMissing.of()
                        private var htmlRemoveFixedElements: JsonField<Boolean> = JsonMissing.of()
                        private var htmlRemoveNavigationElements: JsonField<Boolean> =
                            JsonMissing.of()
                        ...
                        private var presentationOutOfBoundsContent: JsonField<Boolean> =
                            JsonMissing.of()
                        private var presentationSkipEmbeddedData: JsonField<Boolean> =
                            JsonMissing.of()
                        ...
                        private var replaceFailedPageMode: JsonField<FailPageMode> =
                            JsonMissing.of()
                        ...
                        private var specializedChartParsingEfficient: JsonField<Boolean> =
                            JsonMissing.of()
                        private var specializedChartParsingPlus: JsonField<Boolean> =
                            JsonMissing.of()
                        private var specializedImageParsing: JsonField<Boolean> = JsonMissing.of()
                        private var spreadsheetExtractSubTables: JsonField<Boolean> =
                            JsonMissing.of()
                        ...
                        private var structuredOutputJsonSchemaName: JsonField<String> =
                            JsonMissing.of()
                        ...
                        internal fun from(parameters: Parameters) = apply {
                            ...
                            confidenceScoreEffort = parameters.confidenceScoreEffort
                            ...
                            presentationOutOfBoundsContent =
                                parameters.presentationOutOfBoundsContent
                            ...
                            specializedChartParsingAgentic =
                                parameters.specializedChartParsingAgentic
                            specializedChartParsingEfficient =
                            ...
                            spreadsheetIncludeHiddenSheets =
                                parameters.spreadsheetIncludeHiddenSheets
                            ...
                            structuredOutputJsonSchemaName =
                                parameters.structuredOutputJsonSchemaName
                        ...
                        fun aggressiveTableExtraction(aggressiveTableExtraction: Boolean?) =
                            aggressiveTableExtraction(
                                JsonField.ofNullable(aggressiveTableExtraction)
                            )
                         ...
                         */
                        fun aggressiveTableExtraction(
                            aggressiveTableExtraction: Optional<Boolean>
                         ...
                         *
                         * You should usually call [Builder.aggressiveTableExtraction] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun aggressiveTableExtraction(
                            aggressiveTableExtraction: JsonField<Boolean>
                        ) = apply { this.aggressiveTableExtraction = aggressiveTableExtraction }
                        ...
                        /**
                         * Alias for calling [Builder.annotateLinks] with
                         * `annotateLinks.orElse(null)`.
                         */
                         ...
                         *
                         * You should usually call [Builder.annotateLinks] with a well-typed
                         * [Boolean] value instead. This method is primarily for setting the field
                         * to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.autoMode] with a well-typed [Boolean]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun autoMode(autoMode: JsonField<Boolean>) = apply {
                            this.autoMode = autoMode
                        }

                        fun autoModeConfigurationJson(autoModeConfigurationJson: String?) =
                            autoModeConfigurationJson(
                                JsonField.ofNullable(autoModeConfigurationJson)
                            )
                         ...
                         *
                         * You should usually call [Builder.autoModeConfigurationJson] with a
                         * well-typed [String] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun autoModeConfigurationJson(
                            autoModeConfigurationJson: JsonField<String>
                        ) = apply { this.autoModeConfigurationJson = autoModeConfigurationJson }
                        ...
                        fun autoModeTriggerOnTextInPage(
                            autoModeTriggerOnTextInPage: Optional<String>
                         ...
                         * an undocumented or not yet supported value.
                         */
                        fun azureOpenAIApiVersion(azureOpenAIApiVersion: JsonField<String>) =
                            apply {
                        ...
                        fun azureOpenAIDeploymentName(azureOpenAIDeploymentName: String?) =
                            azureOpenAIDeploymentName(
                                JsonField.ofNullable(azureOpenAIDeploymentName)
                            )
                         ...
                         *
                         * You should usually call [Builder.azureOpenAIDeploymentName] with a
                         * well-typed [String] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun azureOpenAIDeploymentName(
                            azureOpenAIDeploymentName: JsonField<String>
                        ) = apply { this.azureOpenAIDeploymentName = azureOpenAIDeploymentName }
                         ...
                         *
                         * You should usually call [Builder.azureOpenAIKey] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.bboxBottom] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.bboxLeft] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun bboxLeft(bboxLeft: JsonField<Double>) = apply {
                            this.bboxLeft = bboxLeft
                        }

                        fun bboxRight(bboxRight: Double?) =
                            bboxRight(JsonField.ofNullable(bboxRight))
                        ...
                        fun bboxRight(bboxRight: Optional<Double>) =
                            bboxRight(bboxRight.getOrNull())

                        /**
                         * Sets [Builder.bboxRight] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.bboxRight] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.bboxTop] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * Sets [Builder.complementalFormattingInstruction] to an arbitrary JSON
                         * value.
                         *
                         * You should usually call [Builder.complementalFormattingInstruction] with
                         * a well-typed [String] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun complementalFormattingInstruction(
                            complementalFormattingInstruction: JsonField<String>
                        ) = apply {
                            this.complementalFormattingInstruction =
                                complementalFormattingInstruction
                        }
                         ...
                         * an undocumented or not yet supported value.
                         */
                        fun confidenceScoreEffort(confidenceScoreEffort: JsonField<String>) =
                            apply {
                        ...
                        fun contentGuidelineInstruction(
                            contentGuidelineInstruction: Optional<String>
                         ...
                         *
                         * You should usually call [Builder.continuousMode] with a well-typed
                         * [Boolean] value instead. This method is primarily for setting the field
                         * to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.disableImageExtraction] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun disableImageExtraction(disableImageExtraction: JsonField<Boolean>) =
                            apply {
                         ...
                         * to an undocumented or not yet supported value.
                         */
                        fun disableReconstruction(disableReconstruction: JsonField<Boolean>) =
                            apply {
                        ...
                        /**
                         * Alias for calling [Builder.extractCharts] with
                         * `extractCharts.orElse(null)`.
                         */
                         ...
                         *
                         * You should usually call [Builder.extractCharts] with a well-typed
                         * [Boolean] value instead. This method is primarily for setting the field
                         * to an undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * Alias for calling [Builder.extractLayout] with
                         * `extractLayout.orElse(null)`.
                         */
                         ...
                         *
                         * You should usually call [Builder.extractLayout] with a well-typed
                         * [Boolean] value instead. This method is primarily for setting the field
                         * to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.extractPrintedPageNumber] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.fastMode] with a well-typed [Boolean]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun fastMode(fastMode: JsonField<Boolean>) = apply {
                         ...
                         * an undocumented or not yet supported value.
                         */
                        fun formattingInstruction(formattingInstruction: JsonField<String>) =
                            apply {
                        ...
                        fun gpt4oMode(gpt4oMode: Boolean?) =
                            gpt4oMode(JsonField.ofNullable(gpt4oMode))
                        ...
                        fun gpt4oMode(gpt4oMode: Optional<Boolean>) =
                            gpt4oMode(gpt4oMode.getOrNull())

                        /**
                         * Sets [Builder.gpt4oMode] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.gpt4oMode] with a well-typed [Boolean]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        ...
                        fun htmlMakeAllElementsVisible(htmlMakeAllElementsVisible: Boolean?) =
                            htmlMakeAllElementsVisible(
                                JsonField.ofNullable(htmlMakeAllElementsVisible)
                            )
                         ...
                         */
                        fun htmlMakeAllElementsVisible(
                            htmlMakeAllElementsVisible: Optional<Boolean>
                         ...
                         */
                        fun htmlMakeAllElementsVisible(
                            htmlMakeAllElementsVisible: JsonField<Boolean>
                        ) = apply { this.htmlMakeAllElementsVisible = htmlMakeAllElementsVisible }
                         ...
                         *
                         * You should usually call [Builder.htmlRemoveFixedElements] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        ...
                        fun httpProxy(httpProxy: String?) =
                            httpProxy(JsonField.ofNullable(httpProxy))

                        /** Alias for calling [Builder.httpProxy] with `httpProxy.orElse(null)`. */
                        fun httpProxy(httpProxy: Optional<String>) =
                            httpProxy(httpProxy.getOrNull())

                        /**
                         * Sets [Builder.httpProxy] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.httpProxy] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * Sets [Builder.ignoreDocumentElementsForLayoutDetection] to an arbitrary
                         * JSON value.
                         *
                         * You should usually call
                         * [Builder.ignoreDocumentElementsForLayoutDetection] with a well-typed
                         * [Boolean] value instead. This method is primarily for setting the field
                         * to an undocumented or not yet supported value.
                         */
                        fun ignoreDocumentElementsForLayoutDetection(
                        ...
                        /**
                         * Alias for calling [Builder.imagesToSave] with
                         * `imagesToSave.orElse(null)`.
                         */
                         ...
                         * `List<ImagesToSave>` value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.inlineImagesInMarkdown] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun inlineImagesInMarkdown(inlineImagesInMarkdown: JsonField<Boolean>) =
                            apply {
                        ...
                        /**
                         * Alias for calling [Builder.inputS3Region] with
                         * `inputS3Region.orElse(null)`.
                         */
                         ...
                         *
                         * You should usually call [Builder.inputS3Region] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.inputUrl] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun inputUrl(inputUrl: JsonField<String>) = apply {
                         ...
                         *
                         * You should usually call [Builder.internalIsScreenshotJob] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.invalidateCache] with a well-typed
                         * [Boolean] value instead. This method is primarily for setting the field
                         * to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.isFormattingInstruction] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                         ...
                         * value.
                         *
                         * You should usually call [Builder.jobTimeoutExtraTimePerPageInSeconds]
                         * with a well-typed [Double] value instead. This method is primarily for
                        ...
                        /**
                         * Sets [Builder.keepPageSeparatorWhenMergingTables] to an arbitrary JSON
                         * value.
                         *
                         * You should usually call [Builder.keepPageSeparatorWhenMergingTables] with
                        ...
                        fun keepPageSeparatorWhenMergingTables(
                            ...
                            this.keepPageSeparatorWhenMergingTables =
                                keepPageSeparatorWhenMergingTables
                        }
                         ...
                         * `List<ParsingLanguages>` value instead. This method is primarily for
                         * setting the field to an undocumented or not yet supported value.
                         */
                         ...
                         * value.
                         *
                         * You should usually call [Builder.markdownTableMultilineHeaderSeparator]
                         ...
                         *
                         * You should usually call [Builder.maxPagesEnforced] with a well-typed
                        ...
                        /**
                         * Sets [Builder.mergeTablesAcrossPagesInMarkdown] to an arbitrary JSON
                         * value.
                         *
                         ...
                         *
                         * You should usually call [Builder.outlinedTableExtraction] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.outputS3Region] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * Alias for calling [Builder.outputBucket] with
                         * `outputBucket.orElse(null)`.
                         */
                         ...
                         *
                         * You should usually call [Builder.pageFooterPrefix] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.pageFooterSuffix] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.pageHeaderPrefix] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.pageHeaderSuffix] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.pagePrefix] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * Alias for calling [Builder.pageSeparator] with
                         * `pageSeparator.orElse(null)`.
                         */
                         ...
                         *
                         * You should usually call [Builder.pageSeparator] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.pageSuffix] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.parseMode] with a well-typed
                         * [ParsingMode] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.pipelineId] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        ...
                        fun presentationOutOfBoundsContent(
                            ...
                            presentationOutOfBoundsContent(
                                presentationOutOfBoundsContent as Boolean?
                            )
                        ...
                        fun presentationOutOfBoundsContent(
                            ...
                            presentationOutOfBoundsContent(
                                presentationOutOfBoundsContent.getOrNull()
                            )
                         ...
                         *
                         * You should usually call [Builder.priority] with a well-typed [Priority]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun priority(priority: JsonField<Priority>) = apply {
                            this.priority = priority
                        }

                        fun projectId(projectId: String?) =
                            projectId(JsonField.ofNullable(projectId))

                        /** Alias for calling [Builder.projectId] with `projectId.orElse(null)`. */
                        fun projectId(projectId: Optional<String>) =
                            projectId(projectId.getOrNull())
                         ...
                         * [FailPageMode] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * Sets [Builder.replaceFailedPageWithErrorMessagePrefix] to an arbitrary
                         * JSON value.
                         *
                        ...
                        /**
                         * Sets [Builder.replaceFailedPageWithErrorMessageSuffix] to an arbitrary
                         * JSON value.
                         *
                        ...
                        /**
                         * Alias for calling [Builder.resourceInfo] with
                         * `resourceInfo.orElse(null)`.
                         */
                         ...
                         * [ResourceInfo] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                        ...
                        fun specializedChartParsingAgentic(
                            ...
                            specializedChartParsingAgentic(
                                specializedChartParsingAgentic as Boolean?
                            )
                        ...
                        fun specializedChartParsingAgentic(
                            ...
                            specializedChartParsingAgentic(
                                specializedChartParsingAgentic.getOrNull()
                            )
                        ...
                        /**
                         * Sets [Builder.specializedChartParsingEfficient] to an arbitrary JSON
                         * value.
                         *
                         ...
                         *
                         * You should usually call [Builder.specializedImageParsing] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        ...
                        /**
                         * Sets [Builder.spreadsheetForceFormulaComputation] to an arbitrary JSON
                         * value.
                         *
                         * You should usually call [Builder.spreadsheetForceFormulaComputation] with
                         * a well-typed [Boolean] value instead. This method is primarily for
                         * setting the field to an undocumented or not yet supported value.
                         */
                        fun spreadsheetForceFormulaComputation(
                            ...
                            this.spreadsheetForceFormulaComputation =
                                spreadsheetForceFormulaComputation
                        }

                        fun spreadsheetIncludeHiddenSheets(
                            spreadsheetIncludeHiddenSheets: Boolean?
                        ) =
                            spreadsheetIncludeHiddenSheets(
                        ...
                        fun spreadsheetIncludeHiddenSheets(
                            ...
                            spreadsheetIncludeHiddenSheets(
                                spreadsheetIncludeHiddenSheets as Boolean?
                            )
                        ...
                        fun spreadsheetIncludeHiddenSheets(
                            ...
                            spreadsheetIncludeHiddenSheets(
                                spreadsheetIncludeHiddenSheets.getOrNull()
                            )
                        ...
                        fun strictModeImageExtraction(strictModeImageExtraction: Boolean?) =
                            strictModeImageExtraction(
                                JsonField.ofNullable(strictModeImageExtraction)
                            )
                         ...
                         */
                        fun strictModeImageExtraction(
                            strictModeImageExtraction: Optional<Boolean>
                         ...
                         *
                         * You should usually call [Builder.strictModeImageExtraction] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun strictModeImageExtraction(
                            strictModeImageExtraction: JsonField<Boolean>
                        ) = apply { this.strictModeImageExtraction = strictModeImageExtraction }
                         ...
                         *
                         * You should usually call [Builder.strictModeReconstruction] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        ...
                        fun structuredOutputJsonSchema(structuredOutputJsonSchema: String?) =
                            structuredOutputJsonSchema(
                                JsonField.ofNullable(structuredOutputJsonSchema)
                            )
                         ...
                         */
                        fun structuredOutputJsonSchema(
                            structuredOutputJsonSchema: Optional<String>
                         ...
                         */
                        fun structuredOutputJsonSchema(
                            structuredOutputJsonSchema: JsonField<String>
                        ) = apply { this.structuredOutputJsonSchema = structuredOutputJsonSchema }
                        ...
                        fun structuredOutputJsonSchemaName(
                            ...
                            structuredOutputJsonSchemaName(
                                structuredOutputJsonSchemaName.getOrNull()
                            )
                        ...
                        /**
                         * Alias for calling [Builder.systemPrompt] with
                         * `systemPrompt.orElse(null)`.
                         */
                         ...
                         *
                         * You should usually call [Builder.takeScreenshot] with a well-typed
                         * [Boolean] value instead. This method is primarily for setting the field
                         * to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.useVendorMultimodalModel] with a
                         * well-typed [Boolean] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.userPrompt] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.vendorMultimodalApiKey] with a
                         * well-typed [String] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun vendorMultimodalApiKey(vendorMultimodalApiKey: JsonField<String>) =
                            apply {
                        ...
                        fun vendorMultimodalModelName(vendorMultimodalModelName: String?) =
                            vendorMultimodalModelName(
                                JsonField.ofNullable(vendorMultimodalModelName)
                            )
                         ...
                         *
                         * You should usually call [Builder.vendorMultimodalModelName] with a
                         * well-typed [String] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun vendorMultimodalModelName(
                            vendorMultimodalModelName: JsonField<String>
                        ) = apply { this.vendorMultimodalModelName = vendorMultimodalModelName }
                        ...
                        fun webhookConfigurations(
                            webhookConfigurations: List<WebhookConfiguration>?
                        ...
                        fun build(): Parameters =
                            Parameters(
                                ...
                                vendorMultimodalModelName,
                                version,
                                (webhookConfigurations ?: JsonMissing.of()).map {
                                    it.toImmutable()
                                },
                                webhookUrl,
                                additionalProperties.toMutableMap(),
                    ...
                    internal fun validity(): Int =
                        (if (adaptiveLongTable.asKnown().isPresent) 1 else 0) +
                            ...
                            (imagesToSave.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                                ?: 0) +
                            ...
                            (if (jobTimeoutExtraTimePerPageInSeconds.asKnown().isPresent) 1
                            else 0) +
                            ...
                            (languages.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                                ?: 0) +
                            (if (layoutAware.asKnown().isPresent) 1 else 0) +
                            (if (lineLevelBoundingBox.asKnown().isPresent) 1 else 0) +
                            (if (markdownTableMultilineHeaderSeparator.asKnown().isPresent) 1
                            else 0) +
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                        ...
                        /**
                         * An enum containing [ImagesToSave]'s known values, as well as an
                         * [_UNKNOWN] member.
                         *
                        ...
                        enum class Value {
                            ...
                            SCREENSHOT,
                            /**
                             * An enum member indicating that [ImagesToSave] was instantiated with
                             * an unknown value.
                             */
                            _UNKNOWN,
                        }
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                         ...
                         * member.
                         *
                         * An instance of [Priority] can contain an unknown value in a couple of
                         * cases:
                         * - It was deserialized from data that doesn't match any known member. For
                         *   example, if the SDK is on an older version than the API, then the API
                         *   may respond with new members that the SDK is unaware of.
                        ...
                        fun known(): Known =
                            when (this) {
                                ...
                                MEDIUM -> Known.MEDIUM
                                    ...
                                    throw LlamaCloudInvalidDataException("Unknown Priority: $value")
                            }
                    ...
                    private constructor(
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(resourceInfo: ResourceInfo) = apply {
                                additionalProperties =
                                    resourceInfo.additionalProperties.toMutableMap()
                            }
                             ...
                             * instance.
                             */
                            fun build(): ResourceInfo =
                                ResourceInfo(additionalProperties.toImmutable())
                        }
                    ...
                    private constructor(
                         ...
                         *
                         * Unlike [webhookEvents], this method doesn't throw if the JSON field has
                         * an unexpected type.
                         */
                        @JsonProperty("webhook_events")
                        @ExcludeMissing
                         ...
                         *
                         * Unlike [webhookHeaders], this method doesn't throw if the JSON field has
                         * an unexpected type.
                         */
                        @JsonProperty("webhook_headers")
                        @ExcludeMissing
                         ...
                         *
                         * Unlike [webhookOutputFormat], this method doesn't throw if the JSON field
                         * has an unexpected type.
                         */
                        @JsonProperty("webhook_output_format")
                        @ExcludeMissing
                        ...
                        class Builder internal constructor() {
                            ...
                            /**
                             * Events to subscribe to (e.g. 'parse.success', 'extract.error'). If
                             * null, all events are delivered.
                             */
                             ...
                             * `List<WebhookEvent>` value instead. This method is primarily for
                             * setting the field to an undocumented or not yet supported value.
                             */
                            fun webhookEvents(webhookEvents: JsonField<List<WebhookEvent>>) =
                                apply {
                             ...
                             * [WebhookHeaders] value instead. This method is primarily for setting
                             * the field to an undocumented or not yet supported value.
                             */
                             ...
                             *
                             * You should usually call [Builder.webhookOutputFormat] with a
                             * well-typed [String] value instead. This method is primarily for
                             * setting the field to an undocumented or not yet supported value.
                             */
                            fun webhookOutputFormat(webhookOutputFormat: JsonField<String>) =
                                apply {
                             ...
                             * Shared signing secret used to sign webhook deliveries. When set, each
                             * request includes an HMAC-SHA256 signature of the request body in the
                             * 'LC-Signature' header (value 'sha256=<hex>'). Recompute the HMAC over
                             ...
                             * setting the field to an undocumented or not yet supported value.
                             */
                            fun webhookSigningSecret(webhookSigningSecret: JsonField<String>) =
                                apply {
                            ...
                            /**
                             * Alias for calling [Builder.webhookUrl] with
                             * `webhookUrl.orElse(null)`.
                             */
                            fun webhookUrl(webhookUrl: Optional<String>) =
                                webhookUrl(webhookUrl.getOrNull())
                             ...
                             * Sets [Builder.webhookUrl] to an arbitrary JSON value.
                             *
                             * You should usually call [Builder.webhookUrl] with a well-typed
                        ...
                        private constructor(private val value: JsonField<String>) : Enum {
                            ...
                            companion object {
                                ...
                                @JvmField
                                val CLASSIFY_PARTIAL_SUCCESS = of("classify.partial_success")
                                ...
                                @JvmField
                                val EXTRACT_PARTIAL_SUCCESS = of("extract.partial_success")
                             ...
                             * [_UNKNOWN] member.
                             *
                             * An instance of [WebhookEvent] can contain an unknown value in a
                             * couple of cases:
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return other is Parameters &&
                            ...
                            presentationOutOfBoundsContent ==
                                other.presentationOutOfBoundsContent &&
                            ...
                            specializedChartParsingAgentic ==
                                other.specializedChartParsingAgentic &&
                            specializedChartParsingEfficient ==
                            ...
                            spreadsheetIncludeHiddenSheets ==
                                other.spreadsheetIncludeHiddenSheets &&
                            ...
                            structuredOutputJsonSchemaName ==
                                other.structuredOutputJsonSchemaName &&
                ...
                private constructor(
                    ...
                    override fun toString() =
                        "Partitions{additionalProperties=$additionalProperties}"
                }
        ...
        /** Type of processing performed */
        class JobType @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ProcessingResult &&
                ...
                outputS3Path == other.outputS3Path &&
                parametersHash == other.parametersHash &&
                processedAt == other.processedAt &&
                resultId == other.resultId &&
                outputMetadata == other.outputMetadata &&
                additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() =
            "ProcessingResult{itemId=$itemId, jobConfig=$jobConfig, jobType=$jobType, outputS3Path=$outputS3Path, parametersHash=$parametersHash, processedAt=$processedAt, resultId=$resultId, outputMetadata=$outputMetadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JobItemGetProcessingResultsResponse &&
            itemId == other.itemId &&
            itemName == other.itemName &&
            processingResults == other.processingResults &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy {
        Objects.hash(itemId, itemName, processingResults, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "JobItemGetProcessingResultsResponse{itemId=$itemId, itemName=$itemName, processingResults=$processingResults, additionalProperties=$additionalProperties}"
}
