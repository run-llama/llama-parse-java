...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun fileNameContains(): Optional<String> = body.fileNameContains()
    ...
    /**
     * Returns the raw JSON value of [fileNameContains].
     *
     * Unlike [fileNameContains], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    fun _fileNameContains(): JsonField<String> = body._fileNameContains()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RetrievalFindParams].
         *
    ...
    /** A builder for [RetrievalFindParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(retrievalFindParams: RetrievalFindParams) = apply {
            organizationId = retrievalFindParams.organizationId
            projectId = retrievalFindParams.projectId
            body = retrievalFindParams.body.toBuilder()
            additionalHeaders = retrievalFindParams.additionalHeaders.toBuilder()
            additionalQueryParams = retrievalFindParams.additionalQueryParams.toBuilder()
        }
        ...
        fun fileNameContains(fileNameContains: String?) = apply {
            body.fileNameContains(fileNameContains)
        }
        ...
        /**
         * Sets [Builder.fileNameContains] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fileNameContains] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fileNameContains(fileNameContains: JsonField<String>) = apply {
            body.fileNameContains(fileNameContains)
        }
        ...
        /**
         * Returns an immutable instance of [RetrievalFindParams].
         *
    ...
    private constructor(
        ...
        private val fileNameContains: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("file_name_contains")
            @ExcludeMissing
            fileNameContains: JsonField<String> = JsonMissing.of(),
            @JsonProperty("page_size") @ExcludeMissing pageSize: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("page_token")
            @ExcludeMissing
            pageToken: JsonField<String> = JsonMissing.of(),
        ) : this(indexId, fileName, fileNameContains, pageSize, pageToken, mutableMapOf())
         ...
         *   the server responded with an unexpected value).
         */
        fun fileNameContains(): Optional<String> =
            fileNameContains.getOptional("file_name_contains")
        ...
        @JsonProperty("file_name_contains")
        @ExcludeMissing
        fun _fileNameContains(): JsonField<String> = fileNameContains
        ...
        class Builder internal constructor() {
            ...
            private var fileNameContains: JsonField<String> = JsonMissing.of()
            ...
            internal fun from(body: Body) = apply {
                ...
                fileNameContains = body.fileNameContains
            ...
            /** Substring match on file name (case-insensitive). */
            fun fileNameContains(fileNameContains: String?) =
                fileNameContains(JsonField.ofNullable(fileNameContains))
        ...
        internal fun validity(): Int =
            (if (indexId.asKnown().isPresent) 1 else 0) +
                ...
                (if (fileNameContains.asKnown().isPresent) 1 else 0) +
        ...
        override fun toString() =
            "Body{indexId=$indexId, fileName=$fileName, fileNameContains=$fileNameContains, pageSize=$pageSize, pageToken=$pageToken, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetrievalFindParams &&
    ...
    override fun toString() =
        "RetrievalFindParams{organizationId=$organizationId, projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
