...
private constructor(
    ...
    private val azureDeployment: JsonField<String>,
    private val azureEndpoint: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        azureDeployment: JsonField<String> = JsonMissing.of(),
        @JsonProperty("azure_endpoint")
        @ExcludeMissing
        azureEndpoint: JsonField<String> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun azureDeployment(): Optional<String> = azureDeployment.getOptional("azure_deployment")
     ...
     *   server responded with an unexpected value).
     */
    fun azureEndpoint(): Optional<String> = azureEndpoint.getOptional("azure_endpoint")
    ...
    /**
     * Returns the raw JSON value of [azureDeployment].
     *
     * Unlike [azureDeployment], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("azure_deployment")
    @ExcludeMissing
    fun _azureDeployment(): JsonField<String> = azureDeployment

    /**
     * Returns the raw JSON value of [azureEndpoint].
     *
     * Unlike [azureEndpoint], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("azure_endpoint")
    @ExcludeMissing
    fun _azureEndpoint(): JsonField<String> = azureEndpoint
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AzureOpenAIEmbedding]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AzureOpenAIEmbedding]. */
    class Builder internal constructor() {
        ...
        private var azureDeployment: JsonField<String> = JsonMissing.of()
        private var azureEndpoint: JsonField<String> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(azureOpenAIEmbedding: AzureOpenAIEmbedding) = apply {
            additionalKwargs = azureOpenAIEmbedding.additionalKwargs
            apiBase = azureOpenAIEmbedding.apiBase
            apiKey = azureOpenAIEmbedding.apiKey
            apiVersion = azureOpenAIEmbedding.apiVersion
            azureDeployment = azureOpenAIEmbedding.azureDeployment
            azureEndpoint = azureOpenAIEmbedding.azureEndpoint
            className = azureOpenAIEmbedding.className
            defaultHeaders = azureOpenAIEmbedding.defaultHeaders
            dimensions = azureOpenAIEmbedding.dimensions
            embedBatchSize = azureOpenAIEmbedding.embedBatchSize
            maxRetries = azureOpenAIEmbedding.maxRetries
            modelName = azureOpenAIEmbedding.modelName
            numWorkers = azureOpenAIEmbedding.numWorkers
            reuseClient = azureOpenAIEmbedding.reuseClient
            timeout = azureOpenAIEmbedding.timeout
            additionalProperties = azureOpenAIEmbedding.additionalProperties.toMutableMap()
        }
        ...
        /** The Azure deployment to use. */
        fun azureDeployment(azureDeployment: String?) =
            azureDeployment(JsonField.ofNullable(azureDeployment))

        /** Alias for calling [Builder.azureDeployment] with `azureDeployment.orElse(null)`. */
        fun azureDeployment(azureDeployment: Optional<String>) =
            azureDeployment(azureDeployment.getOrNull())

        /**
         * Sets [Builder.azureDeployment] to an arbitrary JSON value.
         *
         * You should usually call [Builder.azureDeployment] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun azureDeployment(azureDeployment: JsonField<String>) = apply {
            this.azureDeployment = azureDeployment
        }

        /** The Azure endpoint to use. */
        fun azureEndpoint(azureEndpoint: String?) =
            azureEndpoint(JsonField.ofNullable(azureEndpoint))

        /** Alias for calling [Builder.azureEndpoint] with `azureEndpoint.orElse(null)`. */
        fun azureEndpoint(azureEndpoint: Optional<String>) =
            azureEndpoint(azureEndpoint.getOrNull())

        /**
         * Sets [Builder.azureEndpoint] to an arbitrary JSON value.
         *
         * You should usually call [Builder.azureEndpoint] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun azureEndpoint(azureEndpoint: JsonField<String>) = apply {
        ...
        /**
         * Returns an immutable instance of [AzureOpenAIEmbedding].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AzureOpenAIEmbedding =
     ...
     *   expected type.
     */
    fun validate(): AzureOpenAIEmbedding = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (additionalKwargs.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (azureDeployment.asKnown().isPresent) 1 else 0) +
            (if (azureEndpoint.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AzureOpenAIEmbedding &&
            additionalKwargs == other.additionalKwargs &&
            apiBase == other.apiBase &&
            apiKey == other.apiKey &&
            apiVersion == other.apiVersion &&
            azureDeployment == other.azureDeployment &&
            azureEndpoint == other.azureEndpoint &&
    ...
    override fun toString() =
        "AzureOpenAIEmbedding{additionalKwargs=$additionalKwargs, apiBase=$apiBase, apiKey=$apiKey, apiVersion=$apiVersion, azureDeployment=$azureDeployment, azureEndpoint=$azureEndpoint, className=$className, defaultHeaders=$defaultHeaders, dimensions=$dimensions, embedBatchSize=$embedBatchSize, maxRetries=$maxRetries, modelName=$modelName, numWorkers=$numWorkers, reuseClient=$reuseClient, timeout=$timeout, additionalProperties=$additionalProperties}"
}
