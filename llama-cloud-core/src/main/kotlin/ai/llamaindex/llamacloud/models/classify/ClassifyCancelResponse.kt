...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClassifyCancelResponse].
         *
    ...
    /** A builder for [ClassifyCancelResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(classifyCancelResponse: ClassifyCancelResponse) = apply {
            id = classifyCancelResponse.id
            configuration = classifyCancelResponse.configuration
            documentInputType = classifyCancelResponse.documentInputType
            fileInput = classifyCancelResponse.fileInput
            projectId = classifyCancelResponse.projectId
            status = classifyCancelResponse.status
            userId = classifyCancelResponse.userId
            configurationId = classifyCancelResponse.configurationId
            createdAt = classifyCancelResponse.createdAt
            errorMessage = classifyCancelResponse.errorMessage
            parseJobId = classifyCancelResponse.parseJobId
            result = classifyCancelResponse.result
            transactionId = classifyCancelResponse.transactionId
            updatedAt = classifyCancelResponse.updatedAt
            additionalProperties = classifyCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClassifyCancelResponse].
         *
         ...
         */
        fun build(): ClassifyCancelResponse =
     ...
     *   expected type.
     */
    fun validate(): ClassifyCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClassifyCancelResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ClassifyCancelResponse{id=$id, configuration=$configuration, documentInputType=$documentInputType, fileInput=$fileInput, projectId=$projectId, status=$status, userId=$userId, configurationId=$configurationId, createdAt=$createdAt, errorMessage=$errorMessage, parseJobId=$parseJobId, result=$result, transactionId=$transactionId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
