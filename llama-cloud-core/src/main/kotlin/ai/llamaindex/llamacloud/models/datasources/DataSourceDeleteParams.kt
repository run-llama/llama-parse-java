...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DataSourceDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DataSourceDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DataSourceDeleteParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(dataSourceDeleteParams: DataSourceDeleteParams) = apply {
            ...
            additionalBodyProperties =
                dataSourceDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DataSourceDeleteParams].
         *
