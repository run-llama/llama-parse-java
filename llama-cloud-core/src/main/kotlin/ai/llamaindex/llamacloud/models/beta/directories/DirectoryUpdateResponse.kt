...
private constructor(
     ...
     *
     * Unlike [systemMetadata], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("system_metadata")
    @ExcludeMissing
    fun _systemMetadata(): JsonField<SystemMetadata> = systemMetadata
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirectoryUpdateResponse].
         *
    ...
    /** A builder for [DirectoryUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(directoryUpdateResponse: DirectoryUpdateResponse) = apply {
            id = directoryUpdateResponse.id
            name = directoryUpdateResponse.name
            projectId = directoryUpdateResponse.projectId
            connectorSubscriptionId = directoryUpdateResponse.connectorSubscriptionId
            createdAt = directoryUpdateResponse.createdAt
            deletedAt = directoryUpdateResponse.deletedAt
            description = directoryUpdateResponse.description
            expiresAt = directoryUpdateResponse.expiresAt
            systemMetadata = directoryUpdateResponse.systemMetadata
            type = directoryUpdateResponse.type
            updatedAt = directoryUpdateResponse.updatedAt
            additionalProperties = directoryUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Reserved system-managed metadata. */
        fun systemMetadata(systemMetadata: SystemMetadata?) =
            systemMetadata(JsonField.ofNullable(systemMetadata))

        /** Alias for calling [Builder.systemMetadata] with `systemMetadata.orElse(null)`. */
        fun systemMetadata(systemMetadata: Optional<SystemMetadata>) =
            systemMetadata(systemMetadata.getOrNull())

        /**
         * Sets [Builder.systemMetadata] to an arbitrary JSON value.
         *
         * You should usually call [Builder.systemMetadata] with a well-typed [SystemMetadata] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun systemMetadata(systemMetadata: JsonField<SystemMetadata>) = apply {
        ...
        /**
         * Returns an immutable instance of [DirectoryUpdateResponse].
         *
         ...
         */
        fun build(): DirectoryUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): DirectoryUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [SystemMetadata]. */
            @JvmStatic fun builder() = Builder()
        }

        /** A builder for [SystemMetadata]. */
        class Builder internal constructor() {

            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(systemMetadata: SystemMetadata) = apply {
                additionalProperties = systemMetadata.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [SystemMetadata].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): SystemMetadata = SystemMetadata(additionalProperties.toImmutable())
        }
         ...
         *   expected type.
         */
        fun validate(): SystemMetadata = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is SystemMetadata && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirectoryUpdateResponse &&
            id == other.id &&
            name == other.name &&
    ...
    override fun toString() =
        "DirectoryUpdateResponse{id=$id, name=$name, projectId=$projectId, connectorSubscriptionId=$connectorSubscriptionId, createdAt=$createdAt, deletedAt=$deletedAt, description=$description, expiresAt=$expiresAt, systemMetadata=$systemMetadata, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
