...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchListResponse: BatchListResponse) = apply {
            ...
            jobType = batchListResponse.jobType
            projectId = batchListResponse.projectId
            status = batchListResponse.status
            totalItems = batchListResponse.totalItems
            completedAt = batchListResponse.completedAt
            createdAt = batchListResponse.createdAt
            directoryId = batchListResponse.directoryId
            effectiveAt = batchListResponse.effectiveAt
            errorMessage = batchListResponse.errorMessage
            failedItems = batchListResponse.failedItems
            jobRecordId = batchListResponse.jobRecordId
            processedItems = batchListResponse.processedItems
            skippedItems = batchListResponse.skippedItems
            startedAt = batchListResponse.startedAt
            updatedAt = batchListResponse.updatedAt
            workflowId = batchListResponse.workflowId
    ...
    override fun toString() =
        "BatchListResponse{id=$id, jobType=$jobType, projectId=$projectId, status=$status, totalItems=$totalItems, completedAt=$completedAt, createdAt=$createdAt, directoryId=$directoryId, effectiveAt=$effectiveAt, errorMessage=$errorMessage, failedItems=$failedItems, jobRecordId=$jobRecordId, processedItems=$processedItems, skippedItems=$skippedItems, startedAt=$startedAt, updatedAt=$updatedAt, workflowId=$workflowId, additionalProperties=$additionalProperties}"
}
