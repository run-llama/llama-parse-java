...
package ai.llamaindex.llamacloud.models.retrievers.query
...
private constructor(
    ...
    private constructor(
        ...
        ) : this(query, mode, rerankConfig, rerankTopN, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(query, mode, rerankConfig, rerankTopN, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{query=$query, mode=$mode, rerankConfig=$rerankConfig, rerankTopN=$rerankTopN, additionalProperties=$additionalProperties}"
    }
