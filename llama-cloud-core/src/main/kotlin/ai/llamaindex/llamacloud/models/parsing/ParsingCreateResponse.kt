...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParsingCreateResponse].
         *
    ...
    /** A builder for [ParsingCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(parsingCreateResponse: ParsingCreateResponse) = apply {
            id = parsingCreateResponse.id
            projectId = parsingCreateResponse.projectId
            status = parsingCreateResponse.status
            createdAt = parsingCreateResponse.createdAt
            errorMessage = parsingCreateResponse.errorMessage
            name = parsingCreateResponse.name
            tier = parsingCreateResponse.tier
            updatedAt = parsingCreateResponse.updatedAt
            usage = parsingCreateResponse.usage
        ...
        /**
         * Returns an immutable instance of [ParsingCreateResponse].
         *
         ...
         */
        fun build(): ParsingCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): ParsingCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParsingCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ParsingCreateResponse{id=$id, projectId=$projectId, status=$status, createdAt=$createdAt, errorMessage=$errorMessage, name=$name, tier=$tier, updatedAt=$updatedAt, usage=$usage, userMetadata=$userMetadata, additionalProperties=$additionalProperties}"
}
