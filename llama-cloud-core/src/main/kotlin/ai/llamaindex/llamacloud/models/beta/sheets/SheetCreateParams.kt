...
private constructor(
     ...
     */
    @Deprecated("deprecated") fun config(): Optional<SheetsParsingConfig> = body.config()
     ...
     *   server responded with an unexpected value).
     */
    fun configuration(): Optional<SheetsParsingConfig> = body.configuration()
     ...
     */
    @Deprecated("deprecated") fun _config(): JsonField<SheetsParsingConfig> = body._config()
     ...
     */
    fun _configuration(): JsonField<SheetsParsingConfig> = body._configuration()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SheetCreateParams].
         *
    ...
    /** A builder for [SheetCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sheetCreateParams: SheetCreateParams) = apply {
            organizationId = sheetCreateParams.organizationId
            projectId = sheetCreateParams.projectId
            body = sheetCreateParams.body.toBuilder()
            additionalHeaders = sheetCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = sheetCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Configuration for spreadsheet parsing and region extraction */
        @Deprecated("deprecated")
        fun config(config: SheetsParsingConfig?) = apply { body.config(config) }
         ...
         */
        @Deprecated("deprecated")
        fun config(config: JsonField<SheetsParsingConfig>) = apply { body.config(config) }

        /** Configuration for spreadsheet parsing and region extraction */
        fun configuration(configuration: SheetsParsingConfig?) = apply {
            body.configuration(configuration)
        }

        /** Alias for calling [Builder.configuration] with `configuration.orElse(null)`. */
        fun configuration(configuration: Optional<SheetsParsingConfig>) =
        ...
        /**
         * Returns an immutable instance of [SheetCreateParams].
         *
     ...
     *
     * Provide at most one of `configuration` (inline) or `configuration_id` (saved preset). If
     * neither is provided, a default inline configuration is used.
     */
    class Body
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun configuration(): Optional<SheetsParsingConfig> =
        ...
        class Builder internal constructor() {
            ...
            private var configuration: JsonField<SheetsParsingConfig> = JsonMissing.of()
             ...
             * Sets [Builder.config] to an arbitrary JSON value.
             *
             * You should usually call [Builder.config] with a well-typed [SheetsParsingConfig]
             ...
             * [SheetsParsingConfig] value instead. This method is primarily for setting the field
        ...
        override fun toString() =
            "Body{fileId=$fileId, config=$config, configuration=$configuration, configurationId=$configurationId, webhookConfigurationIds=$webhookConfigurationIds, webhookConfigurations=$webhookConfigurations, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SheetCreateParams &&
    ...
    override fun toString() =
        "SheetCreateParams{organizationId=$organizationId, projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
