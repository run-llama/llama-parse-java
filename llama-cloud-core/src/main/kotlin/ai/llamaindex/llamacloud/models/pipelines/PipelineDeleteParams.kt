...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PipelineDeleteParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(pipelineDeleteParams: PipelineDeleteParams) = apply {
            ...
            projectId = pipelineDeleteParams.projectId
    ...
    override fun toString() =
        "PipelineDeleteParams{pipelineId=$pipelineId, projectId=$projectId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
