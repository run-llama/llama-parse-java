...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ExtractDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ExtractDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExtractDeleteParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(extractDeleteParams: ExtractDeleteParams) = apply {
            ...
            additionalQueryParams = extractDeleteParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = extractDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExtractDeleteParams].
         *
