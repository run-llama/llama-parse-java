...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PipelineGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PipelineGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PipelineGetParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PipelineGetParams].
         *
