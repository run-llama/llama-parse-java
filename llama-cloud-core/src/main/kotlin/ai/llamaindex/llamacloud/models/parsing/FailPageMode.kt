...
class FailPageMode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [FailPageMode]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [FailPageMode] can contain an unknown value in a couple of cases:
     ...
     *   expected type.
     */
    fun validate(): FailPageMode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FailPageMode && value == other.value
    }
