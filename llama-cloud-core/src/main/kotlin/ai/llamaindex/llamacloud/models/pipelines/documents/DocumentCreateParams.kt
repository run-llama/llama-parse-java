...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentCreateParams: DocumentCreateParams) = apply {
            pipelineId = documentCreateParams.pipelineId
            projectId = documentCreateParams.projectId
            body = documentCreateParams.body.toMutableList()
    ...
    override fun toString() =
        "DocumentCreateParams{pipelineId=$pipelineId, projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
