...
import ai.llamaindex.llamacloud.models.CloudAzStorageBlobDataSource
import ai.llamaindex.llamacloud.models.CloudBoxDataSource
import ai.llamaindex.llamacloud.models.CloudConfluenceDataSource
import ai.llamaindex.llamacloud.models.CloudGoogleDriveDataSource
import ai.llamaindex.llamacloud.models.CloudJiraDataSource
import ai.llamaindex.llamacloud.models.CloudJiraDataSourceV2
import ai.llamaindex.llamacloud.models.CloudNotionPageDataSource
import ai.llamaindex.llamacloud.models.CloudOneDriveDataSource
import ai.llamaindex.llamacloud.models.CloudS3DataSource
import ai.llamaindex.llamacloud.models.CloudSharepointDataSource
import ai.llamaindex.llamacloud.models.CloudSlackDataSource
...
private constructor(
     ...
     */
    fun component(): Component = body.component()
     ...
     */
    fun _component(): JsonField<Component> = body._component()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DataSourceCreateParams].
         *
    ...
    /** A builder for [DataSourceCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataSourceCreateParams: DataSourceCreateParams) = apply {
            organizationId = dataSourceCreateParams.organizationId
            projectId = dataSourceCreateParams.projectId
            body = dataSourceCreateParams.body.toBuilder()
            additionalHeaders = dataSourceCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = dataSourceCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * value.
         */
        fun component(component: JsonField<Component>) = apply { body.component(component) }

        /** Alias for calling [component] with `Component.ofUnionMember0(unionMember0)`. */
        fun component(unionMember0: Component.UnionMember0) = apply { body.component(unionMember0) }

        /**
         * Alias for calling [component] with `Component.ofCloudS3DataSource(cloudS3DataSource)`.
         */
        fun component(cloudS3DataSource: CloudS3DataSource) = apply {
            body.component(cloudS3DataSource)
        }
         ...
         */
        fun component(cloudAzStorageBlobDataSource: CloudAzStorageBlobDataSource) = apply {
            body.component(cloudAzStorageBlobDataSource)
        }
         ...
         */
        fun component(cloudGoogleDriveDataSource: CloudGoogleDriveDataSource) = apply {
            body.component(cloudGoogleDriveDataSource)
        }
         ...
         */
        fun component(cloudOneDriveDataSource: CloudOneDriveDataSource) = apply {
            body.component(cloudOneDriveDataSource)
        }
         ...
         */
        fun component(cloudSharepointDataSource: CloudSharepointDataSource) = apply {
            body.component(cloudSharepointDataSource)
        }
         ...
         */
        fun component(cloudSlackDataSource: CloudSlackDataSource) = apply {
            body.component(cloudSlackDataSource)
        }
         ...
         */
        fun component(cloudNotionPageDataSource: CloudNotionPageDataSource) = apply {
            body.component(cloudNotionPageDataSource)
        }
         ...
         */
        fun component(cloudConfluenceDataSource: CloudConfluenceDataSource) = apply {
            body.component(cloudConfluenceDataSource)
        }
         ...
         */
        fun component(cloudJiraDataSource: CloudJiraDataSource) = apply {
            body.component(cloudJiraDataSource)
        }
         ...
         */
        fun component(cloudJiraDataSourceV2: CloudJiraDataSourceV2) = apply {
            body.component(cloudJiraDataSourceV2)
        }

        /**
         * Alias for calling [component] with `Component.ofCloudBoxDataSource(cloudBoxDataSource)`.
         */
        fun component(cloudBoxDataSource: CloudBoxDataSource) = apply {
            body.component(cloudBoxDataSource)
        }
        ...
        /**
         * Returns an immutable instance of [DataSourceCreateParams].
         *
         ...
         */
        fun build(): DataSourceCreateParams =
    ...
    private constructor(
        ...
        ) : this(component, name, sourceType, customMetadata, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [component] with
             * `Component.ofCloudS3DataSource(cloudS3DataSource)`.
             */
            ...
            /**
             * Alias for calling [component] with
             * `Component.ofCloudBoxDataSource(cloudBoxDataSource)`.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(component, name, sourceType, customMetadata, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{component=$component, name=$name, sourceType=$sourceType, customMetadata=$customMetadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DataSourceCreateParams &&
    ...
    override fun toString() =
        "DataSourceCreateParams{organizationId=$organizationId, projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
