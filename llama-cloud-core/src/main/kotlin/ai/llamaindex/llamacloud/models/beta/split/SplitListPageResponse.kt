...
private constructor(
    private val items: JsonField<List<SplitListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<SplitListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<SplitListResponse> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<SplitListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SplitListPageResponse].
         *
    ...
    /** A builder for [SplitListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<SplitListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(splitListPageResponse: SplitListPageResponse) = apply {
            items = splitListPageResponse.items.map { it.toMutableList() }
            nextPageToken = splitListPageResponse.nextPageToken
            totalSize = splitListPageResponse.totalSize
            additionalProperties = splitListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<SplitListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<SplitListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<SplitListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [SplitListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: SplitListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [SplitListPageResponse].
         *
         ...
         */
        fun build(): SplitListPageResponse =
            SplitListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): SplitListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SplitListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "SplitListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
