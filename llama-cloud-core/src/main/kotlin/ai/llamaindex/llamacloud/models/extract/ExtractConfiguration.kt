...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExtractConfiguration].
         *
    ...
    /** A builder for [ExtractConfiguration]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(extractConfiguration: ExtractConfiguration) = apply {
            dataSchema = extractConfiguration.dataSchema
            citeSources = extractConfiguration.citeSources
            confidenceScores = extractConfiguration.confidenceScores
            disableCache = extractConfiguration.disableCache
            extractionTarget = extractConfiguration.extractionTarget
            ...
            version = extractConfiguration.version
            additionalProperties = extractConfiguration.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExtractConfiguration].
         *
         ...
         */
        fun build(): ExtractConfiguration =
     ...
     *   expected type.
     */
    fun validate(): ExtractConfiguration = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExtractConfiguration &&
