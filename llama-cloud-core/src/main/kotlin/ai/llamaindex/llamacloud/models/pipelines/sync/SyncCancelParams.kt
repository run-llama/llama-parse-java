...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SyncCancelParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SyncCancelParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SyncCancelParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SyncCancelParams].
         *
