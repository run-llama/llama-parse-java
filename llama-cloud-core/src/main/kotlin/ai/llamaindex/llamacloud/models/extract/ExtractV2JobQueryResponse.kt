...
private constructor(
    private val items: JsonField<List<ExtractV2Job>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<ExtractV2Job>> = JsonMissing.of(),
     ...
     */
    fun items(): List<ExtractV2Job> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<ExtractV2Job>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExtractV2JobQueryResponse].
         *
    ...
    /** A builder for [ExtractV2JobQueryResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<ExtractV2Job>>? = null
        ...
        @JvmSynthetic
        internal fun from(extractV2JobQueryResponse: ExtractV2JobQueryResponse) = apply {
            items = extractV2JobQueryResponse.items.map { it.toMutableList() }
            nextPageToken = extractV2JobQueryResponse.nextPageToken
            totalSize = extractV2JobQueryResponse.totalSize
            additionalProperties = extractV2JobQueryResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<ExtractV2Job>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<ExtractV2Job>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<ExtractV2Job>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ExtractV2Job] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ExtractV2Job) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [ExtractV2JobQueryResponse].
         *
         ...
         */
        fun build(): ExtractV2JobQueryResponse =
     ...
     *   expected type.
     */
    fun validate(): ExtractV2JobQueryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExtractV2JobQueryResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "ExtractV2JobQueryResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
