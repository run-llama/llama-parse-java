...
private constructor(
    private val items: JsonField<List<JobItemListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<JobItemListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): Optional<List<JobItemListResponse>> = items.getOptional("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<JobItemListResponse>> = items
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [JobItemListPageResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [JobItemListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<JobItemListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(jobItemListPageResponse: JobItemListPageResponse) = apply {
            items = jobItemListPageResponse.items.map { it.toMutableList() }
            nextPageToken = jobItemListPageResponse.nextPageToken
            totalSize = jobItemListPageResponse.totalSize
            additionalProperties = jobItemListPageResponse.additionalProperties.toMutableMap()
        }

        /** List of item details */
        fun items(items: List<JobItemListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<JobItemListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<JobItemListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [JobItemListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: JobItemListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [JobItemListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): JobItemListPageResponse =
            JobItemListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): JobItemListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JobItemListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "JobItemListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
