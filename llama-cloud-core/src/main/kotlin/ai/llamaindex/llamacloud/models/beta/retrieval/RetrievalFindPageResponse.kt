...
private constructor(
    private val items: JsonField<List<RetrievalFindResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<RetrievalFindResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<RetrievalFindResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<RetrievalFindResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RetrievalFindPageResponse].
         *
    ...
    /** A builder for [RetrievalFindPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<RetrievalFindResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(retrievalFindPageResponse: RetrievalFindPageResponse) = apply {
            items = retrievalFindPageResponse.items.map { it.toMutableList() }
            nextPageToken = retrievalFindPageResponse.nextPageToken
            totalSize = retrievalFindPageResponse.totalSize
            additionalProperties = retrievalFindPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<RetrievalFindResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<RetrievalFindResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<RetrievalFindResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [RetrievalFindResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: RetrievalFindResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [RetrievalFindPageResponse].
         *
         ...
         */
        fun build(): RetrievalFindPageResponse =
            RetrievalFindPageResponse(
     ...
     *   expected type.
     */
    fun validate(): RetrievalFindPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetrievalFindPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "RetrievalFindPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
