...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DataSinkGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DataSinkGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DataSinkGetParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DataSinkGetParams].
         *
