...
private constructor(
    ...
    private val confidenceScoreEffort: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("auto_mode") @ExcludeMissing autoMode: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("bbox_left") @ExcludeMissing bboxLeft: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("bbox_right") @ExcludeMissing bboxRight: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("bbox_top") @ExcludeMissing bboxTop: JsonField<Double> = JsonMissing.of(),
        ...
        @ExcludeMissing
        confidenceScoreEffort: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("fast_mode") @ExcludeMissing fastMode: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("http_proxy") @ExcludeMissing httpProxy: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("input_url") @ExcludeMissing inputUrl: JsonField<String> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun annotateRevisions(): Optional<Boolean> = annotateRevisions.getOptional("annotate_revisions")
     ...
     *   server responded with an unexpected value).
     */
    fun azureOpenAIKey(): Optional<String> = azureOpenAIKey.getOptional("azure_openai_key")
    ...
    fun complementalFormattingInstruction(): Optional<String> =
        complementalFormattingInstruction.getOptional("complemental_formatting_instruction")

    /**
     * @throws LlamaCloudInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun confidenceScoreEffort(): Optional<String> =
     ...
     *   server responded with an unexpected value).
     */
    fun continuousMode(): Optional<Boolean> = continuousMode.getOptional("continuous_mode")
     ...
     *   server responded with an unexpected value).
     */
    fun imagesToSave(): Optional<List<ImagesToSave>> = imagesToSave.getOptional("images_to_save")
    ...
    fun keepPageSeparatorWhenMergingTables(): Optional<Boolean> =
        keepPageSeparatorWhenMergingTables.getOptional("keep_page_separator_when_merging_tables")
     ...
     *   server responded with an unexpected value).
     */
    fun maxPagesEnforced(): Optional<Long> = maxPagesEnforced.getOptional("max_pages_enforced")
    ...
    fun mergeTablesAcrossPagesInMarkdown(): Optional<Boolean> =
        mergeTablesAcrossPagesInMarkdown.getOptional("merge_tables_across_pages_in_markdown")
     ...
     *   server responded with an unexpected value).
     */
    fun outputS3Region(): Optional<String> = outputS3Region.getOptional("output_s3_region")
     ...
     *   server responded with an unexpected value).
     */
    fun pageFooterPrefix(): Optional<String> = pageFooterPrefix.getOptional("page_footer_prefix")

    /**
     * @throws LlamaCloudInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun pageFooterSuffix(): Optional<String> = pageFooterSuffix.getOptional("page_footer_suffix")

    /**
     * @throws LlamaCloudInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun pageHeaderPrefix(): Optional<String> = pageHeaderPrefix.getOptional("page_header_prefix")

    /**
     * @throws LlamaCloudInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun pageHeaderSuffix(): Optional<String> = pageHeaderSuffix.getOptional("page_header_suffix")
    ...
    fun preserveLayoutAlignmentAcrossPages(): Optional<Boolean> =
        preserveLayoutAlignmentAcrossPages.getOptional("preserve_layout_alignment_across_pages")
     ...
     *   server responded with an unexpected value).
     */
    fun removeHiddenText(): Optional<Boolean> = removeHiddenText.getOptional("remove_hidden_text")
     ...
     *   server responded with an unexpected value).
     */
    fun skipDiagonalText(): Optional<Boolean> = skipDiagonalText.getOptional("skip_diagonal_text")
    ...
    fun specializedChartParsingEfficient(): Optional<Boolean> =
        specializedChartParsingEfficient.getOptional("specialized_chart_parsing_efficient")
    ...
    fun spreadsheetForceFormulaComputation(): Optional<Boolean> =
        spreadsheetForceFormulaComputation.getOptional("spreadsheet_force_formula_computation")
     ...
     *   server responded with an unexpected value).
     */
    fun structuredOutput(): Optional<Boolean> = structuredOutput.getOptional("structured_output")
     ...
     *   server responded with an unexpected value).
     */
    fun takeScreenshot(): Optional<Boolean> = takeScreenshot.getOptional("take_screenshot")
     ...
     *
     * Unlike [adaptiveLongTable], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("adaptive_long_table")
    @ExcludeMissing
     ...
     *
     * Unlike [annotateLineNumbers], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("annotate_line_numbers")
    @ExcludeMissing
     ...
     *
     * Unlike [annotateLinks], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("annotate_links")
    @ExcludeMissing
     ...
     *
     * Unlike [annotateRevisions], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("annotate_revisions")
    @ExcludeMissing
     ...
     *
     * Unlike [autoMode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("auto_mode") @ExcludeMissing fun _autoMode(): JsonField<Boolean> = autoMode

    /**
     * Returns the raw JSON value of [autoModeConfigurationJson].
     *
     * Unlike [autoModeConfigurationJson], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("auto_mode_configuration_json")
    @ExcludeMissing
     ...
     *
     * Unlike [autoModeTriggerOnImageInPage], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("auto_mode_trigger_on_image_in_page")
    @ExcludeMissing
    fun _autoModeTriggerOnImageInPage(): JsonField<Boolean> = autoModeTriggerOnImageInPage

    /**
     * Returns the raw JSON value of [autoModeTriggerOnRegexpInPage].
     *
     * Unlike [autoModeTriggerOnRegexpInPage], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("auto_mode_trigger_on_regexp_in_page")
    @ExcludeMissing
    fun _autoModeTriggerOnRegexpInPage(): JsonField<String> = autoModeTriggerOnRegexpInPage

    /**
     * Returns the raw JSON value of [autoModeTriggerOnTableInPage].
     *
     * Unlike [autoModeTriggerOnTableInPage], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("auto_mode_trigger_on_table_in_page")
    @ExcludeMissing
    fun _autoModeTriggerOnTableInPage(): JsonField<Boolean> = autoModeTriggerOnTableInPage

    /**
     * Returns the raw JSON value of [autoModeTriggerOnTextInPage].
     *
     * Unlike [autoModeTriggerOnTextInPage], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("auto_mode_trigger_on_text_in_page")
    @ExcludeMissing
     ...
     *
     * Unlike [azureOpenAIApiVersion], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("azure_openai_api_version")
    @ExcludeMissing
     ...
     *
     * Unlike [azureOpenAIDeploymentName], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("azure_openai_deployment_name")
    @ExcludeMissing
     ...
     *
     * Unlike [azureOpenAIEndpoint], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("azure_openai_endpoint")
    @ExcludeMissing
     ...
     *
     * Unlike [azureOpenAIKey], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("azure_openai_key")
    @ExcludeMissing
     ...
     *
     * Unlike [bboxBottom], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("bbox_bottom") @ExcludeMissing fun _bboxBottom(): JsonField<Double> = bboxBottom

    /**
     * Returns the raw JSON value of [bboxLeft].
     *
     * Unlike [bboxLeft], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("bbox_left") @ExcludeMissing fun _bboxLeft(): JsonField<Double> = bboxLeft

    /**
     * Returns the raw JSON value of [bboxRight].
     *
     * Unlike [bboxRight], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("bbox_right") @ExcludeMissing fun _bboxRight(): JsonField<Double> = bboxRight

    /**
     * Returns the raw JSON value of [bboxTop].
     *
     * Unlike [bboxTop], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("bbox_top") @ExcludeMissing fun _bboxTop(): JsonField<Double> = bboxTop
     ...
     *
     * Unlike [compactMarkdownTable], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("compact_markdown_table")
    @ExcludeMissing
     ...
     *
     * Unlike [complementalFormattingInstruction], this method doesn't throw if the JSON field has
     * an unexpected type.
     */
    @JsonProperty("complemental_formatting_instruction")
    @ExcludeMissing
    fun _complementalFormattingInstruction(): JsonField<String> = complementalFormattingInstruction

    /**
     * Returns the raw JSON value of [confidenceScoreEffort].
     *
     * Unlike [confidenceScoreEffort], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("confidence_score_effort")
    @ExcludeMissing
    fun _confidenceScoreEffort(): JsonField<String> = confidenceScoreEffort

    /**
     * Returns the raw JSON value of [contentGuidelineInstruction].
     *
     * Unlike [contentGuidelineInstruction], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("content_guideline_instruction")
    @ExcludeMissing
     ...
     *
     * Unlike [continuousMode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("continuous_mode")
    @ExcludeMissing
     ...
     *
     * Unlike [disableImageExtraction], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("disable_image_extraction")
    @ExcludeMissing
     ...
     *
     * Unlike [disableOcr], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("disable_ocr") @ExcludeMissing fun _disableOcr(): JsonField<Boolean> = disableOcr

    /**
     * Returns the raw JSON value of [disableReconstruction].
     *
     * Unlike [disableReconstruction], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("disable_reconstruction")
    @ExcludeMissing
     ...
     *
     * Unlike [doNotCache], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("do_not_cache") @ExcludeMissing fun _doNotCache(): JsonField<Boolean> = doNotCache

    /**
     * Returns the raw JSON value of [doNotUnrollColumns].
     *
     * Unlike [doNotUnrollColumns], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("do_not_unroll_columns")
    @ExcludeMissing
     ...
     *
     * Unlike [enableCostOptimizer], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("enable_cost_optimizer")
    @ExcludeMissing
     ...
     *
     * Unlike [extractCharts], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("extract_charts")
    @ExcludeMissing
     ...
     *
     * Unlike [extractLayout], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("extract_layout")
    @ExcludeMissing
     ...
     *
     * Unlike [fastMode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("fast_mode") @ExcludeMissing fun _fastMode(): JsonField<Boolean> = fastMode

    /**
     * Returns the raw JSON value of [formattingInstruction].
     *
     * Unlike [formattingInstruction], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("formatting_instruction")
    @ExcludeMissing
     ...
     *
     * Unlike [gpt4oApiKey], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("gpt4o_api_key")
    @ExcludeMissing
     ...
     *
     * Unlike [gpt4oMode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("gpt4o_mode") @ExcludeMissing fun _gpt4oMode(): JsonField<Boolean> = gpt4oMode

    /**
     * Returns the raw JSON value of [guessXlsxSheetName].
     *
     * Unlike [guessXlsxSheetName], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("guess_xlsx_sheet_name")
    @ExcludeMissing
     ...
     *
     * Unlike [hideFooters], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("hide_footers")
    @ExcludeMissing
     ...
     *
     * Unlike [hideHeaders], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("hide_headers")
    @ExcludeMissing
     ...
     *
     * Unlike [highResOcr], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("high_res_ocr") @ExcludeMissing fun _highResOcr(): JsonField<Boolean> = highResOcr

    /**
     * Returns the raw JSON value of [htmlMakeAllElementsVisible].
     *
     * Unlike [htmlMakeAllElementsVisible], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("html_make_all_elements_visible")
    @ExcludeMissing
     ...
     *
     * Unlike [htmlRemoveFixedElements], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("html_remove_fixed_elements")
    @ExcludeMissing
     ...
     *
     * Unlike [htmlRemoveNavigationElements], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("html_remove_navigation_elements")
    @ExcludeMissing
    fun _htmlRemoveNavigationElements(): JsonField<Boolean> = htmlRemoveNavigationElements
     ...
     *
     * Unlike [ignoreDocumentElementsForLayoutDetection], this method doesn't throw if the JSON
     ...
     *
     * Unlike [imagesToSave], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("images_to_save")
    @ExcludeMissing
     ...
     *
     * Unlike [inlineImagesInMarkdown], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("inline_images_in_markdown")
    @ExcludeMissing
     ...
     *
     * Unlike [inputS3Path], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("input_s3_path")
    @ExcludeMissing
     ...
     *
     * Unlike [inputS3Region], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("input_s3_region")
    @ExcludeMissing
     ...
     *
     * Unlike [internalIsScreenshotJob], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("internal_is_screenshot_job")
    @ExcludeMissing
     ...
     *
     * Unlike [invalidateCache], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("invalidate_cache")
    @ExcludeMissing
     ...
     *
     * Unlike [isFormattingInstruction], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("is_formatting_instruction")
    @ExcludeMissing
     ...
     *
     * Unlike [jobTimeoutExtraTimePerPageInSeconds], this method doesn't throw if the JSON field has
     * an unexpected type.
     */
    @JsonProperty("job_timeout_extra_time_per_page_in_seconds")
    @ExcludeMissing
     ...
     *
     * Unlike [jobTimeoutInSeconds], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("job_timeout_in_seconds")
    @ExcludeMissing
     ...
     *
     * Unlike [keepPageSeparatorWhenMergingTables], this method doesn't throw if the JSON field has
     * an unexpected type.
     */
    @JsonProperty("keep_page_separator_when_merging_tables")
    @ExcludeMissing
     ...
     *
     * Unlike [layoutAware], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("layout_aware")
    @ExcludeMissing
     ...
     *
     * Unlike [lineLevelBoundingBox], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("line_level_bounding_box")
    @ExcludeMissing
     ...
     *
     * Unlike [markdownTableMultilineHeaderSeparator], this method doesn't throw if the JSON field
     ...
     *
     * Unlike [maxPagesEnforced], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("max_pages_enforced")
    @ExcludeMissing
     ...
     *
     * Unlike [mergeTablesAcrossPagesInMarkdown], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("merge_tables_across_pages_in_markdown")
    @ExcludeMissing
    fun _mergeTablesAcrossPagesInMarkdown(): JsonField<Boolean> = mergeTablesAcrossPagesInMarkdown
     ...
     *
     * Unlike [outlinedTableExtraction], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("outlined_table_extraction")
    @ExcludeMissing
     ...
     *
     * Unlike [outputPdfOfDocument], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("output_pdf_of_document")
    @ExcludeMissing
     ...
     *
     * Unlike [outputS3PathPrefix], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("output_s3_path_prefix")
    @ExcludeMissing
     ...
     *
     * Unlike [outputS3Region], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("output_s3_region")
    @ExcludeMissing
     ...
     *
     * Unlike [outputTablesAsHtml], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("output_tables_as_HTML")
    @ExcludeMissing
     ...
     *
     * Unlike [pageErrorTolerance], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("page_error_tolerance")
    @ExcludeMissing
     ...
     *
     * Unlike [pageFooterPrefix], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("page_footer_prefix")
    @ExcludeMissing
     ...
     *
     * Unlike [pageFooterSuffix], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("page_footer_suffix")
    @ExcludeMissing
     ...
     *
     * Unlike [pageHeaderPrefix], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("page_header_prefix")
    @ExcludeMissing
     ...
     *
     * Unlike [pageHeaderSuffix], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("page_header_suffix")
    @ExcludeMissing
     ...
     *
     * Unlike [pagePrefix], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("page_prefix") @ExcludeMissing fun _pagePrefix(): JsonField<String> = pagePrefix

    /**
     * Returns the raw JSON value of [pageSeparator].
     *
     * Unlike [pageSeparator], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("page_separator")
    @ExcludeMissing
     ...
     *
     * Unlike [pageSuffix], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("page_suffix") @ExcludeMissing fun _pageSuffix(): JsonField<String> = pageSuffix
     ...
     */
    @JsonProperty("parse_mode") @ExcludeMissing fun _parseMode(): JsonField<ParsingMode> = parseMode

    /**
     * Returns the raw JSON value of [parsingInstruction].
     *
     * Unlike [parsingInstruction], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("parsing_instruction")
    @ExcludeMissing
     ...
     *
     * Unlike [preciseBoundingBox], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("precise_bounding_box")
    @ExcludeMissing
     ...
     *
     * Unlike [presentationOutOfBoundsContent], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("presentation_out_of_bounds_content")
    @ExcludeMissing
    fun _presentationOutOfBoundsContent(): JsonField<Boolean> = presentationOutOfBoundsContent

    /**
     * Returns the raw JSON value of [presentationSkipEmbeddedData].
     *
     * Unlike [presentationSkipEmbeddedData], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("presentation_skip_embedded_data")
    @ExcludeMissing
    fun _presentationSkipEmbeddedData(): JsonField<Boolean> = presentationSkipEmbeddedData

    /**
     * Returns the raw JSON value of [preserveLayoutAlignmentAcrossPages].
     *
     * Unlike [preserveLayoutAlignmentAcrossPages], this method doesn't throw if the JSON field has
     * an unexpected type.
     */
    @JsonProperty("preserve_layout_alignment_across_pages")
    @ExcludeMissing
     ...
     *
     * Unlike [preserveVerySmallText], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("preserve_very_small_text")
    @ExcludeMissing
     ...
     *
     * Unlike [removeHiddenText], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("remove_hidden_text")
    @ExcludeMissing
     ...
     *
     * Unlike [replaceFailedPageMode], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("replace_failed_page_mode")
    @ExcludeMissing
     ...
     *
     * Unlike [replaceFailedPageWithErrorMessagePrefix], this method doesn't throw if the JSON field
     * has an unexpected type.
     */
    @JsonProperty("replace_failed_page_with_error_message_prefix")
    @ExcludeMissing
     ...
     *
     * Unlike [replaceFailedPageWithErrorMessageSuffix], this method doesn't throw if the JSON field
     * has an unexpected type.
     */
    @JsonProperty("replace_failed_page_with_error_message_suffix")
    @ExcludeMissing
     ...
     *
     * Unlike [saveImages], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("save_images") @ExcludeMissing fun _saveImages(): JsonField<Boolean> = saveImages

    /**
     * Returns the raw JSON value of [skipDiagonalText].
     *
     * Unlike [skipDiagonalText], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("skip_diagonal_text")
    @ExcludeMissing
     ...
     *
     * Unlike [specializedChartParsingAgentic], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("specialized_chart_parsing_agentic")
    @ExcludeMissing
    fun _specializedChartParsingAgentic(): JsonField<Boolean> = specializedChartParsingAgentic

    /**
     * Returns the raw JSON value of [specializedChartParsingEfficient].
     *
     * Unlike [specializedChartParsingEfficient], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("specialized_chart_parsing_efficient")
    @ExcludeMissing
    fun _specializedChartParsingEfficient(): JsonField<Boolean> = specializedChartParsingEfficient

    /**
     * Returns the raw JSON value of [specializedChartParsingPlus].
     *
     * Unlike [specializedChartParsingPlus], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("specialized_chart_parsing_plus")
    @ExcludeMissing
     ...
     *
     * Unlike [specializedImageParsing], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("specialized_image_parsing")
    @ExcludeMissing
     ...
     *
     * Unlike [spreadsheetExtractSubTables], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("spreadsheet_extract_sub_tables")
    @ExcludeMissing
     ...
     *
     * Unlike [spreadsheetForceFormulaComputation], this method doesn't throw if the JSON field has
     * an unexpected type.
     */
    @JsonProperty("spreadsheet_force_formula_computation")
    @ExcludeMissing
     ...
     *
     * Unlike [spreadsheetIncludeHiddenSheets], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("spreadsheet_include_hidden_sheets")
    @ExcludeMissing
    fun _spreadsheetIncludeHiddenSheets(): JsonField<Boolean> = spreadsheetIncludeHiddenSheets

    /**
     * Returns the raw JSON value of [strictModeBuggyFont].
     *
     * Unlike [strictModeBuggyFont], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("strict_mode_buggy_font")
    @ExcludeMissing
     ...
     *
     * Unlike [strictModeImageExtraction], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("strict_mode_image_extraction")
    @ExcludeMissing
     ...
     *
     * Unlike [strictModeImageOcr], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("strict_mode_image_ocr")
    @ExcludeMissing
     ...
     *
     * Unlike [strictModeReconstruction], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("strict_mode_reconstruction")
    @ExcludeMissing
     ...
     *
     * Unlike [structuredOutputJsonSchema], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("structured_output_json_schema")
    @ExcludeMissing
     ...
     *
     * Unlike [structuredOutputJsonSchemaName], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("structured_output_json_schema_name")
    @ExcludeMissing
    fun _structuredOutputJsonSchemaName(): JsonField<String> = structuredOutputJsonSchemaName
     ...
     *
     * Unlike [systemPromptAppend], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("system_prompt_append")
    @ExcludeMissing
     ...
     *
     * Unlike [takeScreenshot], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("take_screenshot")
    @ExcludeMissing
     ...
     *
     * Unlike [useVendorMultimodalModel], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("use_vendor_multimodal_model")
    @ExcludeMissing
     ...
     *
     * Unlike [vendorMultimodalApiKey], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("vendor_multimodal_api_key")
    @ExcludeMissing
     ...
     *
     * Unlike [vendorMultimodalModelName], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("vendor_multimodal_model_name")
    @ExcludeMissing
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LlamaParseParameters]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LlamaParseParameters]. */
    class Builder internal constructor() {
        ...
        private var complementalFormattingInstruction: JsonField<String> = JsonMissing.of()
        private var confidenceScoreEffort: JsonField<String> = JsonMissing.of()
        ...
        private var ignoreDocumentElementsForLayoutDetection: JsonField<Boolean> = JsonMissing.of()
        ...
        private var jobTimeoutExtraTimePerPageInSeconds: JsonField<Double> = JsonMissing.of()
        private var jobTimeoutInSeconds: JsonField<Double> = JsonMissing.of()
        private var keepPageSeparatorWhenMergingTables: JsonField<Boolean> = JsonMissing.of()
        ...
        private var markdownTableMultilineHeaderSeparator: JsonField<String> = JsonMissing.of()
        private var maxPages: JsonField<Long> = JsonMissing.of()
        private var maxPagesEnforced: JsonField<Long> = JsonMissing.of()
        private var mergeTablesAcrossPagesInMarkdown: JsonField<Boolean> = JsonMissing.of()
        ...
        private var presentationOutOfBoundsContent: JsonField<Boolean> = JsonMissing.of()
        private var presentationSkipEmbeddedData: JsonField<Boolean> = JsonMissing.of()
        private var preserveLayoutAlignmentAcrossPages: JsonField<Boolean> = JsonMissing.of()
        ...
        private var replaceFailedPageWithErrorMessagePrefix: JsonField<String> = JsonMissing.of()
        private var replaceFailedPageWithErrorMessageSuffix: JsonField<String> = JsonMissing.of()
        private var saveImages: JsonField<Boolean> = JsonMissing.of()
        private var skipDiagonalText: JsonField<Boolean> = JsonMissing.of()
        private var specializedChartParsingAgentic: JsonField<Boolean> = JsonMissing.of()
        private var specializedChartParsingEfficient: JsonField<Boolean> = JsonMissing.of()
        ...
        private var spreadsheetForceFormulaComputation: JsonField<Boolean> = JsonMissing.of()
        private var spreadsheetIncludeHiddenSheets: JsonField<Boolean> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(llamaParseParameters: LlamaParseParameters) = apply {
            adaptiveLongTable = llamaParseParameters.adaptiveLongTable
            aggressiveTableExtraction = llamaParseParameters.aggressiveTableExtraction
            annotateLineNumbers = llamaParseParameters.annotateLineNumbers
            annotateLinks = llamaParseParameters.annotateLinks
            annotateRevisions = llamaParseParameters.annotateRevisions
            autoMode = llamaParseParameters.autoMode
            autoModeConfigurationJson = llamaParseParameters.autoModeConfigurationJson
            autoModeTriggerOnImageInPage = llamaParseParameters.autoModeTriggerOnImageInPage
            autoModeTriggerOnRegexpInPage = llamaParseParameters.autoModeTriggerOnRegexpInPage
            autoModeTriggerOnTableInPage = llamaParseParameters.autoModeTriggerOnTableInPage
            autoModeTriggerOnTextInPage = llamaParseParameters.autoModeTriggerOnTextInPage
            azureOpenAIApiVersion = llamaParseParameters.azureOpenAIApiVersion
            azureOpenAIDeploymentName = llamaParseParameters.azureOpenAIDeploymentName
            azureOpenAIEndpoint = llamaParseParameters.azureOpenAIEndpoint
            azureOpenAIKey = llamaParseParameters.azureOpenAIKey
            bboxBottom = llamaParseParameters.bboxBottom
            bboxLeft = llamaParseParameters.bboxLeft
            bboxRight = llamaParseParameters.bboxRight
            bboxTop = llamaParseParameters.bboxTop
            boundingBox = llamaParseParameters.boundingBox
            compactMarkdownTable = llamaParseParameters.compactMarkdownTable
            complementalFormattingInstruction =
                llamaParseParameters.complementalFormattingInstruction
            confidenceScoreEffort = llamaParseParameters.confidenceScoreEffort
            contentGuidelineInstruction = llamaParseParameters.contentGuidelineInstruction
            continuousMode = llamaParseParameters.continuousMode
            disableImageExtraction = llamaParseParameters.disableImageExtraction
            disableOcr = llamaParseParameters.disableOcr
            disableReconstruction = llamaParseParameters.disableReconstruction
            doNotCache = llamaParseParameters.doNotCache
            doNotUnrollColumns = llamaParseParameters.doNotUnrollColumns
            enableCostOptimizer = llamaParseParameters.enableCostOptimizer
            extractCharts = llamaParseParameters.extractCharts
            extractLayout = llamaParseParameters.extractLayout
            extractPrintedPageNumber = llamaParseParameters.extractPrintedPageNumber
            fastMode = llamaParseParameters.fastMode
            formattingInstruction = llamaParseParameters.formattingInstruction
            gpt4oApiKey = llamaParseParameters.gpt4oApiKey
            gpt4oMode = llamaParseParameters.gpt4oMode
            guessXlsxSheetName = llamaParseParameters.guessXlsxSheetName
            hideFooters = llamaParseParameters.hideFooters
            hideHeaders = llamaParseParameters.hideHeaders
            highResOcr = llamaParseParameters.highResOcr
            htmlMakeAllElementsVisible = llamaParseParameters.htmlMakeAllElementsVisible
            htmlRemoveFixedElements = llamaParseParameters.htmlRemoveFixedElements
            htmlRemoveNavigationElements = llamaParseParameters.htmlRemoveNavigationElements
            httpProxy = llamaParseParameters.httpProxy
            ignoreDocumentElementsForLayoutDetection =
                llamaParseParameters.ignoreDocumentElementsForLayoutDetection
            imagesToSave = llamaParseParameters.imagesToSave.map { it.toMutableList() }
            inlineImagesInMarkdown = llamaParseParameters.inlineImagesInMarkdown
            inputS3Path = llamaParseParameters.inputS3Path
            inputS3Region = llamaParseParameters.inputS3Region
            inputUrl = llamaParseParameters.inputUrl
            internalIsScreenshotJob = llamaParseParameters.internalIsScreenshotJob
            invalidateCache = llamaParseParameters.invalidateCache
            isFormattingInstruction = llamaParseParameters.isFormattingInstruction
            jobTimeoutExtraTimePerPageInSeconds =
                llamaParseParameters.jobTimeoutExtraTimePerPageInSeconds
            jobTimeoutInSeconds = llamaParseParameters.jobTimeoutInSeconds
            keepPageSeparatorWhenMergingTables =
                llamaParseParameters.keepPageSeparatorWhenMergingTables
            languages = llamaParseParameters.languages.map { it.toMutableList() }
            layoutAware = llamaParseParameters.layoutAware
            lineLevelBoundingBox = llamaParseParameters.lineLevelBoundingBox
            markdownTableMultilineHeaderSeparator =
                llamaParseParameters.markdownTableMultilineHeaderSeparator
            maxPages = llamaParseParameters.maxPages
            maxPagesEnforced = llamaParseParameters.maxPagesEnforced
            mergeTablesAcrossPagesInMarkdown = llamaParseParameters.mergeTablesAcrossPagesInMarkdown
            model = llamaParseParameters.model
            outlinedTableExtraction = llamaParseParameters.outlinedTableExtraction
            outputPdfOfDocument = llamaParseParameters.outputPdfOfDocument
            outputS3PathPrefix = llamaParseParameters.outputS3PathPrefix
            outputS3Region = llamaParseParameters.outputS3Region
            outputTablesAsHtml = llamaParseParameters.outputTablesAsHtml
            pageErrorTolerance = llamaParseParameters.pageErrorTolerance
            pageFooterPrefix = llamaParseParameters.pageFooterPrefix
            pageFooterSuffix = llamaParseParameters.pageFooterSuffix
            pageHeaderPrefix = llamaParseParameters.pageHeaderPrefix
            pageHeaderSuffix = llamaParseParameters.pageHeaderSuffix
            pagePrefix = llamaParseParameters.pagePrefix
            pageSeparator = llamaParseParameters.pageSeparator
            pageSuffix = llamaParseParameters.pageSuffix
            parseMode = llamaParseParameters.parseMode
            parsingInstruction = llamaParseParameters.parsingInstruction
            preciseBoundingBox = llamaParseParameters.preciseBoundingBox
            premiumMode = llamaParseParameters.premiumMode
            presentationOutOfBoundsContent = llamaParseParameters.presentationOutOfBoundsContent
            presentationSkipEmbeddedData = llamaParseParameters.presentationSkipEmbeddedData
            preserveLayoutAlignmentAcrossPages =
                llamaParseParameters.preserveLayoutAlignmentAcrossPages
            preserveVerySmallText = llamaParseParameters.preserveVerySmallText
            preset = llamaParseParameters.preset
            priority = llamaParseParameters.priority
            projectId = llamaParseParameters.projectId
            removeHiddenText = llamaParseParameters.removeHiddenText
            replaceFailedPageMode = llamaParseParameters.replaceFailedPageMode
            replaceFailedPageWithErrorMessagePrefix =
                llamaParseParameters.replaceFailedPageWithErrorMessagePrefix
            replaceFailedPageWithErrorMessageSuffix =
                llamaParseParameters.replaceFailedPageWithErrorMessageSuffix
            saveImages = llamaParseParameters.saveImages
            skipDiagonalText = llamaParseParameters.skipDiagonalText
            specializedChartParsingAgentic = llamaParseParameters.specializedChartParsingAgentic
            specializedChartParsingEfficient = llamaParseParameters.specializedChartParsingEfficient
            specializedChartParsingPlus = llamaParseParameters.specializedChartParsingPlus
            specializedImageParsing = llamaParseParameters.specializedImageParsing
            spreadsheetExtractSubTables = llamaParseParameters.spreadsheetExtractSubTables
            spreadsheetForceFormulaComputation =
                llamaParseParameters.spreadsheetForceFormulaComputation
            spreadsheetIncludeHiddenSheets = llamaParseParameters.spreadsheetIncludeHiddenSheets
            strictModeBuggyFont = llamaParseParameters.strictModeBuggyFont
            strictModeImageExtraction = llamaParseParameters.strictModeImageExtraction
            strictModeImageOcr = llamaParseParameters.strictModeImageOcr
            strictModeReconstruction = llamaParseParameters.strictModeReconstruction
            structuredOutput = llamaParseParameters.structuredOutput
            structuredOutputJsonSchema = llamaParseParameters.structuredOutputJsonSchema
            structuredOutputJsonSchemaName = llamaParseParameters.structuredOutputJsonSchemaName
            systemPrompt = llamaParseParameters.systemPrompt
            systemPromptAppend = llamaParseParameters.systemPromptAppend
            takeScreenshot = llamaParseParameters.takeScreenshot
            targetPages = llamaParseParameters.targetPages
            tier = llamaParseParameters.tier
            useVendorMultimodalModel = llamaParseParameters.useVendorMultimodalModel
            userPrompt = llamaParseParameters.userPrompt
            vendorMultimodalApiKey = llamaParseParameters.vendorMultimodalApiKey
            vendorMultimodalModelName = llamaParseParameters.vendorMultimodalModelName
            version = llamaParseParameters.version
            webhookConfigurations =
                llamaParseParameters.webhookConfigurations.map { it.toMutableList() }
            webhookUrl = llamaParseParameters.webhookUrl
            additionalProperties = llamaParseParameters.additionalProperties.toMutableMap()
        }
        ...
        /** Alias for calling [Builder.adaptiveLongTable] with `adaptiveLongTable.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.adaptiveLongTable] with a well-typed [Boolean] value
         ...
         *
         * You should usually call [Builder.aggressiveTableExtraction] with a well-typed [Boolean]
        ...
        /**
         * Alias for calling [Builder.annotateLineNumbers] with `annotateLineNumbers.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.annotateLineNumbers] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.annotateRevisions] with `annotateRevisions.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.annotateRevisions] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.autoMode] with a well-typed [Boolean] value instead.
         ...
         *
         * You should usually call [Builder.autoModeConfigurationJson] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun autoModeConfigurationJson(autoModeConfigurationJson: JsonField<String>) = apply {
        ...
        fun autoModeTriggerOnImageInPage(autoModeTriggerOnImageInPage: Boolean?) =
            autoModeTriggerOnImageInPage(JsonField.ofNullable(autoModeTriggerOnImageInPage))
         ...
         */
        fun autoModeTriggerOnImageInPage(autoModeTriggerOnImageInPage: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.autoModeTriggerOnImageInPage] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun autoModeTriggerOnImageInPage(autoModeTriggerOnImageInPage: JsonField<Boolean>) = apply {
        ...
        fun autoModeTriggerOnRegexpInPage(autoModeTriggerOnRegexpInPage: String?) =
            autoModeTriggerOnRegexpInPage(JsonField.ofNullable(autoModeTriggerOnRegexpInPage))

        /**
         * Alias for calling [Builder.autoModeTriggerOnRegexpInPage] with
         * `autoModeTriggerOnRegexpInPage.orElse(null)`.
         */
        fun autoModeTriggerOnRegexpInPage(autoModeTriggerOnRegexpInPage: Optional<String>) =
         ...
         *
         * You should usually call [Builder.autoModeTriggerOnRegexpInPage] with a well-typed
         * [String] value instead. This method is primarily for setting the field to an undocumented
         * or not yet supported value.
         */
        fun autoModeTriggerOnRegexpInPage(autoModeTriggerOnRegexpInPage: JsonField<String>) =
            apply {
        ...
        fun autoModeTriggerOnTableInPage(autoModeTriggerOnTableInPage: Boolean?) =
            autoModeTriggerOnTableInPage(JsonField.ofNullable(autoModeTriggerOnTableInPage))
         ...
         */
        fun autoModeTriggerOnTableInPage(autoModeTriggerOnTableInPage: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.autoModeTriggerOnTableInPage] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun autoModeTriggerOnTableInPage(autoModeTriggerOnTableInPage: JsonField<Boolean>) = apply {
        ...
        fun autoModeTriggerOnTextInPage(autoModeTriggerOnTextInPage: String?) =
            autoModeTriggerOnTextInPage(JsonField.ofNullable(autoModeTriggerOnTextInPage))
         ...
         *
         * You should usually call [Builder.autoModeTriggerOnTextInPage] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun autoModeTriggerOnTextInPage(autoModeTriggerOnTextInPage: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.azureOpenAIApiVersion] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.azureOpenAIDeploymentName] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun azureOpenAIDeploymentName(azureOpenAIDeploymentName: JsonField<String>) = apply {
        ...
        /**
         * Alias for calling [Builder.azureOpenAIEndpoint] with `azureOpenAIEndpoint.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.azureOpenAIEndpoint] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.azureOpenAIKey] with `azureOpenAIKey.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.azureOpenAIKey] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun bboxBottom(bboxBottom: Double?) = bboxBottom(JsonField.ofNullable(bboxBottom))
        ...
        fun bboxBottom(bboxBottom: Optional<Double>) = bboxBottom(bboxBottom.getOrNull())

        /**
         * Sets [Builder.bboxBottom] to an arbitrary JSON value.
         *
         * You should usually call [Builder.bboxBottom] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun bboxBottom(bboxBottom: JsonField<Double>) = apply { this.bboxBottom = bboxBottom }
         ...
         *
         * You should usually call [Builder.bboxLeft] with a well-typed [Double] value instead. This
         ...
         *
         * You should usually call [Builder.bboxRight] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun bboxRight(bboxRight: JsonField<Double>) = apply { this.bboxRight = bboxRight }
         ...
         *
         * You should usually call [Builder.bboxTop] with a well-typed [Double] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun bboxTop(bboxTop: JsonField<Double>) = apply { this.bboxTop = bboxTop }

        fun boundingBox(boundingBox: String?) = boundingBox(JsonField.ofNullable(boundingBox))
         ...
         * value.
         */
        fun boundingBox(boundingBox: JsonField<String>) = apply { this.boundingBox = boundingBox }
         ...
         *
         * You should usually call [Builder.compactMarkdownTable] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun complementalFormattingInstruction(complementalFormattingInstruction: String?) =
            complementalFormattingInstruction(
         ...
         */
        fun complementalFormattingInstruction(complementalFormattingInstruction: Optional<String>) =
            complementalFormattingInstruction(complementalFormattingInstruction.getOrNull())

        /**
         * Sets [Builder.complementalFormattingInstruction] to an arbitrary JSON value.
         *
         * You should usually call [Builder.complementalFormattingInstruction] with a well-typed
         * [String] value instead. This method is primarily for setting the field to an undocumented
         * or not yet supported value.
         */
        fun complementalFormattingInstruction(
            complementalFormattingInstruction: JsonField<String>
        ) = apply { this.complementalFormattingInstruction = complementalFormattingInstruction }

        fun confidenceScoreEffort(confidenceScoreEffort: String?) =
         ...
         */
        fun confidenceScoreEffort(confidenceScoreEffort: Optional<String>) =
            confidenceScoreEffort(confidenceScoreEffort.getOrNull())

        /**
         * Sets [Builder.confidenceScoreEffort] to an arbitrary JSON value.
         *
         * You should usually call [Builder.confidenceScoreEffort] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun confidenceScoreEffort(confidenceScoreEffort: JsonField<String>) = apply {
            this.confidenceScoreEffort = confidenceScoreEffort
        }

        fun contentGuidelineInstruction(contentGuidelineInstruction: String?) =
            contentGuidelineInstruction(JsonField.ofNullable(contentGuidelineInstruction))
         ...
         *
         * You should usually call [Builder.contentGuidelineInstruction] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun contentGuidelineInstruction(contentGuidelineInstruction: JsonField<String>) = apply {
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun continuousMode(continuousMode: Boolean) = continuousMode(continuousMode as Boolean?)

        /** Alias for calling [Builder.continuousMode] with `continuousMode.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.continuousMode] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.disableImageExtraction] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        ...
        fun disableOcr(disableOcr: Boolean?) = disableOcr(JsonField.ofNullable(disableOcr))
        ...
        fun disableOcr(disableOcr: Optional<Boolean>) = disableOcr(disableOcr.getOrNull())

        /**
         * Sets [Builder.disableOcr] to an arbitrary JSON value.
         *
         * You should usually call [Builder.disableOcr] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun disableOcr(disableOcr: JsonField<Boolean>) = apply { this.disableOcr = disableOcr }
         ...
         *
         * You should usually call [Builder.disableReconstruction] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun doNotCache(doNotCache: Boolean?) = doNotCache(JsonField.ofNullable(doNotCache))
        ...
        fun doNotCache(doNotCache: Optional<Boolean>) = doNotCache(doNotCache.getOrNull())

        /**
         * Sets [Builder.doNotCache] to an arbitrary JSON value.
         *
         * You should usually call [Builder.doNotCache] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun doNotCache(doNotCache: JsonField<Boolean>) = apply { this.doNotCache = doNotCache }
        ...
        /**
         * Alias for calling [Builder.doNotUnrollColumns] with `doNotUnrollColumns.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.doNotUnrollColumns] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Alias for calling [Builder.enableCostOptimizer] with `enableCostOptimizer.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.enableCostOptimizer] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun extractCharts(extractCharts: Boolean) = extractCharts(extractCharts as Boolean?)
         ...
         *
         * You should usually call [Builder.extractCharts] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun extractLayout(extractLayout: Boolean) = extractLayout(extractLayout as Boolean?)
         ...
         *
         * You should usually call [Builder.extractLayout] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.extractPrintedPageNumber] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
         ...
         *
         * You should usually call [Builder.fastMode] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.formattingInstruction] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun gpt4oApiKey(gpt4oApiKey: String?) = gpt4oApiKey(JsonField.ofNullable(gpt4oApiKey))

        /** Alias for calling [Builder.gpt4oApiKey] with `gpt4oApiKey.orElse(null)`. */
        fun gpt4oApiKey(gpt4oApiKey: Optional<String>) = gpt4oApiKey(gpt4oApiKey.getOrNull())

        /**
         * Sets [Builder.gpt4oApiKey] to an arbitrary JSON value.
         *
         * You should usually call [Builder.gpt4oApiKey] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun gpt4oApiKey(gpt4oApiKey: JsonField<String>) = apply { this.gpt4oApiKey = gpt4oApiKey }
         ...
         *
         * You should usually call [Builder.gpt4oMode] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun gpt4oMode(gpt4oMode: JsonField<Boolean>) = apply { this.gpt4oMode = gpt4oMode }
        ...
        /**
         * Alias for calling [Builder.guessXlsxSheetName] with `guessXlsxSheetName.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.guessXlsxSheetName] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun hideFooters(hideFooters: Boolean?) = hideFooters(JsonField.ofNullable(hideFooters))
        ...
        fun hideFooters(hideFooters: Optional<Boolean>) = hideFooters(hideFooters.getOrNull())

        /**
         * Sets [Builder.hideFooters] to an arbitrary JSON value.
         *
         * You should usually call [Builder.hideFooters] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun hideFooters(hideFooters: JsonField<Boolean>) = apply { this.hideFooters = hideFooters }

        fun hideHeaders(hideHeaders: Boolean?) = hideHeaders(JsonField.ofNullable(hideHeaders))
        ...
        fun hideHeaders(hideHeaders: Optional<Boolean>) = hideHeaders(hideHeaders.getOrNull())

        /**
         * Sets [Builder.hideHeaders] to an arbitrary JSON value.
         *
         * You should usually call [Builder.hideHeaders] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun hideHeaders(hideHeaders: JsonField<Boolean>) = apply { this.hideHeaders = hideHeaders }

        fun highResOcr(highResOcr: Boolean?) = highResOcr(JsonField.ofNullable(highResOcr))
        ...
        fun highResOcr(highResOcr: Optional<Boolean>) = highResOcr(highResOcr.getOrNull())

        /**
         * Sets [Builder.highResOcr] to an arbitrary JSON value.
         *
         * You should usually call [Builder.highResOcr] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun highResOcr(highResOcr: JsonField<Boolean>) = apply { this.highResOcr = highResOcr }
         ...
         *
         * You should usually call [Builder.htmlMakeAllElementsVisible] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun htmlMakeAllElementsVisible(htmlMakeAllElementsVisible: JsonField<Boolean>) = apply {
         ...
         *
         * You should usually call [Builder.htmlRemoveFixedElements] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun htmlRemoveFixedElements(htmlRemoveFixedElements: JsonField<Boolean>) = apply {
        ...
        fun htmlRemoveNavigationElements(htmlRemoveNavigationElements: Boolean?) =
            htmlRemoveNavigationElements(JsonField.ofNullable(htmlRemoveNavigationElements))
         ...
         */
        fun htmlRemoveNavigationElements(htmlRemoveNavigationElements: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.htmlRemoveNavigationElements] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun htmlRemoveNavigationElements(htmlRemoveNavigationElements: JsonField<Boolean>) = apply {
        ...
        /**
         * Sets [Builder.ignoreDocumentElementsForLayoutDetection] to an arbitrary JSON value.
         *
         * You should usually call [Builder.ignoreDocumentElementsForLayoutDetection] with a
         ...
         *
         * You should usually call [Builder.inlineImagesInMarkdown] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        ...
        fun inputS3Path(inputS3Path: String?) = inputS3Path(JsonField.ofNullable(inputS3Path))

        /** Alias for calling [Builder.inputS3Path] with `inputS3Path.orElse(null)`. */
        fun inputS3Path(inputS3Path: Optional<String>) = inputS3Path(inputS3Path.getOrNull())

        /**
         * Sets [Builder.inputS3Path] to an arbitrary JSON value.
         *
         * You should usually call [Builder.inputS3Path] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun inputS3Path(inputS3Path: JsonField<String>) = apply { this.inputS3Path = inputS3Path }
         ...
         *
         * You should usually call [Builder.inputS3Region] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.internalIsScreenshotJob] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun internalIsScreenshotJob(internalIsScreenshotJob: JsonField<Boolean>) = apply {
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun invalidateCache(invalidateCache: Boolean) = invalidateCache(invalidateCache as Boolean?)

        /** Alias for calling [Builder.invalidateCache] with `invalidateCache.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.isFormattingInstruction] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun isFormattingInstruction(isFormattingInstruction: JsonField<Boolean>) = apply {
            this.isFormattingInstruction = isFormattingInstruction
        }

        fun jobTimeoutExtraTimePerPageInSeconds(jobTimeoutExtraTimePerPageInSeconds: Double?) =
            jobTimeoutExtraTimePerPageInSeconds(
         ...
         */
        fun jobTimeoutExtraTimePerPageInSeconds(jobTimeoutExtraTimePerPageInSeconds: Double) =
            jobTimeoutExtraTimePerPageInSeconds(jobTimeoutExtraTimePerPageInSeconds as Double?)
        ...
        ) = jobTimeoutExtraTimePerPageInSeconds(jobTimeoutExtraTimePerPageInSeconds.getOrNull())

        /**
         * Sets [Builder.jobTimeoutExtraTimePerPageInSeconds] to an arbitrary JSON value.
         *
         * You should usually call [Builder.jobTimeoutExtraTimePerPageInSeconds] with a well-typed
        ...
        ) = apply { this.jobTimeoutExtraTimePerPageInSeconds = jobTimeoutExtraTimePerPageInSeconds }
        ...
        /**
         * Alias for calling [Builder.jobTimeoutInSeconds] with `jobTimeoutInSeconds.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.jobTimeoutInSeconds] with a well-typed [Double] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun keepPageSeparatorWhenMergingTables(keepPageSeparatorWhenMergingTables: Boolean?) =
            keepPageSeparatorWhenMergingTables(
         ...
         */
        fun keepPageSeparatorWhenMergingTables(keepPageSeparatorWhenMergingTables: Boolean) =
            keepPageSeparatorWhenMergingTables(keepPageSeparatorWhenMergingTables as Boolean?)
        ...
        ) = keepPageSeparatorWhenMergingTables(keepPageSeparatorWhenMergingTables.getOrNull())

        /**
         * Sets [Builder.keepPageSeparatorWhenMergingTables] to an arbitrary JSON value.
         *
         * You should usually call [Builder.keepPageSeparatorWhenMergingTables] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun keepPageSeparatorWhenMergingTables(
            keepPageSeparatorWhenMergingTables: JsonField<Boolean>
        ) = apply { this.keepPageSeparatorWhenMergingTables = keepPageSeparatorWhenMergingTables }

        fun languages(languages: List<ParsingLanguages>) = languages(JsonField.of(languages))

        /**
         * Sets [Builder.languages] to an arbitrary JSON value.
         *
         * You should usually call [Builder.languages] with a well-typed `List<ParsingLanguages>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        ...
        fun layoutAware(layoutAware: Boolean?) = layoutAware(JsonField.ofNullable(layoutAware))
        ...
        fun layoutAware(layoutAware: Optional<Boolean>) = layoutAware(layoutAware.getOrNull())

        /**
         * Sets [Builder.layoutAware] to an arbitrary JSON value.
         *
         * You should usually call [Builder.layoutAware] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun layoutAware(layoutAware: JsonField<Boolean>) = apply { this.layoutAware = layoutAware }
         ...
         *
         * You should usually call [Builder.lineLevelBoundingBox] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun markdownTableMultilineHeaderSeparator(markdownTableMultilineHeaderSeparator: String?) =
            markdownTableMultilineHeaderSeparator(
        ...
        ) = markdownTableMultilineHeaderSeparator(markdownTableMultilineHeaderSeparator.getOrNull())

        /**
         * Sets [Builder.markdownTableMultilineHeaderSeparator] to an arbitrary JSON value.
         *
         * You should usually call [Builder.markdownTableMultilineHeaderSeparator] with a well-typed
         * [String] value instead. This method is primarily for setting the field to an undocumented
         * or not yet supported value.
         */
        fun markdownTableMultilineHeaderSeparator(
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun maxPagesEnforced(maxPagesEnforced: Long) = maxPagesEnforced(maxPagesEnforced as Long?)

        /** Alias for calling [Builder.maxPagesEnforced] with `maxPagesEnforced.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.maxPagesEnforced] with a well-typed [Long] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun mergeTablesAcrossPagesInMarkdown(mergeTablesAcrossPagesInMarkdown: Boolean?) =
            mergeTablesAcrossPagesInMarkdown(JsonField.ofNullable(mergeTablesAcrossPagesInMarkdown))
         ...
         */
        fun mergeTablesAcrossPagesInMarkdown(mergeTablesAcrossPagesInMarkdown: Boolean) =
            mergeTablesAcrossPagesInMarkdown(mergeTablesAcrossPagesInMarkdown as Boolean?)

        /**
         * Alias for calling [Builder.mergeTablesAcrossPagesInMarkdown] with
         * `mergeTablesAcrossPagesInMarkdown.orElse(null)`.
         */
        fun mergeTablesAcrossPagesInMarkdown(mergeTablesAcrossPagesInMarkdown: Optional<Boolean>) =
            mergeTablesAcrossPagesInMarkdown(mergeTablesAcrossPagesInMarkdown.getOrNull())

        /**
         * Sets [Builder.mergeTablesAcrossPagesInMarkdown] to an arbitrary JSON value.
         *
         * You should usually call [Builder.mergeTablesAcrossPagesInMarkdown] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun mergeTablesAcrossPagesInMarkdown(mergeTablesAcrossPagesInMarkdown: JsonField<Boolean>) =
            apply {
         ...
         *
         * You should usually call [Builder.outlinedTableExtraction] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun outlinedTableExtraction(outlinedTableExtraction: JsonField<Boolean>) = apply {
        ...
        /**
         * Alias for calling [Builder.outputPdfOfDocument] with `outputPdfOfDocument.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.outputPdfOfDocument] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Alias for calling [Builder.outputS3PathPrefix] with `outputS3PathPrefix.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.outputS3PathPrefix] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.outputS3Region] with `outputS3Region.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.outputS3Region] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Alias for calling [Builder.outputTablesAsHtml] with `outputTablesAsHtml.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.outputTablesAsHtml] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Alias for calling [Builder.pageErrorTolerance] with `pageErrorTolerance.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.pageErrorTolerance] with a well-typed [Double] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.pageFooterPrefix] with `pageFooterPrefix.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.pageFooterPrefix] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.pageFooterSuffix] with `pageFooterSuffix.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.pageFooterSuffix] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.pageHeaderPrefix] with `pageHeaderPrefix.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.pageHeaderPrefix] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.pageHeaderSuffix] with `pageHeaderSuffix.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.pageHeaderSuffix] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun pagePrefix(pagePrefix: String?) = pagePrefix(JsonField.ofNullable(pagePrefix))

        /** Alias for calling [Builder.pagePrefix] with `pagePrefix.orElse(null)`. */
        fun pagePrefix(pagePrefix: Optional<String>) = pagePrefix(pagePrefix.getOrNull())

        /**
         * Sets [Builder.pagePrefix] to an arbitrary JSON value.
         *
         * You should usually call [Builder.pagePrefix] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun pagePrefix(pagePrefix: JsonField<String>) = apply { this.pagePrefix = pagePrefix }
         ...
         *
         * You should usually call [Builder.pageSeparator] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        fun pageSuffix(pageSuffix: String?) = pageSuffix(JsonField.ofNullable(pageSuffix))

        /** Alias for calling [Builder.pageSuffix] with `pageSuffix.orElse(null)`. */
        fun pageSuffix(pageSuffix: Optional<String>) = pageSuffix(pageSuffix.getOrNull())

        /**
         * Sets [Builder.pageSuffix] to an arbitrary JSON value.
         *
         * You should usually call [Builder.pageSuffix] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun pageSuffix(pageSuffix: JsonField<String>) = apply { this.pageSuffix = pageSuffix }

        /** Enum for representing the mode of parsing to be used. */
        fun parseMode(parseMode: ParsingMode?) = parseMode(JsonField.ofNullable(parseMode))

        /** Alias for calling [Builder.parseMode] with `parseMode.orElse(null)`. */
        fun parseMode(parseMode: Optional<ParsingMode>) = parseMode(parseMode.getOrNull())

        /**
         * Sets [Builder.parseMode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.parseMode] with a well-typed [ParsingMode] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun parseMode(parseMode: JsonField<ParsingMode>) = apply { this.parseMode = parseMode }

        fun parsingInstruction(parsingInstruction: String?) =
            parsingInstruction(JsonField.ofNullable(parsingInstruction))

        /**
         * Alias for calling [Builder.parsingInstruction] with `parsingInstruction.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.parsingInstruction] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Alias for calling [Builder.preciseBoundingBox] with `preciseBoundingBox.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.preciseBoundingBox] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun premiumMode(premiumMode: Optional<Boolean>) = premiumMode(premiumMode.getOrNull())
        ...
        fun presentationOutOfBoundsContent(presentationOutOfBoundsContent: Boolean?) =
            presentationOutOfBoundsContent(JsonField.ofNullable(presentationOutOfBoundsContent))
         ...
         */
        fun presentationOutOfBoundsContent(presentationOutOfBoundsContent: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.presentationOutOfBoundsContent] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun presentationOutOfBoundsContent(presentationOutOfBoundsContent: JsonField<Boolean>) =
            apply {
        ...
        fun presentationSkipEmbeddedData(presentationSkipEmbeddedData: Boolean?) =
            presentationSkipEmbeddedData(JsonField.ofNullable(presentationSkipEmbeddedData))
         ...
         */
        fun presentationSkipEmbeddedData(presentationSkipEmbeddedData: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.presentationSkipEmbeddedData] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun presentationSkipEmbeddedData(presentationSkipEmbeddedData: JsonField<Boolean>) = apply {
            this.presentationSkipEmbeddedData = presentationSkipEmbeddedData
        }

        fun preserveLayoutAlignmentAcrossPages(preserveLayoutAlignmentAcrossPages: Boolean?) =
            preserveLayoutAlignmentAcrossPages(
         ...
         */
        fun preserveLayoutAlignmentAcrossPages(preserveLayoutAlignmentAcrossPages: Boolean) =
            preserveLayoutAlignmentAcrossPages(preserveLayoutAlignmentAcrossPages as Boolean?)
        ...
        ) = preserveLayoutAlignmentAcrossPages(preserveLayoutAlignmentAcrossPages.getOrNull())

        /**
         * Sets [Builder.preserveLayoutAlignmentAcrossPages] to an arbitrary JSON value.
         *
         * You should usually call [Builder.preserveLayoutAlignmentAcrossPages] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun preserveLayoutAlignmentAcrossPages(
            preserveLayoutAlignmentAcrossPages: JsonField<Boolean>
        ) = apply { this.preserveLayoutAlignmentAcrossPages = preserveLayoutAlignmentAcrossPages }
         ...
         *
         * You should usually call [Builder.preserveVerySmallText] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [Builder.removeHiddenText] with `removeHiddenText.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.removeHiddenText] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.replaceFailedPageMode] with a well-typed [FailPageMode]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun replaceFailedPageMode(replaceFailedPageMode: JsonField<FailPageMode>) = apply {
        ...
        /**
         * Sets [Builder.replaceFailedPageWithErrorMessagePrefix] to an arbitrary JSON value.
         *
         * You should usually call [Builder.replaceFailedPageWithErrorMessagePrefix] with a
        ...
        /**
         * Sets [Builder.replaceFailedPageWithErrorMessageSuffix] to an arbitrary JSON value.
         *
         * You should usually call [Builder.replaceFailedPageWithErrorMessageSuffix] with a
         * well-typed [String] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun replaceFailedPageWithErrorMessageSuffix(
        ...
        fun saveImages(saveImages: Boolean?) = saveImages(JsonField.ofNullable(saveImages))
        ...
        fun saveImages(saveImages: Optional<Boolean>) = saveImages(saveImages.getOrNull())

        /**
         * Sets [Builder.saveImages] to an arbitrary JSON value.
         *
         * You should usually call [Builder.saveImages] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun saveImages(saveImages: JsonField<Boolean>) = apply { this.saveImages = saveImages }
        ...
        /** Alias for calling [Builder.skipDiagonalText] with `skipDiagonalText.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.skipDiagonalText] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun specializedChartParsingAgentic(specializedChartParsingAgentic: Boolean?) =
            specializedChartParsingAgentic(JsonField.ofNullable(specializedChartParsingAgentic))
         ...
         */
        fun specializedChartParsingAgentic(specializedChartParsingAgentic: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.specializedChartParsingAgentic] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun specializedChartParsingAgentic(specializedChartParsingAgentic: JsonField<Boolean>) =
            apply {
                this.specializedChartParsingAgentic = specializedChartParsingAgentic
            }

        fun specializedChartParsingEfficient(specializedChartParsingEfficient: Boolean?) =
            specializedChartParsingEfficient(JsonField.ofNullable(specializedChartParsingEfficient))
         ...
         */
        fun specializedChartParsingEfficient(specializedChartParsingEfficient: Boolean) =
            specializedChartParsingEfficient(specializedChartParsingEfficient as Boolean?)

        /**
         * Alias for calling [Builder.specializedChartParsingEfficient] with
         * `specializedChartParsingEfficient.orElse(null)`.
         */
        fun specializedChartParsingEfficient(specializedChartParsingEfficient: Optional<Boolean>) =
            specializedChartParsingEfficient(specializedChartParsingEfficient.getOrNull())

        /**
         * Sets [Builder.specializedChartParsingEfficient] to an arbitrary JSON value.
         *
         * You should usually call [Builder.specializedChartParsingEfficient] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun specializedChartParsingEfficient(specializedChartParsingEfficient: JsonField<Boolean>) =
            apply {
        ...
        fun specializedChartParsingPlus(specializedChartParsingPlus: Boolean?) =
            specializedChartParsingPlus(JsonField.ofNullable(specializedChartParsingPlus))
         ...
         */
        fun specializedChartParsingPlus(specializedChartParsingPlus: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.specializedChartParsingPlus] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun specializedChartParsingPlus(specializedChartParsingPlus: JsonField<Boolean>) = apply {
         ...
         *
         * You should usually call [Builder.specializedImageParsing] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun specializedImageParsing(specializedImageParsing: JsonField<Boolean>) = apply {
            this.specializedImageParsing = specializedImageParsing
        }

        fun spreadsheetExtractSubTables(spreadsheetExtractSubTables: Boolean?) =
            spreadsheetExtractSubTables(JsonField.ofNullable(spreadsheetExtractSubTables))
         ...
         */
        fun spreadsheetExtractSubTables(spreadsheetExtractSubTables: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.spreadsheetExtractSubTables] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun spreadsheetExtractSubTables(spreadsheetExtractSubTables: JsonField<Boolean>) = apply {
            this.spreadsheetExtractSubTables = spreadsheetExtractSubTables
        }

        fun spreadsheetForceFormulaComputation(spreadsheetForceFormulaComputation: Boolean?) =
            spreadsheetForceFormulaComputation(
         ...
         */
        fun spreadsheetForceFormulaComputation(spreadsheetForceFormulaComputation: Boolean) =
            spreadsheetForceFormulaComputation(spreadsheetForceFormulaComputation as Boolean?)
        ...
        ) = spreadsheetForceFormulaComputation(spreadsheetForceFormulaComputation.getOrNull())

        /**
         * Sets [Builder.spreadsheetForceFormulaComputation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.spreadsheetForceFormulaComputation] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun spreadsheetForceFormulaComputation(
            spreadsheetForceFormulaComputation: JsonField<Boolean>
        ) = apply { this.spreadsheetForceFormulaComputation = spreadsheetForceFormulaComputation }

        fun spreadsheetIncludeHiddenSheets(spreadsheetIncludeHiddenSheets: Boolean?) =
            spreadsheetIncludeHiddenSheets(JsonField.ofNullable(spreadsheetIncludeHiddenSheets))
         ...
         */
        fun spreadsheetIncludeHiddenSheets(spreadsheetIncludeHiddenSheets: Optional<Boolean>) =
         ...
         *
         * You should usually call [Builder.spreadsheetIncludeHiddenSheets] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun spreadsheetIncludeHiddenSheets(spreadsheetIncludeHiddenSheets: JsonField<Boolean>) =
            apply {
        ...
        /**
         * Alias for calling [Builder.strictModeBuggyFont] with `strictModeBuggyFont.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.strictModeBuggyFont] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.strictModeImageExtraction] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun strictModeImageExtraction(strictModeImageExtraction: JsonField<Boolean>) = apply {
        ...
        /**
         * Alias for calling [Builder.strictModeImageOcr] with `strictModeImageOcr.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.strictModeImageOcr] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.strictModeReconstruction] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun strictModeReconstruction(strictModeReconstruction: JsonField<Boolean>) = apply {
         ...
         *
         * You should usually call [Builder.structuredOutputJsonSchema] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun structuredOutputJsonSchema(structuredOutputJsonSchema: JsonField<String>) = apply {
        ...
        fun structuredOutputJsonSchemaName(structuredOutputJsonSchemaName: String?) =
            structuredOutputJsonSchemaName(JsonField.ofNullable(structuredOutputJsonSchemaName))

        /**
         * Alias for calling [Builder.structuredOutputJsonSchemaName] with
         * `structuredOutputJsonSchemaName.orElse(null)`.
         */
        fun structuredOutputJsonSchemaName(structuredOutputJsonSchemaName: Optional<String>) =
         ...
         *
         * You should usually call [Builder.structuredOutputJsonSchemaName] with a well-typed
         * [String] value instead. This method is primarily for setting the field to an undocumented
         * or not yet supported value.
         */
        fun structuredOutputJsonSchemaName(structuredOutputJsonSchemaName: JsonField<String>) =
            apply {
        ...
        /**
         * Alias for calling [Builder.systemPromptAppend] with `systemPromptAppend.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.systemPromptAppend] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun takeScreenshot(takeScreenshot: Boolean) = takeScreenshot(takeScreenshot as Boolean?)

        /** Alias for calling [Builder.takeScreenshot] with `takeScreenshot.orElse(null)`. */
         ...
         *
         * You should usually call [Builder.takeScreenshot] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.useVendorMultimodalModel] with a well-typed [Boolean]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun useVendorMultimodalModel(useVendorMultimodalModel: JsonField<Boolean>) = apply {
            this.useVendorMultimodalModel = useVendorMultimodalModel
        }

        fun userPrompt(userPrompt: String?) = userPrompt(JsonField.ofNullable(userPrompt))

        /** Alias for calling [Builder.userPrompt] with `userPrompt.orElse(null)`. */
        fun userPrompt(userPrompt: Optional<String>) = userPrompt(userPrompt.getOrNull())
         ...
         *
         * You should usually call [Builder.vendorMultimodalApiKey] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.vendorMultimodalModelName] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun vendorMultimodalModelName(vendorMultimodalModelName: JsonField<String>) = apply {
        ...
        /**
         * Returns an immutable instance of [LlamaParseParameters].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LlamaParseParameters =
     ...
     *   expected type.
     */
    fun validate(): LlamaParseParameters = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (adaptiveLongTable.asKnown().isPresent) 1 else 0) +
            ...
            (if (confidenceScoreEffort.asKnown().isPresent) 1 else 0) +
            ...
            (if (ignoreDocumentElementsForLayoutDetection.asKnown().isPresent) 1 else 0) +
            ...
            (if (replaceFailedPageWithErrorMessagePrefix.asKnown().isPresent) 1 else 0) +
            (if (replaceFailedPageWithErrorMessageSuffix.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LlamaParseParameters &&
            ...
            complementalFormattingInstruction == other.complementalFormattingInstruction &&
            ...
            jobTimeoutExtraTimePerPageInSeconds == other.jobTimeoutExtraTimePerPageInSeconds &&
            jobTimeoutInSeconds == other.jobTimeoutInSeconds &&
            keepPageSeparatorWhenMergingTables == other.keepPageSeparatorWhenMergingTables &&
            languages == other.languages &&
            layoutAware == other.layoutAware &&
            lineLevelBoundingBox == other.lineLevelBoundingBox &&
            markdownTableMultilineHeaderSeparator == other.markdownTableMultilineHeaderSeparator &&
            maxPages == other.maxPages &&
            maxPagesEnforced == other.maxPagesEnforced &&
            mergeTablesAcrossPagesInMarkdown == other.mergeTablesAcrossPagesInMarkdown &&
            model == other.model &&
            ...
            preserveLayoutAlignmentAcrossPages == other.preserveLayoutAlignmentAcrossPages &&
            ...
            specializedChartParsingEfficient == other.specializedChartParsingEfficient &&
            ...
            spreadsheetForceFormulaComputation == other.spreadsheetForceFormulaComputation &&
