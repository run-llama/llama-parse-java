...
private constructor(
    ...
    override fun toString() =
        "DirectoryCreateResponse{id=$id, name=$name, projectId=$projectId, createdAt=$createdAt, deletedAt=$deletedAt, description=$description, expiresAt=$expiresAt, systemMetadata=$systemMetadata, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
