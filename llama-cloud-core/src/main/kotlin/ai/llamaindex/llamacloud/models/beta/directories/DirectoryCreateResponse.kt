...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(directoryCreateResponse: DirectoryCreateResponse) = apply {
            id = directoryCreateResponse.id
            name = directoryCreateResponse.name
            projectId = directoryCreateResponse.projectId
            connectorSubscriptionId = directoryCreateResponse.connectorSubscriptionId
            createdAt = directoryCreateResponse.createdAt
            deletedAt = directoryCreateResponse.deletedAt
            description = directoryCreateResponse.description
            expiresAt = directoryCreateResponse.expiresAt
            systemMetadata = directoryCreateResponse.systemMetadata
            type = directoryCreateResponse.type
            updatedAt = directoryCreateResponse.updatedAt
    ...
    override fun toString() =
        "DirectoryCreateResponse{id=$id, name=$name, projectId=$projectId, connectorSubscriptionId=$connectorSubscriptionId, createdAt=$createdAt, deletedAt=$deletedAt, description=$description, expiresAt=$expiresAt, systemMetadata=$systemMetadata, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
