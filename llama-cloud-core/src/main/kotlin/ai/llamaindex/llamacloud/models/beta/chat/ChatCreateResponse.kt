...
private constructor(
    ...
    override fun toString() =
        "ChatCreateResponse{lastUpdatedAt=$lastUpdatedAt, sessionId=$sessionId, generatedTitle=$generatedTitle, indexIds=$indexIds, jobMetadata=$jobMetadata, additionalProperties=$additionalProperties}"
}
