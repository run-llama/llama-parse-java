...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(chatCreateResponse: ChatCreateResponse) = apply {
            lastUpdatedAt = chatCreateResponse.lastUpdatedAt
            sessionId = chatCreateResponse.sessionId
            sharedAccess = chatCreateResponse.sharedAccess
            generatedTitle = chatCreateResponse.generatedTitle
            indexIds = chatCreateResponse.indexIds.map { it.toMutableList() }
            jobMetadata = chatCreateResponse.jobMetadata
    ...
    override fun toString() =
        "ChatCreateResponse{lastUpdatedAt=$lastUpdatedAt, sessionId=$sessionId, sharedAccess=$sharedAccess, generatedTitle=$generatedTitle, indexIds=$indexIds, jobMetadata=$jobMetadata, additionalProperties=$additionalProperties}"
}
