...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SplitCancelResponse].
         *
    ...
    /** A builder for [SplitCancelResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(splitCancelResponse: SplitCancelResponse) = apply {
            id = splitCancelResponse.id
            categories = splitCancelResponse.categories.map { it.toMutableList() }
            documentInputType = splitCancelResponse.documentInputType
            fileInput = splitCancelResponse.fileInput
            projectId = splitCancelResponse.projectId
            status = splitCancelResponse.status
            userId = splitCancelResponse.userId
        ...
        /**
         * Returns an immutable instance of [SplitCancelResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): SplitCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SplitCancelResponse &&
            id == other.id &&
