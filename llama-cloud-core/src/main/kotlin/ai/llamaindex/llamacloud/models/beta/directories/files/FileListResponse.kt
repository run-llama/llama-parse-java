...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileListResponse: FileListResponse) = apply {
            ...
            directoryId = fileListResponse.directoryId
            displayName = fileListResponse.displayName
            projectId = fileListResponse.projectId
            uniqueId = fileListResponse.uniqueId
            createdAt = fileListResponse.createdAt
            deletedAt = fileListResponse.deletedAt
            downloadUrl = fileListResponse.downloadUrl
            fileId = fileListResponse.fileId
    ...
    override fun toString() =
        "FileListResponse{id=$id, directoryId=$directoryId, displayName=$displayName, projectId=$projectId, uniqueId=$uniqueId, createdAt=$createdAt, deletedAt=$deletedAt, downloadUrl=$downloadUrl, fileId=$fileId, metadata=$metadata, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
