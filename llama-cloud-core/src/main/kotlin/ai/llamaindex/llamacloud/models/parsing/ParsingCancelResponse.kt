...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParsingCancelResponse].
         *
    ...
    /** A builder for [ParsingCancelResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(parsingCancelResponse: ParsingCancelResponse) = apply {
            id = parsingCancelResponse.id
            projectId = parsingCancelResponse.projectId
            status = parsingCancelResponse.status
            createdAt = parsingCancelResponse.createdAt
            errorMessage = parsingCancelResponse.errorMessage
            name = parsingCancelResponse.name
            tier = parsingCancelResponse.tier
            updatedAt = parsingCancelResponse.updatedAt
            usage = parsingCancelResponse.usage
            userMetadata = parsingCancelResponse.userMetadata
            additionalProperties = parsingCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ParsingCancelResponse].
         *
         ...
         */
        fun build(): ParsingCancelResponse =
     ...
     *   expected type.
     */
    fun validate(): ParsingCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParsingCancelResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ParsingCancelResponse{id=$id, projectId=$projectId, status=$status, createdAt=$createdAt, errorMessage=$errorMessage, name=$name, tier=$tier, updatedAt=$updatedAt, usage=$usage, userMetadata=$userMetadata, additionalProperties=$additionalProperties}"
}
