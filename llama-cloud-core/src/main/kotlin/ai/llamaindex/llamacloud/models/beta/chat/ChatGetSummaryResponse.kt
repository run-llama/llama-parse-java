...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChatGetSummaryResponse].
         *
    ...
    /** A builder for [ChatGetSummaryResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(chatGetSummaryResponse: ChatGetSummaryResponse) = apply {
            ...
            additionalProperties = chatGetSummaryResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChatGetSummaryResponse].
         *
         ...
         */
        fun build(): ChatGetSummaryResponse =
     ...
     *   expected type.
     */
    fun validate(): ChatGetSummaryResponse = apply {
        if (validated) {
            return@apply
        }
