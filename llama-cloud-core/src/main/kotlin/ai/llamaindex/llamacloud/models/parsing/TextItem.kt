...
private constructor(
    ...
    ) : this(md, value, bbox, type, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TextItem].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(textItem: TextItem) = apply {
            md = textItem.md
            value = textItem.value
            bbox = textItem.bbox.map { it.toMutableList() }
            type = textItem.type
            additionalProperties = textItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TextItem].
         *
    ...
    private val hashCode: Int by lazy { Objects.hash(md, value, bbox, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "TextItem{md=$md, value=$value, bbox=$bbox, type=$type, additionalProperties=$additionalProperties}"
}
