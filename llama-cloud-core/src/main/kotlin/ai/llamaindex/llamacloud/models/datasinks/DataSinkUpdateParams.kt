...
import ai.llamaindex.llamacloud.models.CloudAstraDbVectorStore
import ai.llamaindex.llamacloud.models.CloudAzureAiSearchVectorStore
import ai.llamaindex.llamacloud.models.CloudMilvusVectorStore
import ai.llamaindex.llamacloud.models.CloudMongoDBAtlasVectorSearch
import ai.llamaindex.llamacloud.models.CloudPineconeVectorStore
import ai.llamaindex.llamacloud.models.CloudPostgresVectorStore
import ai.llamaindex.llamacloud.models.CloudQdrantVectorStore
...
private constructor(
     ...
     */
    fun sinkType(): SinkType = body.sinkType()
     ...
     */
    fun component(): Optional<Component> = body.component()
     ...
     */
    fun _sinkType(): JsonField<SinkType> = body._sinkType()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DataSinkUpdateParams].
         *
    ...
    /** A builder for [DataSinkUpdateParams]. */
    class Builder internal constructor() {
        ...
        fun dataSinkId(dataSinkId: String?) = apply { this.dataSinkId = dataSinkId }
        ...
        fun sinkType(sinkType: SinkType) = apply { body.sinkType(sinkType) }
         ...
         * value.
         */
        fun sinkType(sinkType: JsonField<SinkType>) = apply { body.sinkType(sinkType) }

        /** Component that implements the data sink */
        fun component(component: Component?) = apply { body.component(component) }

        /** Alias for calling [Builder.component] with `component.orElse(null)`. */
        fun component(component: Optional<Component>) = component(component.getOrNull())
         ...
         */
        fun component(cloudPineconeVectorStore: CloudPineconeVectorStore) = apply {
            body.component(cloudPineconeVectorStore)
        }
         ...
         */
        fun component(cloudPostgresVectorStore: CloudPostgresVectorStore) = apply {
            body.component(cloudPostgresVectorStore)
        }
         ...
         */
        fun component(cloudQdrantVectorStore: CloudQdrantVectorStore) = apply {
            body.component(cloudQdrantVectorStore)
        }
         ...
         */
        fun component(cloudAzureAiSearchVectorStore: CloudAzureAiSearchVectorStore) = apply {
            body.component(cloudAzureAiSearchVectorStore)
        }
         ...
         */
        fun component(cloudMongoDBAtlasVectorSearch: CloudMongoDBAtlasVectorSearch) = apply {
            body.component(cloudMongoDBAtlasVectorSearch)
        }
         ...
         */
        fun component(cloudMilvusVectorStore: CloudMilvusVectorStore) = apply {
            body.component(cloudMilvusVectorStore)
        }
         ...
         */
        fun component(cloudAstraDbVectorStore: CloudAstraDbVectorStore) = apply {
            body.component(cloudAstraDbVectorStore)
        }
        ...
        /**
         * Returns an immutable instance of [DataSinkUpdateParams].
         *
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            sinkType: JsonField<SinkType> = JsonMissing.of(),
            @JsonProperty("component")
            @ExcludeMissing
            component: JsonField<Component> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
        ) : this(sinkType, component, name, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.sinkType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.sinkType] with a well-typed [SinkType] value
            ...
            /** Component that implements the data sink */
            fun component(component: Component?) = component(JsonField.ofNullable(component))
        ...
        private val hashCode: Int by lazy {
            Objects.hash(sinkType, component, name, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{sinkType=$sinkType, component=$component, name=$name, additionalProperties=$additionalProperties}"
    }
