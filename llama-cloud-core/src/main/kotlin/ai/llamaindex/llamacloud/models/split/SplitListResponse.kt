...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(splitListResponse: SplitListResponse) = apply {
            id = splitListResponse.id
            categories = splitListResponse.categories.map { it.toMutableList() }
            documentInputType = splitListResponse.documentInputType
            fileInput = splitListResponse.fileInput
            projectId = splitListResponse.projectId
            status = splitListResponse.status
            userId = splitListResponse.userId
            configurationId = splitListResponse.configurationId
            createdAt = splitListResponse.createdAt
            errorMessage = splitListResponse.errorMessage
            parseConfigId = splitListResponse.parseConfigId
            parseTier = splitListResponse.parseTier
            result = splitListResponse.result
            splittingStrategy = splitListResponse.splittingStrategy
            targetPages = splitListResponse.targetPages
            transactionId = splitListResponse.transactionId
            updatedAt = splitListResponse.updatedAt
