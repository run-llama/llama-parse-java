...
package ai.llamaindex.llamacloud.models.pipelines.sync
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SyncCreateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SyncCreateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SyncCreateParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SyncCreateParams].
         *
