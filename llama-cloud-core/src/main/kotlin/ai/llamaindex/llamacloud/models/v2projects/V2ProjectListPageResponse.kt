...
class V2ProjectListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<V2ProjectListResponse>>,
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<V2ProjectListResponse>> = JsonMissing.of(),
     ...
     */
    fun items(): List<V2ProjectListResponse> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<V2ProjectListResponse>> = items
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2ProjectListPageResponse].
         *
    ...
    /** A builder for [V2ProjectListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<V2ProjectListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(v2ProjectListPageResponse: V2ProjectListPageResponse) = apply {
            items = v2ProjectListPageResponse.items.map { it.toMutableList() }
            nextPageToken = v2ProjectListPageResponse.nextPageToken
            totalSize = v2ProjectListPageResponse.totalSize
            additionalProperties = v2ProjectListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<V2ProjectListResponse>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<V2ProjectListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun items(items: JsonField<List<V2ProjectListResponse>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [V2ProjectListResponse] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: V2ProjectListResponse) = apply {
            items =
        ...
        /**
         * Returns an immutable instance of [V2ProjectListPageResponse].
         *
         ...
         */
        fun build(): V2ProjectListPageResponse =
            V2ProjectListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): V2ProjectListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V2ProjectListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "V2ProjectListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
