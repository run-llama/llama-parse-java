...
class RetrievalMode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [RetrievalMode]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [RetrievalMode] can contain an unknown value in a couple of cases:
     ...
     *   expected type.
     */
    fun validate(): RetrievalMode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetrievalMode && value == other.value
    }
