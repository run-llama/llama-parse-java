...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchCancelResponse: BatchCancelResponse) = apply {
            ...
            projectId = batchCancelResponse.projectId
            sourceDirectoryId = batchCancelResponse.sourceDirectoryId
            status = batchCancelResponse.status
            createdAt = batchCancelResponse.createdAt
            results = batchCancelResponse.results.map { it.toMutableList() }
            updatedAt = batchCancelResponse.updatedAt
    ...
    override fun toString() =
        "BatchCancelResponse{id=$id, config=$config, projectId=$projectId, sourceDirectoryId=$sourceDirectoryId, status=$status, createdAt=$createdAt, results=$results, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
