...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileRetrieveResponse: FileRetrieveResponse) = apply {
            id = fileRetrieveResponse.id
            name = fileRetrieveResponse.name
            projectId = fileRetrieveResponse.projectId
            downloadUrl = fileRetrieveResponse.downloadUrl
            expiresAt = fileRetrieveResponse.expiresAt
            externalFileId = fileRetrieveResponse.externalFileId
            fileType = fileRetrieveResponse.fileType
            lastModifiedAt = fileRetrieveResponse.lastModifiedAt
            purpose = fileRetrieveResponse.purpose
    ...
    override fun toString() =
        "FileRetrieveResponse{id=$id, name=$name, projectId=$projectId, downloadUrl=$downloadUrl, expiresAt=$expiresAt, externalFileId=$externalFileId, fileType=$fileType, lastModifiedAt=$lastModifiedAt, purpose=$purpose, additionalProperties=$additionalProperties}"
}
