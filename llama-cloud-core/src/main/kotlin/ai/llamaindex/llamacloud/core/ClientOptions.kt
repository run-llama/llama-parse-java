...
package ai.llamaindex.llamacloud.core
...
import ai.llamaindex.llamacloud.core.http.LoggingHttpClient
import ai.llamaindex.llamacloud.core.http.PhantomReachableClosingHttpClient
import ai.llamaindex.llamacloud.core.http.QueryParams
import ai.llamaindex.llamacloud.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Defaults to [ai.llamaindex.llamacloud.core.jsonMapper]. The default is usually sufficient and
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("llamacloud.baseUrl") ?: System.getenv("LLAMA_CLOUD_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("llamacloud.apiKey") ?: System.getenv("LLAMA_CLOUD_API_KEY"))?.let {
                apiKey(it)
            }
            System.getenv("LLAMA_CLOUD_CUSTOM_HEADERS")?.let { customHeadersEnv ->
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "llama-cloud-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
