...
import ai.llamaindex.llamacloud.models.extract.ExtractV2JobQueryResponse
...
class ExtractServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun cancel(params: ExtractCancelParams, requestOptions: RequestOptions): ExtractV2Job =
