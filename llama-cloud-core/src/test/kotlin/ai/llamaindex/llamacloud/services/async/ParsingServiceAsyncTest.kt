...
internal class ParsingServiceAsyncTest {
    ...
    fun list() {
        ...
        val pageFuture = parsingServiceAsync.list()
    ...
    fun listVersions() {
        ...
        val responseFuture = parsingServiceAsync.listVersions()
