...
package ai.llamaindex.llamacloud.core.http

import ai.llamaindex.llamacloud.client.okhttp.OkHttpClient
import ai.llamaindex.llamacloud.core.RequestOptions
import ai.llamaindex.llamacloud.core.Sleeper
import ai.llamaindex.llamacloud.errors.LlamaCloudRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw LlamaCloudRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            LlamaCloudRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
