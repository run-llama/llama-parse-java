...
internal class PipelineUpdateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.dataSinkId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(body.embeddingConfig())
            .contains(
                PipelineUpdateParams.EmbeddingConfig.ofAzureEmbedding(
                    AzureOpenAIEmbeddingConfig.builder()
                        .component(
                            AzureOpenAIEmbedding.builder()
                                .additionalKwargs(
        ...
        assertThat(body.embeddingModelConfigId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(body.llamaParseParameters())
            .contains(
                LlamaParseParameters.builder()
                    .adaptiveLongTable(true)
                    .aggressiveTableExtraction(true)
        ...
        assertThat(body.managedPipelineId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(body.metadataConfig())
            .contains(
                PipelineMetadataConfig.builder()
                    .addExcludedEmbedMetadataKey("string")
                    .addExcludedLlmMetadataKey("string")
        ...
        assertThat(body.presetRetrievalParameters())
            .contains(
                PresetRetrievalParams.builder()
                    .alpha(0.0)
                    .className("class_name")
        ...
        assertThat(body.sparseModelConfig())
            .contains(
                SparseModelConfig.builder()
                    .className("class_name")
                    .modelType(SparseModelConfig.ModelType.AUTO)
        ...
        assertThat(body.transformConfig())
            .contains(
                PipelineUpdateParams.TransformConfig.ofAuto(
                    AutoTransformConfig.builder()
                        .chunkOverlap(0L)
                        .chunkSize(1L)
                        .mode(AutoTransformConfig.Mode.AUTO)
