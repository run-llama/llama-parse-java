...
internal class SplitGetResponseTest {
    ...
    fun create() {
        ...
        assertThat(splitGetResponse.parseConfigId()).contains("parse_config_id")
        assertThat(splitGetResponse.parseTier()).contains("parse_tier")
        ...
        assertThat(splitGetResponse.targetPages()).contains("target_pages")
