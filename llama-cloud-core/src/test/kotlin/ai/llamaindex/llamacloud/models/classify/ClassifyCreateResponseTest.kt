    ...
    fun create() {
        val classifyCreateResponse =
            ClassifyCreateResponse.builder()
                ...
                .documentInputType(ClassifyCreateResponse.DocumentInputType.FILE_ID)
                .fileInput("file_input")
                .projectId("project_id")
                .status(ClassifyCreateResponse.Status.COMPLETED)
                .userId("user_id")
        ...
        assertThat(classifyCreateResponse.documentInputType())
            .isEqualTo(ClassifyCreateResponse.DocumentInputType.FILE_ID)
        ...
        assertThat(classifyCreateResponse.status())
            .isEqualTo(ClassifyCreateResponse.Status.COMPLETED)
