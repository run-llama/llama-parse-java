    ...
    fun create() {
        val parsingGetResponse =
            ParsingGetResponse.builder()
                ...
                .forms(
                    ParsingGetResponse.Forms.builder()
                        .addPage(
                                                    ...
                                                    FormField.Grounding.builder()
                                                        ...
                                                        .label(
                                                            FormField.Grounding.Label.builder()
                                                                .addLine(
                                                                    FormField.Grounding.Label.Line
                                                                        .builder()
                                                                        .bbox(
                                                                            BBox.builder()
                                                                                .h(0.0)
                                                        ...
                                                        .value(
                                                            FormField.Grounding.Value.builder()
                                                                .addLine(
                                                                    FormField.Grounding.Value.Line
                                                                        .builder()
                                                                        .bbox(
                                                                            BBox.builder()
                                                                                .h(0.0)
        ...
        assertThat(parsingGetResponse.forms())
            .contains(
                ParsingGetResponse.Forms.builder()
                    .addPage(
                        ParsingGetResponse.Forms.Page.FormsResultPage.builder()
