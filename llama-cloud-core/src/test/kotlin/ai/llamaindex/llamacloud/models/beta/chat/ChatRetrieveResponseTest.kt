...
internal class ChatRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(chatRetrieveResponse.sharedAccess())
            .isEqualTo(ChatRetrieveResponse.SharedAccess.READ_ONLY)
