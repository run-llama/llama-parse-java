    ...
    fun create() {
        val chatGetSummaryResponse =
            ChatGetSummaryResponse.builder()
                ...
                .sharedAccess(ChatGetSummaryResponse.SharedAccess.READ_ONLY)
        ...
        assertThat(chatGetSummaryResponse.sharedAccess())
            .isEqualTo(ChatGetSummaryResponse.SharedAccess.READ_ONLY)
