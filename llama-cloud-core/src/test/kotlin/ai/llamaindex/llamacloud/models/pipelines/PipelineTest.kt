...
internal class PipelineTest {
    ...
    fun create() {
        val pipeline =
            Pipeline.builder()
                ...
                .embeddingModelConfig(
                    Pipeline.EmbeddingModelConfig.builder()
                        .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        .embeddingConfig(
                            AzureOpenAIEmbeddingConfig.builder()
                                .component(
        ...
        assertThat(pipeline.name()).isEqualTo("name")
        assertThat(pipeline.projectId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(pipeline.configHash())
            .contains(
                Pipeline.ConfigHash.builder()
                    .embeddingConfigHash("embedding_config_hash")
                    .parsingConfigHash("parsing_config_hash")
        ...
        assertThat(pipeline.createdAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(pipeline.dataSink())
            .contains(
                DataSink.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .component(
        ...
        assertThat(pipeline.embeddingModelConfig())
            .contains(
                Pipeline.EmbeddingModelConfig.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .embeddingConfig(
        ...
        assertThat(pipeline.embeddingModelConfigId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(pipeline.llamaParseParameters())
            .contains(
                LlamaParseParameters.builder()
                    .adaptiveLongTable(true)
                    .aggressiveTableExtraction(true)
        ...
        assertThat(pipeline.managedPipelineId()).contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(pipeline.metadataConfig())
            .contains(
                PipelineMetadataConfig.builder()
                    .addExcludedEmbedMetadataKey("string")
                    .addExcludedLlmMetadataKey("string")
        ...
        assertThat(pipeline.sparseModelConfig())
            .contains(
                SparseModelConfig.builder()
                    .className("class_name")
                    .modelType(SparseModelConfig.ModelType.AUTO)
        ...
        assertThat(pipeline.transformConfig())
            .contains(
                Pipeline.TransformConfig.ofAuto(
                    AutoTransformConfig.builder()
                        .chunkOverlap(0L)
                        .chunkSize(1L)
                        .mode(AutoTransformConfig.Mode.AUTO)
        ...
        assertThat(pipeline.updatedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
